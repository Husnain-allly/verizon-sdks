...
module Verizon
  ...
  class ResourcesServiceProfile < BaseModel
    ...
    def initialize(client_type:, ecsp_filter: SKIP, client_schedule: SKIP,
                   client_service_area: SKIP, network_resources: SKIP,
                   compute_resources: SKIP, properties: SKIP)
    ...
    def self.from_hash(hash)
      ...
      ResourcesServiceProfile.new(client_type: client_type,
    ...
    def to_s
      ...
      "<#{class_name} client_type: #{@client_type}, ecsp_filter: #{@ecsp_filter},"\
      " client_schedule: #{@client_schedule}, client_service_area: #{@client_service_area},"\
      " network_resources: #{@network_resources}, compute_resources: #{@compute_resources},"\
      " properties: #{@properties}>"
    end
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} client_type: #{@client_type.inspect}, ecsp_filter: #{@ecsp_filter.inspect},"\
      " client_schedule: #{@client_schedule.inspect}, client_service_area:"\
      " #{@client_service_area.inspect}, network_resources: #{@network_resources.inspect},"\
      " compute_resources: #{@compute_resources.inspect}, properties: #{@properties.inspect}>"
    end
  end
end
