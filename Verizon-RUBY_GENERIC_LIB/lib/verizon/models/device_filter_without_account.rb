...
module Verizon
  ...
  class DeviceFilterWithoutAccount < BaseModel
    ...
    def self.from_hash(hash)
      ...
      DeviceFilterWithoutAccount.new(group_name: group_name,
    ...
    def to_s
      ...
      "<#{class_name} group_name: #{@group_name}, service_plan: #{@service_plan}, custom_fields:"\
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} group_name: #{@group_name.inspect}, service_plan: #{@service_plan.inspect},"\
      " custom_fields: #{@custom_fields.inspect}, additional_properties:"\
