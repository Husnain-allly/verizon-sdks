...
module Verizon
  ...
  class DeviceLog < BaseModel
    ...
    def initialize(device_id:, log_time:, log_type:, event_log:,
                   binary_log_file_base64:, binary_log_filename:,
    ...
    def self.from_hash(hash)
      ...
      DeviceLog.new(device_id: device_id,
                    log_time: log_time,
                    log_type: log_type,
                    event_log: event_log,
                    binary_log_file_base64: binary_log_file_base64,
    ...
    def to_s
      ...
      "<#{class_name} device_id: #{@device_id}, log_time: #{@log_time}, log_type: #{@log_type},"\
      " event_log: #{@event_log}, binary_log_file_base64: #{@binary_log_file_base64},"\
      " binary_log_filename: #{@binary_log_filename}, additional_properties:"\
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} device_id: #{@device_id.inspect}, log_time: #{@log_time.inspect}, log_type:"\
      " #{@log_type.inspect}, event_log: #{@event_log.inspect}, binary_log_file_base64:"\
      " #{@binary_log_file_base64.inspect}, binary_log_filename: #{@binary_log_filename.inspect},"\
      " additional_properties: #{@additional_properties}>"
    end
  end
end
