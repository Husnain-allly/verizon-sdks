...
module Verizon
  ...
  class UploadAndScheduleFileRequest < BaseModel
    ...
    def self.from_hash(hash)
      ...
      UploadAndScheduleFileRequest.new(campaign_name: campaign_name,
                                       file_name: file_name,
    ...
    def to_s
      ...
      "<#{class_name} campaign_name: #{@campaign_name}, file_name: #{@file_name}, file_version:"\
      " #{@file_version}, distribution_type: #{@distribution_type}, start_date: #{@start_date},"\
      " end_date: #{@end_date}, download_after_date: #{@download_after_date},"\
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} campaign_name: #{@campaign_name.inspect}, file_name: #{@file_name.inspect},"\
      " file_version: #{@file_version.inspect}, distribution_type: #{@distribution_type.inspect},"\
