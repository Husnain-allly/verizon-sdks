...
module Verizon
  ...
  class PricePlanTrigger1 < BaseModel
    SKIP = Object.new
    ...
    def initialize(account_group_share: SKIP, account_share: SKIP,
    ...
    def self.from_hash(hash)
      ...
      PricePlanTrigger1.new(account_group_share: account_group_share,
    ...
    def to_s
      ...
      " #{@action}, stand_alone: #{@stand_alone}, additional_properties:"\
    ...
    def inspect
      ...
      " #{@stand_alone.inspect}, additional_properties: #{@additional_properties}>"
    end
  end
end
