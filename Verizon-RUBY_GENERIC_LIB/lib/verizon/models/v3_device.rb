...
module Verizon
  ...
  class V3Device < BaseModel
    ...
    def initialize(device_id:, request_status: SKIP, result_reason: SKIP,
    ...
    def self.from_hash(hash)
      ...
      V3Device.new(device_id: device_id,
    ...
    def to_s
      ...
      "<#{class_name} device_id: #{@device_id}, request_status: #{@request_status},"\
      " result_reason: #{@result_reason}, mdn: #{@mdn}, model: #{@model}, make: #{@make},"\
      " firmware: #{@firmware}, fota_eligible: #{@fota_eligible}, status: #{@status},"\
      " license_assigned: #{@license_assigned}, protocol: #{@protocol}, software_list:"\
      " #{@software_list}, file_list: #{@file_list}, create_time: #{@create_time}, status_time:"\
      " #{@status_time}, update_time: #{@update_time}, refresh_time: #{@refresh_time},"\
      " last_connection_time: #{@last_connection_time}, additional_properties:"\
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} device_id: #{@device_id.inspect}, request_status:"\
      " #{@request_status.inspect}, result_reason: #{@result_reason.inspect}, mdn:"\
      " #{@mdn.inspect}, model: #{@model.inspect}, make: #{@make.inspect}, firmware:"\
      " #{@firmware.inspect}, fota_eligible: #{@fota_eligible.inspect}, status:"\
      " #{@status.inspect}, license_assigned: #{@license_assigned.inspect}, protocol:"\
      " #{@protocol.inspect}, software_list: #{@software_list.inspect}, file_list:"\
      " #{@file_list.inspect}, create_time: #{@create_time.inspect}, status_time:"\
      " #{@status_time.inspect}, update_time: #{@update_time.inspect}, refresh_time:"\
      " #{@refresh_time.inspect}, last_connection_time: #{@last_connection_time.inspect},"\
      " additional_properties: #{@additional_properties}>"
    end
  end
end
