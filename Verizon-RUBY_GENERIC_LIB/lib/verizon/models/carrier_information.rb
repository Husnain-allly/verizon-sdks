...
module Verizon
  ...
  class CarrierInformation < BaseModel
    ...
    def self.from_hash(hash)
      ...
      CarrierInformation.new(carrier_name: carrier_name,
    ...
    def to_s
      ...
      "<#{class_name} carrier_name: #{@carrier_name}, service_plan: #{@service_plan}, state:"\
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} carrier_name: #{@carrier_name.inspect}, service_plan:"\
      " #{@service_plan.inspect}, state: #{@state.inspect}, additional_properties:"\
