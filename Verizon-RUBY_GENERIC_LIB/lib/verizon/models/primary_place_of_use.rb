...
module Verizon
  ...
  class PrimaryPlaceOfUse < BaseModel
    ...
    def self.from_hash(hash)
      ...
      PrimaryPlaceOfUse.new(customer_name: customer_name,
                            address: address)
    end
    ...
    def to_s
      ...
      "<#{class_name} customer_name: #{@customer_name}, address: #{@address}>"
    end

    # Provides a debugging-friendly string with detailed object information.
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} customer_name: #{@customer_name.inspect}, address: #{@address.inspect}>"
    end
  end
end
