...
module Verizon
  ...
  class DataTrigger4 < BaseModel
    ...
    def initialize(account_level: SKIP, device_group: SKIP,
    ...
    def self.from_hash(hash)
      ...
      DataTrigger4.new(account_level: account_level,
    ...
    def to_s
      ...
      "<#{class_name} account_level: #{@account_level}, device_group: #{@device_group},"\
      " condition_type: #{@condition_type}, comparitor: #{@comparitor}, threshold: #{@threshold},"\
      " threshold_unit: #{@threshold_unit}, cycle_type: #{@cycle_type}, allowance_threshold:"\
      " #{@allowance_threshold}, action: #{@action}, additional_properties:"\
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} account_level: #{@account_level.inspect}, device_group:"\
      " #{@device_group.inspect}, condition_type: #{@condition_type.inspect}, comparitor:"\
      ...
      " #{@allowance_threshold.inspect}, action: #{@action.inspect}, additional_properties:"\
      " #{@additional_properties}>"
    end
  end
end
