...
module Verizon
  ...
  class GoToStateRequest < BaseModel
    ...
    def initialize(service_name:, state_name:, service_plan:, mdn_zip_code:,
                   devices: SKIP, filter: SKIP, carrier_ip_pool_name: SKIP,
                   public_ip_restriction: SKIP, sku_number: SKIP,
                   custom_fields: SKIP, devices_with_service_address: SKIP,
                   ipaddress: SKIP, group_name: SKIP,
                   primary_place_of_use: SKIP, additional_properties: nil)
    ...
    def self.from_hash(hash)
      ...
      GoToStateRequest.new(service_name: service_name,
                           state_name: state_name,
                           service_plan: service_plan,
                           mdn_zip_code: mdn_zip_code,
                           devices: devices,
                           ...
                           devices_with_service_address: devices_with_service_address,
                           ipaddress: ipaddress,
    ...
    def to_s
      ...
      "<#{class_name} service_name: #{@service_name}, state_name: #{@state_name}, service_plan:"\
      " #{@service_plan}, mdn_zip_code: #{@mdn_zip_code}, devices: #{@devices}, filter:"\
      " #{@filter}, carrier_ip_pool_name: #{@carrier_ip_pool_name}, public_ip_restriction:"\
      " #{@public_ip_restriction}, sku_number: #{@sku_number}, custom_fields: #{@custom_fields},"\
      " devices_with_service_address: #{@devices_with_service_address}, ipaddress: #{@ipaddress},"\
      " group_name: #{@group_name}, primary_place_of_use: #{@primary_place_of_use},"\
      " additional_properties: #{@additional_properties}>"
    end
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} service_name: #{@service_name.inspect}, state_name: #{@state_name.inspect},"\
      " service_plan: #{@service_plan.inspect}, mdn_zip_code: #{@mdn_zip_code.inspect}, devices:"\
      " #{@devices.inspect}, filter: #{@filter.inspect}, carrier_ip_pool_name:"\
      " #{@carrier_ip_pool_name.inspect}, public_ip_restriction:"\
      " #{@public_ip_restriction.inspect}, sku_number: #{@sku_number.inspect}, custom_fields:"\
      " #{@custom_fields.inspect}, devices_with_service_address:"\
      " #{@devices_with_service_address.inspect}, ipaddress: #{@ipaddress.inspect}, group_name:"\
      " #{@group_name.inspect}, primary_place_of_use: #{@primary_place_of_use.inspect},"\
      " additional_properties: #{@additional_properties}>"
    end
  end
end
