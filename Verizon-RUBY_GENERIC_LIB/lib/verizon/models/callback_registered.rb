...
module Verizon
  ...
  class CallbackRegistered < BaseModel
    ...
    def initialize(account_name:, name:, additional_properties: nil)
    ...
    def self.from_hash(hash)
      ...
      CallbackRegistered.new(account_name: account_name,
                             name: name,
                             additional_properties: additional_properties)
    end
    ...
    def to_s
      ...
      "<#{class_name} account_name: #{@account_name}, name: #{@name}, additional_properties:"\
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} account_name: #{@account_name.inspect}, name: #{@name.inspect},"\
      " additional_properties: #{@additional_properties}>"
    end
  end
end
