...
module Verizon
  ...
  class DeviceCostCenterRequest < BaseModel
    ...
    def initialize(account_name: SKIP, cost_center: SKIP, custom_fields: SKIP,
                   devices: SKIP, group_name: SKIP, primary_place_of_use: SKIP,
                   remove_cost_center: SKIP, service_plan: SKIP,
    ...
    def self.from_hash(hash)
      ...
      DeviceCostCenterRequest.new(account_name: account_name,
    ...
    def to_s
      ...
      "<#{class_name} account_name: #{@account_name}, cost_center: #{@cost_center},"\
      " custom_fields: #{@custom_fields}, devices: #{@devices}, group_name: #{@group_name},"\
      " primary_place_of_use: #{@primary_place_of_use}, remove_cost_center:"\
      " #{@remove_cost_center}, service_plan: #{@service_plan}, additional_properties:"\
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} account_name: #{@account_name.inspect}, cost_center:"\
      " #{@cost_center.inspect}, custom_fields: #{@custom_fields.inspect}, devices:"\
      " #{@devices.inspect}, group_name: #{@group_name.inspect}, primary_place_of_use:"\
      " #{@primary_place_of_use.inspect}, remove_cost_center: #{@remove_cost_center.inspect},"\
