...
module Verizon
  ...
  class TriggersListOptions < BaseModel
    ...
    def initialize(trigger_id: SKIP, trigger_name: SKIP,
                   ...
                   notification: SKIP, additional_properties: nil)
    ...
    def self.from_hash(hash)
      ...
      TriggersListOptions.new(trigger_id: trigger_id,
    ...
    def to_s
      ...
      " #{@modified_at}, anomalyattributes: #{@anomalyattributes}, notification: #{@notification},"\
      " additional_properties: #{@additional_properties}>"
    end
    ...
    def inspect
      ...
      " anomalyattributes: #{@anomalyattributes.inspect}, notification: #{@notification.inspect},"\
      " additional_properties: #{@additional_properties}>"
    end
  end
end
