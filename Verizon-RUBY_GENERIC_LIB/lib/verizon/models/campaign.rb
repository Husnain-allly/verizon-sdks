...
module Verizon
  ...
  class Campaign < BaseModel
    ...
    def initialize(id:, account_name:, protocol: 'LWM2M', make:, model:,
                   start_date:, end_date:, status:, auto_assign_license_flag:,
                   auto_add_devices_flag:, campaign_name: SKIP,
                   firmware_name: SKIP, firmware_from: SKIP, firmware_to: SKIP,
    ...
    def to_s
      ...
      " #{@campaign_time_window_list}, status: #{@status}, auto_assign_license_flag:"\
    ...
    def inspect
      ...
      " #{@campaign_time_window_list.inspect}, status: #{@status.inspect},"\
