...
module Verizon
  ...
  class CreateSubscriptionRequest < BaseModel
    ...
    def initialize(accountidentifier: SKIP, description: SKIP, disabled: SKIP,
                   email: SKIP, filter: SKIP, billingaccountid: SKIP,
                   streamkind: SKIP, targetid: SKIP, name: SKIP,
                   allowaggregation: SKIP, additional_properties: nil)
    ...
    def self.from_hash(hash)
      ...
      CreateSubscriptionRequest.new(accountidentifier: accountidentifier,
    ...
    def to_s
      ...
      "<#{class_name} accountidentifier: #{@accountidentifier}, description: #{@description},"\
      " disabled: #{@disabled}, email: #{@email}, filter: #{@filter}, billingaccountid:"\
      " #{@billingaccountid}, streamkind: #{@streamkind}, targetid: #{@targetid}, name: #{@name},"\
      " allowaggregation: #{@allowaggregation}, additional_properties: #{@additional_properties}>"
    end

    # Provides a debugging-friendly string with detailed object information.
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} accountidentifier: #{@accountidentifier.inspect}, description:"\
      " #{@description.inspect}, disabled: #{@disabled.inspect}, email: #{@email.inspect}, filter:"\
      " #{@filter.inspect}, billingaccountid: #{@billingaccountid.inspect}, streamkind:"\
      " #{@streamkind.inspect}, targetid: #{@targetid.inspect}, name: #{@name.inspect},"\
      " allowaggregation: #{@allowaggregation.inspect}, additional_properties:"\
