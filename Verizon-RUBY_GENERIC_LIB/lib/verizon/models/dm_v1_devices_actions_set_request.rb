...
module Verizon
  ...
  class DmV1DevicesActionsSetRequest < BaseModel
    SKIP = Object.new
    ...
    # The numeric account name, which must include leading zeros
    # @return [DtoDeviceActionSetConfiguration1]
    attr_accessor :configuration

    # Device identifiers, one or more are required
    # @return [DtoDeviceResourceIdentifier1]
    ...
    def self.from_hash(hash)
      ...
      configuration = DtoDeviceActionSetConfiguration1.from_hash(hash['configuration']) if
        hash['configuration']
      resourceidentifier = DtoDeviceResourceIdentifier1.from_hash(hash['resourceidentifier']) if
      ...
      DmV1DevicesActionsSetRequest.new(accountname: accountname,
