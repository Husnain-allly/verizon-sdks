...
module Verizon
  ...
  class Triggervalues2 < BaseModel
    ...
    def initialize(trigger_id: SKIP, trigger_name: SKIP, account_name: SKIP,
                   ...
                   promo_alerts: SKIP, active: SKIP, created_at: SKIP,
    ...
    def self.from_hash(hash)
      ...
      Triggervalues2.new(trigger_id: trigger_id,
    ...
    def to_s
      ...
      " #{@trigger_category}, promo_alerts: #{@promo_alerts}, active: #{@active}, created_at:"\
      " #{@created_at}, modified_at: #{@modified_at}, additional_properties:"\
    ...
    def inspect
      ...
      " active: #{@active.inspect}, created_at: #{@created_at.inspect}, modified_at:"\
      " #{@modified_at.inspect}, additional_properties: #{@additional_properties}>"
    end
  end
end
