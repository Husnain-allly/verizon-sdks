...
module Verizon
  ...
  class ConnectionHistoryResult < BaseModel
    ...
    def self.from_hash(hash)
      ...
      ConnectionHistoryResult.new(connection_history: connection_history,
    ...
    def to_s
      ...
      "<#{class_name} connection_history: #{@connection_history}, has_more_data:"\
      " #{@has_more_data}, additional_properties: #{@additional_properties}>"
    end

    # Provides a debugging-friendly string with detailed object information.
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} connection_history: #{@connection_history.inspect}, has_more_data:"\
      " #{@has_more_data.inspect}, additional_properties: #{@additional_properties}>"
    end
  end
end
