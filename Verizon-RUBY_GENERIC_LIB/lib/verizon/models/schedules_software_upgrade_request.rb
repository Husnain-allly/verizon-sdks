...
module Verizon
  ...
  class SchedulesSoftwareUpgradeRequest < BaseModel
    ...
    def initialize(campaign_name: SKIP, software_name: SKIP,
                   software_from: SKIP, software_to: SKIP,
    ...
    def self.from_hash(hash)
      ...
      SchedulesSoftwareUpgradeRequest.new(campaign_name: campaign_name,
