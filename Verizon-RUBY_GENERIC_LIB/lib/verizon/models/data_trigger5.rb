...
module Verizon
  ...
  class DataTrigger5 < BaseModel
    ...
    def initialize(filter_criteria: SKIP, condition: SKIP, action: SKIP,
                   ...
                   allowance_threshold: SKIP, device_group: SKIP,
                   account_group_share: SKIP, additional_properties: nil)
    ...
    def self.from_hash(hash)
      ...
      DataTrigger5.new(filter_criteria: filter_criteria,
                       condition: condition,
                       action: action,
                       ...
                       account_group_share: account_group_share,
                       additional_properties: additional_properties)
    end
    ...
    def to_s
      ...
      " allowance_threshold: #{@allowance_threshold}, device_group: #{@device_group},"\
      " account_group_share: #{@account_group_share}, additional_properties:"\
    ...
    def inspect
      ...
      " device_group: #{@device_group.inspect}, account_group_share:"\
      " #{@account_group_share.inspect}, additional_properties: #{@additional_properties}>"
    end
  end
end
