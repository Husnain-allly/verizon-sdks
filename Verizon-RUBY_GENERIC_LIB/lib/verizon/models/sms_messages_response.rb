...
module Verizon
  ...
  class SmsMessagesResponse < BaseModel
    ...
    def self.from_hash(hash)
      ...
      SmsMessagesResponse.new(messages: messages,
    ...
    def to_s
      ...
      "<#{class_name} messages: #{@messages}, has_more_data: #{@has_more_data}>"
    end

    # Provides a debugging-friendly string with detailed object information.
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} messages: #{@messages.inspect}, has_more_data: #{@has_more_data.inspect}>"
    end
  end
end
