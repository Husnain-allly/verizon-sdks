...
module Verizon
  ...
  class UpdateTriggerRequestOptions < BaseModel
    ...
    def initialize(trigger_id: SKIP, trigger_name: SKIP, trigger_category: SKIP,
                   account_name: SKIP, anomaly_trigger_request: SKIP,
    ...
    def self.from_hash(hash)
      ...
      UpdateTriggerRequestOptions.new(trigger_id: trigger_id,
    ...
    def to_s
      ...
      " trigger_category: #{@trigger_category}, account_name: #{@account_name},"\
      " anomaly_trigger_request: #{@anomaly_trigger_request}, notification: #{@notification},"\
      " active: #{@active}, additional_properties: #{@additional_properties}>"
    end
    ...
    def inspect
      ...
      " trigger_category: #{@trigger_category.inspect}, account_name: #{@account_name.inspect},"\
      " anomaly_trigger_request: #{@anomaly_trigger_request.inspect}, notification:"\
