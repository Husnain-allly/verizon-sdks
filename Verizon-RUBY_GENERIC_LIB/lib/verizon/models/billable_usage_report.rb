...
module Verizon
  ...
  class BillableUsageReport < BaseModel
    ...
    def initialize(account_name: SKIP, usage_for_all_accounts: SKIP,
                   ...
                   managed_accounts: SKIP, additional_properties: nil)
    ...
    def self.from_hash(hash)
      ...
      BillableUsageReport.new(account_name: account_name,
    ...
    def to_s
      ...
      "<#{class_name} account_name: #{@account_name}, usage_for_all_accounts:"\
      " #{@usage_for_all_accounts}, sku_name: #{@sku_name}, transactions_allowed:"\
      " #{@transactions_allowed}, total_transaction_count: #{@total_transaction_count},"\
      " primary_account: #{@primary_account}, managed_accounts: #{@managed_accounts},"\
      " additional_properties: #{@additional_properties}>"
    end
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} account_name: #{@account_name.inspect}, usage_for_all_accounts:"\
      " #{@usage_for_all_accounts.inspect}, sku_name: #{@sku_name.inspect}, transactions_allowed:"\
      " #{@transactions_allowed.inspect}, total_transaction_count:"\
      " #{@total_transaction_count.inspect}, primary_account: #{@primary_account.inspect},"\
      " managed_accounts: #{@managed_accounts.inspect}, additional_properties:"\
