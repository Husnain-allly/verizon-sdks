...
module Verizon
  ...
  class ARequestBodyForUsage < BaseModel
    SKIP = Object.new
    ...
    def initialize(device_id: SKIP, start_time: SKIP, end_time: SKIP,
    ...
    def self.from_hash(hash)
      ...
      ARequestBodyForUsage.new(device_id: device_id,
    ...
    def to_s
      ...
      "<#{class_name} device_id: #{@device_id}, start_time: #{@start_time}, end_time:"\
      " #{@end_time}, additional_properties: #{@additional_properties}>"
    end

    # Provides a debugging-friendly string with detailed object information.
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} device_id: #{@device_id.inspect}, start_time: #{@start_time.inspect},"\
      " end_time: #{@end_time.inspect}, additional_properties: #{@additional_properties}>"
    end
  end
end
