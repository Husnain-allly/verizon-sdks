...
module Verizon
  ...
  class SensorInsightsRulesApi < BaseApi
    # TODO: type endpoint description here
    # @param [DtoOverwriteRuleRequest] body Required parameter: Overwrite a
    # rule
    ...
    # TODO: type endpoint description here
    # @param [DtoListRulesRequest] body Required parameter: Retrieve a rule
    # @return [ApiResponse] Complete http response with raw body and status code.
