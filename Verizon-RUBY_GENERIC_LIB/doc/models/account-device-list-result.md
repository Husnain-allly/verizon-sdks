...
|  --- | --- | --- | --- |
| `devices` | [`Array<ThingspaceDevice>`](../../doc/models/thingspace-device.md) | Optional | Up to 10,000 devices that you want to move to a different account, specified by device identifier. |
