...
export interface PayAsYouGoUpdateTriggerRequest {
...
export const payAsYouGoUpdateTriggerRequestSchema: Schema<PayAsYouGoUpdateTriggerRequest> = typedExpandoObject(
  {
