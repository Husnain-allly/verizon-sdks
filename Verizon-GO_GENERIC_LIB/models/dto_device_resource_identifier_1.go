...
// DtoDeviceResourceIdentifier1 represents a DtoDeviceResourceIdentifier1 struct.
// Device identifiers, one or more are required
type DtoDeviceResourceIdentifier1 struct {
...
// String implements the fmt.Stringer interface for DtoDeviceResourceIdentifier1,
// providing a human-readable string representation useful for logging, debugging or displaying information.
func (d DtoDeviceResourceIdentifier1) String() string {
    return fmt.Sprintf(
    	"DtoDeviceResourceIdentifier1[Deveui=%v, Deviceid=%v, Esn=%v, Iccid=%v, Imei=%v, Imsi=%v, Mac=%v, Manufacturer=%v, Meid=%v, Msisdn=%v, NodeUuid=%v, Qrcode=%v, Serial=%v, Id=%v]",
    	d.Deveui, d.Deviceid, d.Esn, d.Iccid, d.Imei, d.Imsi, d.Mac, d.Manufacturer, d.Meid, d.Msisdn, d.NodeUuid, d.Qrcode, d.Serial, d.Id)
}

// MarshalJSON implements the json.Marshaler interface for DtoDeviceResourceIdentifier1.
// It customizes the JSON marshaling process for DtoDeviceResourceIdentifier1 objects.
func (d DtoDeviceResourceIdentifier1) MarshalJSON() (
    []byte,
    error) {
    return json.Marshal(d.toMap())
}

// toMap converts the DtoDeviceResourceIdentifier1 object to a map representation for JSON marshaling.
func (d DtoDeviceResourceIdentifier1) toMap() map[string]any {
...
// UnmarshalJSON implements the json.Unmarshaler interface for DtoDeviceResourceIdentifier1.
// It customizes the JSON unmarshaling process for DtoDeviceResourceIdentifier1 objects.
func (d *DtoDeviceResourceIdentifier1) UnmarshalJSON(input []byte) error {
    var temp tempDtoDeviceResourceIdentifier1
...
// tempDtoDeviceResourceIdentifier1 is a temporary struct used for validating the fields of DtoDeviceResourceIdentifier1.
type tempDtoDeviceResourceIdentifier1  struct {
    Deveui       *string `json:"deveui,omitempty"`
    Deviceid     *string `json:"deviceid,omitempty"`
    Esn          *int    `json:"esn,omitempty"`
    Iccid        *string `json:"iccid,omitempty"`
