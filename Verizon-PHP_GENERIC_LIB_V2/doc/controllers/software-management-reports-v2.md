...
```php
$softwareManagementReportsV2Api = $client->getSoftwareManagementReportsV2Api();
```
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `getResult()` method on this instance returns the response data which is of type [`SoftwarePackage[]`](../../doc/models/software-package.md).
...
$apiResponse = $softwareManagementReportsV2Api->listAvailableSoftware(
    $account,
    $distributionType
);
```
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `getResult()` method on this instance returns the response data which is of type [`V2AccountDeviceList`](../../doc/models/v2-account-device-list.md).
...
$apiResponse = $softwareManagementReportsV2Api->listAccountDevices(
    $account,
    $lastSeenDeviceId,
    $distributionType
);
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `getResult()` method on this instance returns the response data which is of type [`DeviceSoftwareUpgrade[]`](../../doc/models/device-software-upgrade.md).
...
$apiResponse = $softwareManagementReportsV2Api->getDeviceFirmwareUpgradeHistory(
    $account,
    $deviceId
);
```
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `getResult()` method on this instance returns the response data which is of type [`V2CampaignHistory`](../../doc/models/v2-campaign-history.md).
...
$apiResponse = $softwareManagementReportsV2Api->getCampaignHistoryByStatus(
    $account,
    $campaignStatus,
    $lastSeenCampaignId
);
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `getResult()` method on this instance returns the response data which is of type [`V2CampaignDevice`](../../doc/models/v2-campaign-device.md).
...
$apiResponse = $softwareManagementReportsV2Api->getCampaignDeviceStatus(
    $account,
    $campaignId,
    $lastSeenDeviceId
);
