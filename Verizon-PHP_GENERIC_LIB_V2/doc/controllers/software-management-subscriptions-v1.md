...
```php
$softwareManagementSubscriptionsV1Api = $client->getSoftwareManagementSubscriptionsV1Api();
```
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `getResult()` method on this instance returns the response data which is of type [`V1AccountSubscription`](../../doc/models/v1-account-subscription.md).
...
$apiResponse = $softwareManagementSubscriptionsV1Api->getAccountSubscriptionStatus($account);
```
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `getResult()` method on this instance returns the response data which is of type [`AccountLicenseInfo`](../../doc/models/account-license-info.md).
...
$apiResponse = $softwareManagementSubscriptionsV1Api->getAccountLicenseStatus(
    $account,
    $startIndex
);
```
