...
```php
$cloudConnectorSubscriptionsApi = $client->getCloudConnectorSubscriptionsApi();
```
...
$apiResponse = $cloudConnectorSubscriptionsApi->createSubscription($body);
```
...
$apiResponse = $cloudConnectorSubscriptionsApi->querySubscription($body);
```
...
$apiResponse = $cloudConnectorSubscriptionsApi->deleteSubscription($body);
```
