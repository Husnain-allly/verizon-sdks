...
```php
$deviceGroupsApi = $client->getDeviceGroupsApi();
```
...
$apiResponse = $deviceGroupsApi->createDeviceGroup($body);
```
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `getResult()` method on this instance returns the response data which is of type [`DeviceGroup[]`](../../doc/models/device-group.md).
...
$apiResponse = $deviceGroupsApi->listDeviceGroups($aname);
```
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `getResult()` method on this instance returns the response data which is of type [`DeviceGroupDevicesData`](../../doc/models/device-group-devices-data.md).
...
$apiResponse = $deviceGroupsApi->getDeviceGroupInformation(
    $aname,
    $gname
);
```
...
$apiResponse = $deviceGroupsApi->updateDeviceGroup(
    $aname,
    $gname,
    $body
);
...
$apiResponse = $deviceGroupsApi->deleteDeviceGroup(
    $aname,
    $gname
);
```
