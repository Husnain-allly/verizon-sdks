...
```php
function domestic4GAnd5GNationwideNetworkCoverage(M2MV1IntelligenceWirelessCoverageRequest $body): ApiResponse
```
...
```php
$body = M2MV1IntelligenceWirelessCoverageRequestBuilder::init()
    ->accountName('0000123456-00001')
    ->requestType('FWA')
    ->locationType('ADDRESS')
    ->locations(
        Locations1Builder::init()
            ->addressList(
                [
