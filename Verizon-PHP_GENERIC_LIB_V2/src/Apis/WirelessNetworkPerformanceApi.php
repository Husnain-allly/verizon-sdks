...
class WirelessNetworkPerformanceApi extends BaseApi
{
     ...
     *
     * @param M2MV1IntelligenceWirelessCoverageRequest $body Request for network coverage details.
     *
     * @return ApiResponse Response from the API call
     */
    public function domestic4GAnd5GNationwideNetworkCoverage(
        M2MV1IntelligenceWirelessCoverageRequest $body
    ): ApiResponse {
