...
class ManagementErrorException extends ApiException
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the ManagementErrorException object to a human-readable string representation.
     *
     * @return string The string representation of the ManagementErrorException object.
     */
