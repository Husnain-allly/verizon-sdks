 ...
 */
class ThingspaceOauth1Manager extends CoreAuth implements ThingspaceOauth1Credentials
{
    /**
    ...
    {
        return $this->config['oauthClientId2'] ?? ConfigurationDefaults::O_AUTH_CLIENT_ID_2;
    }
    ...
    {
        return $this->config['oauthClientSecret2'] ?? ConfigurationDefaults::O_AUTH_CLIENT_SECRET_2;
    }
    ...
    {
        $oauthToken = $this->config['oauthToken2'];
        if ($oauthToken instanceof OauthToken) {
            return clone $oauthToken;
        }
        return ConfigurationDefaults::O_AUTH_TOKEN_2;
    }
    ...
    {
        return $this->config['thingspace_oauth1-ClockSkew'] ?? ConfigurationDefaults::THINGSPACE_OAUTH_1_CLOCK_SKEW;
    }
    ...
    public function fetchToken(?array $additionalParams = null): OauthToken
    {
        ...
        $response = $this->oAuthApi->requestTokenThingspaceOauth1(
    ...
    private function getTokenFromProvider(): ?OAuthToken
    {
        ...
        $provider = $this->config['thingspace_oauth1-TokenProvider'];
        ...
        $updateCallback = $this->config['thingspace_oauth1-OnTokenUpdate'];
