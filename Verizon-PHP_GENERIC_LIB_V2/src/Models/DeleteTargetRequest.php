...
class DeleteTargetRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the DeleteTargetRequest object to a human-readable string representation.
     *
     * @return string The string representation of the DeleteTargetRequest object.
     */
