...
class SearchDeviceByPropertyResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the SearchDeviceByPropertyResponse object to a human-readable string representation.
     *
     * @return string The string representation of the SearchDeviceByPropertyResponse object.
     */
