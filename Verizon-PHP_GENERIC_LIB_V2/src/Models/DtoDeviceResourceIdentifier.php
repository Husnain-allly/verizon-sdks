 ...
 */
class DtoDeviceResourceIdentifier implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the DtoDeviceResourceIdentifier object to a human-readable string representation.
     *
     * @return string The string representation of the DtoDeviceResourceIdentifier object.
     */
