...
class PricePlanTrigger2 implements \JsonSerializable
{
    /**
    ...
    /**
     * Converts the PricePlanTrigger2 object to a human-readable string representation.
     *
     * @return string The string representation of the PricePlanTrigger2 object.
     */
