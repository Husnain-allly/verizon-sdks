...
/**
 * Builder for model AccountLevelCreateTriggerRequest
 *
 * @see AccountLevelCreateTriggerRequest
 */
class AccountLevelCreateTriggerRequestBuilder
{
    /**
     * @var AccountLevelCreateTriggerRequest
     */
    private $instance;

    private function __construct(AccountLevelCreateTriggerRequest $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Account Level Create Trigger Request Builder object.
     */
    public static function init(): self
    {
        return new self(new AccountLevelCreateTriggerRequest());
    }
    ...
    /**
     * Initializes a new Account Level Create Trigger Request object.
     */
    public function build(): AccountLevelCreateTriggerRequest
    {
