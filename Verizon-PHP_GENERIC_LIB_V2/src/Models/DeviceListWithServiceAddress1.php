...
class DeviceListWithServiceAddress1 implements \JsonSerializable
{
    ...
    /**
     * Converts the DeviceListWithServiceAddress1 object to a human-readable string representation.
     *
     * @return string The string representation of the DeviceListWithServiceAddress1 object.
     */
