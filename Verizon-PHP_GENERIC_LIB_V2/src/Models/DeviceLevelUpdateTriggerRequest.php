...
class DeviceLevelUpdateTriggerRequest implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the DeviceLevelUpdateTriggerRequest object to a human-readable string representation.
     *
     * @return string The string representation of the DeviceLevelUpdateTriggerRequest object.
     */
