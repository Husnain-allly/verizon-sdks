 ...
 */
class V3LicenseSummary implements \JsonSerializable
{
    /**
     * @var string
     */
     ...
     * @maps deviceList
     *
     * @param V3LicenseDevice[]|null $deviceList
     */
    ...
    /**
     * Converts the V3LicenseSummary object to a human-readable string representation.
     *
     * @return string The string representation of the V3LicenseSummary object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            ...
            [
                ...
                'assignedLicenses' => $this->assignedLicenses,
