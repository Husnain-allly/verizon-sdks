...
class EsimProfileRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the EsimProfileRequest object to a human-readable string representation.
     *
     * @return string The string representation of the EsimProfileRequest object.
     */
