...
class DeviceLevelUpdateTrigger implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the DeviceLevelUpdateTrigger object to a human-readable string representation.
     *
     * @return string The string representation of the DeviceLevelUpdateTrigger object.
     */
