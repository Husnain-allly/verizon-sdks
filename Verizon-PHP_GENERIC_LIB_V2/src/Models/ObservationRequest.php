...
class ObservationRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the ObservationRequest object to a human-readable string representation.
     *
     * @return string The string representation of the ObservationRequest object.
     */
    ...
    protected $propertyNames = ['accountName', 'devices', 'attributes', 'frequency', 'duration'];
