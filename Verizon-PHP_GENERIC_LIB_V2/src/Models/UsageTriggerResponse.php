...
class UsageTriggerResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the UsageTriggerResponse object to a human-readable string representation.
     *
     * @return string The string representation of the UsageTriggerResponse object.
     */
