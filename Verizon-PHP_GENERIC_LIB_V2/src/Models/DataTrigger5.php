...
class DataTrigger5 implements \JsonSerializable
{
    /**
    ...
    /**
     * Converts the DataTrigger5 object to a human-readable string representation.
     *
     * @return string The string representation of the DataTrigger5 object.
     */
