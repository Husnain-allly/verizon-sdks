 ...
 */
class AnomalyTriggerRequest implements \JsonSerializable
{
    /**
     * @var string|null
     */
     ...
     * The Verizon billing accounts associated with the anomaly triggers for this trigger to be active for
    ...
    /**
     * Converts the AnomalyTriggerRequest object to a human-readable string representation.
     *
     * @return string The string representation of the AnomalyTriggerRequest object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            ...
            [
                ...
                'includeAbnormal' => $this->includeAbnormal,
                'includeVeryAbnormal' => $this->includeVeryAbnormal,
                'includeUnderExpectedUsage' => $this->includeUnderExpectedUsage,
                'includeOverExpectedUsage' => $this->includeOverExpectedUsage
            ]
        );
    }
