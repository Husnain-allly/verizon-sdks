...
class Updatetriggerchunk implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the Updatetriggerchunk object to a human-readable string representation.
     *
     * @return string The string representation of the Updatetriggerchunk object.
     */
