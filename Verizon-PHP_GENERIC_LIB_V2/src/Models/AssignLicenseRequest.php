...
class AssignLicenseRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the AssignLicenseRequest object to a human-readable string representation.
     *
     * @return string The string representation of the AssignLicenseRequest object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            'AssignLicenseRequest',
            ['accountName' => $this->accountName, 'devices' => $this->devices, 'skuNumber' => $this->skuNumber]
        );
    }
