...
class UploadsActivatesDeviceRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the UploadsActivatesDeviceRequest object to a human-readable string representation.
     *
     * @return string The string representation of the UploadsActivatesDeviceRequest object.
     */
