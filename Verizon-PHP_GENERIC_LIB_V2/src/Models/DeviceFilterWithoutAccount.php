...
class DeviceFilterWithoutAccount implements \JsonSerializable
{
    ...
    /**
     * Converts the DeviceFilterWithoutAccount object to a human-readable string representation.
     *
     * @return string The string representation of the DeviceFilterWithoutAccount object.
     */
    ...
    protected $propertyNames = ['groupName', 'servicePlan', 'customFields'];
