...
class ManagedAccountCancelRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the ManagedAccountCancelRequest object to a human-readable string representation.
     *
     * @return string The string representation of the ManagedAccountCancelRequest object.
     */
