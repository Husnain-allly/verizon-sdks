...
class PromoAlert implements \JsonSerializable
{
    /**
    ...
    /**
     * Converts the PromoAlert object to a human-readable string representation.
     *
     * @return string The string representation of the PromoAlert object.
     */
