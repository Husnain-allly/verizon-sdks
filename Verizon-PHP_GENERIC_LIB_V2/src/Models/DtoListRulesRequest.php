...
class DtoListRulesRequest implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the DtoListRulesRequest object to a human-readable string representation.
     *
     * @return string The string representation of the DtoListRulesRequest object.
     */
