...
class PayAsYouGoCreateTriggerRequest implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the PayAsYouGoCreateTriggerRequest object to a human-readable string representation.
     *
     * @return string The string representation of the PayAsYouGoCreateTriggerRequest object.
     */
