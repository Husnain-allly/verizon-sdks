...
class DeviceAggregateUsageListRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the DeviceAggregateUsageListRequest object to a human-readable string representation.
     *
     * @return string The string representation of the DeviceAggregateUsageListRequest object.
     */
    ...
    protected $propertyNames = ['startTime', 'endTime', 'deviceIds', 'accountName', 'groupName', 'label'];
