...
class CreateTriggerRequestOptions implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the CreateTriggerRequestOptions object to a human-readable string representation.
     *
     * @return string The string representation of the CreateTriggerRequestOptions object.
     */
