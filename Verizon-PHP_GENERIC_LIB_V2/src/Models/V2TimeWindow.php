 ...
 */
class V2TimeWindow implements \JsonSerializable
{
    /**
     * @var int
     */
    ...
    /**
     * Converts the V2TimeWindow object to a human-readable string representation.
     *
     * @return string The string representation of the V2TimeWindow object.
     */
