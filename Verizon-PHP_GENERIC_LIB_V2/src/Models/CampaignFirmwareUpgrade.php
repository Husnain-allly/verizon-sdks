...
class CampaignFirmwareUpgrade implements \JsonSerializable
{
    ...
    /**
     * Converts the CampaignFirmwareUpgrade object to a human-readable string representation.
     *
     * @return string The string representation of the CampaignFirmwareUpgrade object.
     */
