...
class DtoConfigurationProfileDelete implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the DtoConfigurationProfileDelete object to a human-readable string representation.
     *
     * @return string The string representation of the DtoConfigurationProfileDelete object.
     */
