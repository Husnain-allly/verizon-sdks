...
class V2TriggersRequest1 implements \JsonSerializable
{
    /**
     * @var string|null
     */
     ...
     */
    public function getDataTrigger(): ?DataTrigger5
    {
     ...
     * @maps dataTrigger
     */
    public function setDataTrigger(?DataTrigger5 $dataTrigger): void
    {
     ...
     */
    public function getPricePlanTrigger(): ?PricePlanTrigger2
    {
     ...
     */
    public function setPricePlanTrigger(?PricePlanTrigger2 $pricePlanTrigger): void
    {
        $this->pricePlanTrigger = $pricePlanTrigger;
    }

    /**
     * Converts the V2TriggersRequest1 object to a human-readable string representation.
     *
     * @return string The string representation of the V2TriggersRequest1 object.
     */
