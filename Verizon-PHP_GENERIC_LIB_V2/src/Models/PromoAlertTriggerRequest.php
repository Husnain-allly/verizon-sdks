...
class PromoAlertTriggerRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the PromoAlertTriggerRequest object to a human-readable string representation.
     *
     * @return string The string representation of the PromoAlertTriggerRequest object.
     */
