...
class SmsEventHistoryRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the SmsEventHistoryRequest object to a human-readable string representation.
     *
     * @return string The string representation of the SmsEventHistoryRequest object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            'SmsEventHistoryRequest',
            ['deviceId' => $this->deviceId, 'earliest' => $this->earliest, 'latest' => $this->latest]
        );
    }
