...
public class MessageBase {
     ...
     * @param  limits  List of Object value for limits.
     ...
     * precise by defining speed and motion direction requirements to be met before the messages are
     * sent out.
     * @param limits Value for List of Object
     */
    @JsonSetter("limits")
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder limits(List<Object> limits) {
            this.limits = limits;
            return this;
        }
        ...
        public MessageBase build() {
            MessageBase model =
                    new MessageBase(isPrivate, roadUserType, triggerConditions, limits,
