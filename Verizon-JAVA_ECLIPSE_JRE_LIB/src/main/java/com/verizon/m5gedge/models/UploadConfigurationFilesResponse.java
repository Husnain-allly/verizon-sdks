...
public class UploadConfigurationFilesResponse {
    ...
    public static class Builder {
        ...
        public UploadConfigurationFilesResponse build() {
            UploadConfigurationFilesResponse model2 =
                    new UploadConfigurationFilesResponse(fileName, fileVersion, launchDate,
                            releaseNote, model, make, distributionType, devicePlatformId,
                            localTargetPath);
