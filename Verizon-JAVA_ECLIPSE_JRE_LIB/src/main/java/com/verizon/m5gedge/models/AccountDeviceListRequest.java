...
public class AccountDeviceListRequest {
    ...
    public String toString() {
        return "AccountDeviceListRequest [" + "accountName=" + accountName + ", deviceId="
                ...
                + largestDeviceIdSeen + ", additionalProperties=" + additionalProperties + "]";
    }
    ...
    public static class Builder {
        ...
        public AccountDeviceListRequest build() {
            AccountDeviceListRequest model =
                    new AccountDeviceListRequest(accountName, deviceId, filter, currentState,
                            customFields, earliest, groupName, latest, servicePlan,
                            maxNumberOfDevices, largestDeviceIdSeen);
