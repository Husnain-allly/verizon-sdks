...
public class FotaV1CallbackRegistrationRequest {
    ...
    public String toString() {
        return "FotaV1CallbackRegistrationRequest [" + "name=" + name + ", url=" + url
                + ", username=" + username + ", password=" + password + ", additionalProperties="
    ...
    public static class Builder {
        ...
        public FotaV1CallbackRegistrationRequest build() {
            FotaV1CallbackRegistrationRequest model =
                    new FotaV1CallbackRegistrationRequest(name, url, username, password);
