...
public class V2AccountDevice {
    ...
    public String toString() {
        return "V2AccountDevice [" + "deviceId=" + deviceId + ", mdn=" + mdn + ", model=" + model
                ...
                + refreshTime + ", additionalProperties=" + additionalProperties + "]";
    }
    ...
    public static class Builder {
        ...
        public V2AccountDevice build() {
            V2AccountDevice model2 =
                    new V2AccountDevice(deviceId, mdn, model, make, fotaEligible, appFotaEligible,
                            licenseAssigned, distributionType, softwareList, createTime,
