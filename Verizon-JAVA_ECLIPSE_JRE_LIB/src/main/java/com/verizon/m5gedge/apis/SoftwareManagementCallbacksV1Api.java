...
import com.verizon.m5gedge.models.CallbackService;
 ...
 */
public final class SoftwareManagementCallbacksV1Api extends BaseApi {

    /**
     * Initializes the controller.
     * @param globalConfig    Configurations added in client.
     */
    public SoftwareManagementCallbacksV1Api(GlobalConfiguration globalConfig) {
        super(globalConfig);
    }
    ...
    public ApiResponse<FotaV1SuccessResult> deregisterCallback(
            final String account,
            final CallbackService service) throws ApiException, IOException {
