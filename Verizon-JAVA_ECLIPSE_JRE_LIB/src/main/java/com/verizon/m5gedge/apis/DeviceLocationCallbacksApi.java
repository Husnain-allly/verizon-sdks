...
import com.verizon.m5gedge.models.CallbackServiceName;
 ...
 */
public final class DeviceLocationCallbacksApi extends BaseApi {

    /**
     * Initializes the controller.
     * @param globalConfig    Configurations added in client.
     */
    public DeviceLocationCallbacksApi(GlobalConfiguration globalConfig) {
        super(globalConfig);
    }
    ...
    public ApiResponse<DeviceLocationSuccessResult> deregisterCallback(
            final String accountName,
            final CallbackServiceName service) throws ApiException, IOException {
