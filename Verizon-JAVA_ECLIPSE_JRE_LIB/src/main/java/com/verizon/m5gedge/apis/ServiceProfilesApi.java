 ...
 */
public final class ServiceProfilesApi extends BaseApi {

    /**
     * Initializes the controller.
     * @param globalConfig    Configurations added in client.
     */
    public ServiceProfilesApi(GlobalConfiguration globalConfig) {
        super(globalConfig);
    }
     ...
     */
    private ApiCall<ApiResponse<ListServiceProfilesResult>, ApiException> prepareListServiceProfilesRequest() {
     ...
     * @param  serviceProfileId  Required parameter:
