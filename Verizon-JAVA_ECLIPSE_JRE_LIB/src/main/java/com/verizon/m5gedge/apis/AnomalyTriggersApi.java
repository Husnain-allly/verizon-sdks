 ...
 */
public final class AnomalyTriggersApi extends BaseApi {

    /**
     * Initializes the controller.
     * @param globalConfig    Configurations added in client.
     */
    public AnomalyTriggersApi(GlobalConfiguration globalConfig) {
        super(globalConfig);
    }
     ...
     */
    private ApiCall<ApiResponse<List<GetTriggerResponseList>>, ApiException> prepareListAnomalyDetectionTriggersRequest() {
