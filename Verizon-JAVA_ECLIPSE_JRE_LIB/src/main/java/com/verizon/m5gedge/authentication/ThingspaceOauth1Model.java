 ...
 */
public class ThingspaceOauth1Model {
    private String oauthClientId;
    private String oauthClientSecret;
    private OauthToken oauthToken;
    private BiFunction<OauthToken, ThingspaceOauth1Credentials, OauthToken> oauthTokenProvider;
    private Consumer<OauthToken> oauthOnTokenUpdate;
    private long oauthClockSkew;

    /**
     * A Constructor for ThingspaceOauth1Model.
     */
    private ThingspaceOauth1Model(String oauthClientId, String oauthClientSecret,
            OauthToken oauthToken,
            BiFunction<OauthToken, ThingspaceOauth1Credentials, OauthToken> oauthTokenProvider,
     ...
     */
    public BiFunction<OauthToken, ThingspaceOauth1Credentials, OauthToken> getOauthTokenProvider() {
    ...
    /**
     * Builds a new {@link ThingspaceOauth1Model.Builder} object.
     * Creates the instance with the state of the current auth model.
     * @return a new {@link ThingspaceOauth1Model.Builder} object.
     */
    ...
    public static class Builder {
         ...
         * @return Builder The current instance of Builder.
         */
        public Builder oauthTokenProvider(BiFunction<OauthToken, ThingspaceOauth1Credentials, OauthToken> oauthTokenProvider) {
            this.oauthTokenProvider = oauthTokenProvider;
            return this;
        }
        ...
        /**
         * Builds the instance of ThingspaceOauth1Model using the provided credentials.
         * @return The instance of ThingspaceOauth1Model.
         */
        public ThingspaceOauth1Model build() {
            return new ThingspaceOauth1Model(oauthClientId, oauthClientSecret, oauthToken,
