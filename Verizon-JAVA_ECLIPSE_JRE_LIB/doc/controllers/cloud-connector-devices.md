...
```java
CloudConnectorDevicesApi cloudConnectorDevicesApi = client.getCloudConnectorDevicesApi();
```
...
cloudConnectorDevicesApi.updateDevicesConfigurationValueAsync(body).thenAccept(result -> {
...
cloudConnectorDevicesApi.findDeviceByPropertyValuesAsync(body).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    // TODO failure callback handler
...
QuerySubscriptionRequest body = new QuerySubscriptionRequest.Builder()
    .accountidentifier(new AccountIdentifier.Builder()
        .billingaccountid("1223334444-00001")
        .build())
    .mSelection(new LinkedHashMap<String, String>() {{
        put("iccid", "89148000003499233389");
    }})
    .build();

cloudConnectorDevicesApi.searchDevicesResourcesByPropertyValuesAsync(body).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    // TODO failure callback handler
...
cloudConnectorDevicesApi.searchDeviceEventHistoryAsync(body).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    // TODO failure callback handler
...
cloudConnectorDevicesApi.searchSensorReadingsAsync(fieldname, body).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    // TODO failure callback handler
...
cloudConnectorDevicesApi.deleteDeviceFromAccountAsync(body).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    // TODO failure callback handler
