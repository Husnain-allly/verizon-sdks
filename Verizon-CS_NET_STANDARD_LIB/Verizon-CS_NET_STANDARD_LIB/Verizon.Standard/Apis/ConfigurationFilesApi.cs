// <copyright file="ConfigurationFilesApi.cs" company="APIMatic">
...
namespace Verizon.Standard.Apis
{
    ...
    /// </summary>
    public class ConfigurationFilesApi : BaseApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfigurationFilesApi"/> class.
        /// </summary>
        internal ConfigurationFilesApi(GlobalConfiguration globalConfiguration) : base(globalConfiguration) { }
            ...
            => await CreateApiCall<Models.RetrievesAvailableFilesResponseList>()
              ...
              .RequestBuilder(_requestBuilder => _requestBuilder
                  ...
                  .Parameters(_parameters => _parameters
                      ...
                      .Query(_query => _query.Setup("distributionType", distributionType).Required())))
