// <copyright file="CloudConnectorSubscriptionsApi.cs" company="APIMatic">
...
namespace Verizon.Standard.Apis
{
    ...
    /// </summary>
    public class CloudConnectorSubscriptionsApi : BaseApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CloudConnectorSubscriptionsApi"/> class.
        /// </summary>
        internal CloudConnectorSubscriptionsApi(GlobalConfiguration globalConfiguration) : base(globalConfiguration) { }
