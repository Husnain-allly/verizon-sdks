// <copyright file="DiagnosticsFactoryResetApi.cs" company="APIMatic">
...
namespace Verizon.Standard.Apis
{
    ...
    /// </summary>
    public class DiagnosticsFactoryResetApi : BaseApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DiagnosticsFactoryResetApi"/> class.
        /// </summary>
        internal DiagnosticsFactoryResetApi(GlobalConfiguration globalConfiguration) : base(globalConfiguration) { }
