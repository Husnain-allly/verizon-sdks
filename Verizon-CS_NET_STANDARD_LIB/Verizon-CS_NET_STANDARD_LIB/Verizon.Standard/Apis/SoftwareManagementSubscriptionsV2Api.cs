// <copyright file="SoftwareManagementSubscriptionsV2Api.cs" company="APIMatic">
...
namespace Verizon.Standard.Apis
{
    ...
    /// </summary>
    public class SoftwareManagementSubscriptionsV2Api : BaseApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SoftwareManagementSubscriptionsV2Api"/> class.
        /// </summary>
        internal SoftwareManagementSubscriptionsV2Api(GlobalConfiguration globalConfiguration) : base(globalConfiguration) { }
