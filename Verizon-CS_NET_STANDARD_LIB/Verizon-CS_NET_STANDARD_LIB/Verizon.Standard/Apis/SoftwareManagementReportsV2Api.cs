// <copyright file="SoftwareManagementReportsV2Api.cs" company="APIMatic">
...
namespace Verizon.Standard.Apis
{
    ...
    /// </summary>
    public class SoftwareManagementReportsV2Api : BaseApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SoftwareManagementReportsV2Api"/> class.
        /// </summary>
        internal SoftwareManagementReportsV2Api(GlobalConfiguration globalConfiguration) : base(globalConfiguration) { }
        ...
        public async Task<ApiResponse<Models.V2CampaignHistory>> GetCampaignHistoryByStatusAsync(
            ...
            => await CreateApiCall<Models.V2CampaignHistory>()
              ...
              .RequestBuilder(_requestBuilder => _requestBuilder
                  ...
                  .Parameters(_parameters => _parameters
                      .Template(_template => _template.Setup("account", account).Required())
                      .Query(_query => _query.Setup("campaignStatus", campaignStatus).Required())
