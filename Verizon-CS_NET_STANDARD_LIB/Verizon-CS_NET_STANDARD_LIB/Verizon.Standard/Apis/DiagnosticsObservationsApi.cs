// <copyright file="DiagnosticsObservationsApi.cs" company="APIMatic">
...
namespace Verizon.Standard.Apis
{
    ...
    /// </summary>
    public class DiagnosticsObservationsApi : BaseApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DiagnosticsObservationsApi"/> class.
        /// </summary>
        internal DiagnosticsObservationsApi(GlobalConfiguration globalConfiguration) : base(globalConfiguration) { }
        ...
        public async Task<ApiResponse<Models.DiagnosticsObservationResult>> StopDiagnosticsObservationAsync(
            ...
            => await CreateApiCall<Models.DiagnosticsObservationResult>()
              ...
              .RequestBuilder(_requestBuilder => _requestBuilder
                  ...
                  .Parameters(_parameters => _parameters
                      .Query(_query => _query.Setup("transactionId", transactionId).Required())
