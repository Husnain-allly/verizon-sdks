// <copyright file="DeviceServiceManagementApi.cs" company="APIMatic">
...
namespace Verizon.Standard.Apis
{
    ...
    /// </summary>
    public class DeviceServiceManagementApi : BaseApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceServiceManagementApi"/> class.
        /// </summary>
        internal DeviceServiceManagementApi(GlobalConfiguration globalConfiguration) : base(globalConfiguration) { }
            ...
            => await CreateApiCall<Models.BullseyeServiceResult>()
              ...
              .RequestBuilder(_requestBuilder => _requestBuilder
                  ...
                  .Parameters(_parameters => _parameters
                      .Query(_query => _query.Setup("imei", imei).Required())
