// <copyright file="TargetsApi.cs" company="APIMatic">
...
namespace Verizon.Standard.Apis
{
    ...
    /// TargetsApi.
    /// </summary>
    public class TargetsApi : BaseApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TargetsApi"/> class.
        /// </summary>
        internal TargetsApi(GlobalConfiguration globalConfiguration) : base(globalConfiguration) { }
        ...
        /// <returns>Returns the ApiResponse of List of Models.Target response from the API call.</returns>
        ...
        public async Task<ApiResponse<Models.CreateIoTApplicationResponse>> CreateAzureCentralIoTApplicationAsync(
            ...
            => await CreateApiCall<Models.CreateIoTApplicationResponse>()
              ...
              .RequestBuilder(_requestBuilder => _requestBuilder
                  ...
                  .Parameters(_parameters => _parameters
                      .Body(_bodyParameter => _bodyParameter.Setup(body).Required())
                      .Header(_header => _header.Setup("BillingaccountID", billingaccountId).Required())
                      .Header(_header => _header.Setup("Content-Type", "application/json"))))
              .ExecuteAsync(cancellationToken).ConfigureAwait(false);
    }
}