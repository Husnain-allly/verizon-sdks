// <copyright file="DeviceGroupsApi.cs" company="APIMatic">
...
namespace Verizon.Standard.Apis
{
    ...
    /// DeviceGroupsApi.
    /// </summary>
    public class DeviceGroupsApi : BaseApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceGroupsApi"/> class.
        /// </summary>
        internal DeviceGroupsApi(GlobalConfiguration globalConfiguration) : base(globalConfiguration) { }
        ...
        /// <returns>Returns the ApiResponse of List of Models.DeviceGroup response from the API call.</returns>
        ...
        public async Task<ApiResponse<Models.DeviceGroupDevicesData>> GetDeviceGroupInformationAsync(
            ...
            => await CreateApiCall<Models.DeviceGroupDevicesData>()
              ...
              .RequestBuilder(_requestBuilder => _requestBuilder
                  ...
                  .Parameters(_parameters => _parameters
                      .Template(_template => _template.Setup("aname", aname).Required())
                      .Template(_template => _template.Setup("gname", gname).Required())
