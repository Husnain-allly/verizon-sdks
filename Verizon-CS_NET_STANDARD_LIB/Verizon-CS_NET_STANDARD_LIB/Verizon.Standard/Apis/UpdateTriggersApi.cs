// <copyright file="UpdateTriggersApi.cs" company="APIMatic">
...
namespace Verizon.Standard.Apis
{
    ...
    /// UpdateTriggersApi.
    /// </summary>
    public class UpdateTriggersApi : BaseApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateTriggersApi"/> class.
        /// </summary>
        internal UpdateTriggersApi(GlobalConfiguration globalConfiguration) : base(globalConfiguration) { }
