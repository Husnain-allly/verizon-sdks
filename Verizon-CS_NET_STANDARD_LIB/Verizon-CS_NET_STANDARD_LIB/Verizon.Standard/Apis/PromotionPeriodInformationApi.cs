// <copyright file="PromotionPeriodInformationApi.cs" company="APIMatic">
...
namespace Verizon.Standard.Apis
{
    ...
    /// </summary>
    public class PromotionPeriodInformationApi : BaseApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PromotionPeriodInformationApi"/> class.
        /// </summary>
        internal PromotionPeriodInformationApi(GlobalConfiguration globalConfiguration) : base(globalConfiguration) { }
