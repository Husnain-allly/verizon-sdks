// <copyright file="EuiccDeviceProfileManagementApi.cs" company="APIMatic">
...
namespace Verizon.Standard.Apis
{
    ...
    /// </summary>
    public class EuiccDeviceProfileManagementApi : BaseApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EuiccDeviceProfileManagementApi"/> class.
        /// </summary>
        internal EuiccDeviceProfileManagementApi(GlobalConfiguration globalConfiguration) : base(globalConfiguration) { }
