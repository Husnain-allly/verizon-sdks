// <copyright file="ExclusionsApi.cs" company="APIMatic">
...
namespace Verizon.Standard.Apis
{
    ...
    /// ExclusionsApi.
    /// </summary>
    public class ExclusionsApi : BaseApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExclusionsApi"/> class.
        /// </summary>
        internal ExclusionsApi(GlobalConfiguration globalConfiguration) : base(globalConfiguration) { }
        ...
        public async Task<ApiResponse<Models.DeviceLocationSuccessResult>> RemoveDevicesFromExclusionListAsync(
            ...
            => await CreateApiCall<Models.DeviceLocationSuccessResult>()
              ...
              .RequestBuilder(_requestBuilder => _requestBuilder
                  ...
                  .Parameters(_parameters => _parameters
                      .Query(_query => _query.Setup("accountName", accountName).Required())
                      .Query(_query => _query.Setup("deviceList", deviceList).Required())))
              .ResponseHandler(_responseHandler => _responseHandler
                  .ErrorCase("400", CreateErrorCase("Unexpected error.", (_reason, _context) => new DeviceLocationResultException(_reason, _context))))
              .ExecuteAsync(cancellationToken).ConfigureAwait(false);
