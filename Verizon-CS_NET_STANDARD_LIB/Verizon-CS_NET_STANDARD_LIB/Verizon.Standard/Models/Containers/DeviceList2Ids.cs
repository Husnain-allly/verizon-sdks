// <copyright file="DeviceList2Ids.cs" company="APIMatic">
...
namespace Verizon.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<DeviceList2Ids>),
        new Type[] {
    ...
    public abstract class DeviceList2Ids
    {
        ...
        /// </summary>
        /// <returns>
        /// The DeviceList2Ids instance, wrapping the provided EsimDeviceId value.
        /// </returns>
        ...
        /// </summary>
        /// <returns>
        /// The DeviceList2Ids instance, wrapping the provided DeviceId2 value.
        /// </returns>
        ...
        private sealed class EsimDeviceIdCase : DeviceList2Ids, ICaseValue<EsimDeviceIdCase, EsimDeviceId>
        {
        ...
        private sealed class DeviceId2Case : DeviceList2Ids, ICaseValue<DeviceId2Case, DeviceId2>
        {
