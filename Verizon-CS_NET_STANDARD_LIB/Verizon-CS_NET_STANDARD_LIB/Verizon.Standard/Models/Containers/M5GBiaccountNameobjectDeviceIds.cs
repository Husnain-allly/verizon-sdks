// <copyright file="M5GBiaccountNameobjectDeviceIds.cs" company="APIMatic">
...
namespace Verizon.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<M5GBiaccountNameobjectDeviceIds>),
        new Type[] {
    ...
    public abstract class M5GBiaccountNameobjectDeviceIds
    {
        ...
        /// </summary>
        /// <returns>
        /// The M5GBiaccountNameobjectDeviceIds instance, wrapping the provided M5GBideviceId1 value.
        /// </returns>
        public static M5GBiaccountNameobjectDeviceIds From5gbideviceId1(M5GBideviceId1 m5GBideviceId1)
        {
        ...
        private sealed class M5GBideviceId1Case : M5GBiaccountNameobjectDeviceIds, ICaseValue<M5GBideviceId1Case, M5GBideviceId1>
        {
