// <copyright file="PayAsYouGoPricePlanTriggerCondition.cs" company="APIMatic">
...
namespace Verizon.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<PayAsYouGoPricePlanTriggerCondition>),
        new Type[] {
    ...
    public abstract class PayAsYouGoPricePlanTriggerCondition
    {
        ...
        /// </summary>
        /// <returns>
        /// The PayAsYouGoPricePlanTriggerCondition instance, wrapping the provided ConditionType value.
        /// </returns>
        public static PayAsYouGoPricePlanTriggerCondition FromConditionType(ConditionType conditionType)
        {
        ...
        /// </summary>
        /// <returns>
        /// The PayAsYouGoPricePlanTriggerCondition instance, wrapping the provided ConditionObjectCall value.
        /// </returns>
        public static PayAsYouGoPricePlanTriggerCondition FromConditionObjectCall(ConditionObjectCall conditionObjectCall)
        {
        ...
        private sealed class ConditionTypeCase : PayAsYouGoPricePlanTriggerCondition, ICaseValue<ConditionTypeCase, ConditionType>
        {
        ...
        private sealed class ConditionObjectCallCase : PayAsYouGoPricePlanTriggerCondition, ICaseValue<ConditionObjectCallCase, ConditionObjectCall>
        {
