// <copyright file="AccountSharePricePlanTriggerCondition.cs" company="APIMatic">
...
namespace Verizon.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<AccountSharePricePlanTriggerCondition>),
        new Type[] {
    ...
    public abstract class AccountSharePricePlanTriggerCondition
    {
        /// <summary>
        /// This is conditionType case.
        /// </summary>
        /// <returns>
        /// The AccountSharePricePlanTriggerCondition instance, wrapping the provided ConditionType value.
        /// </returns>
        public static AccountSharePricePlanTriggerCondition FromConditionType(ConditionType conditionType)
        {
        ...
        /// </summary>
        /// <returns>
        /// The AccountSharePricePlanTriggerCondition instance, wrapping the provided ConditionObjectCall value.
        /// </returns>
        public static AccountSharePricePlanTriggerCondition FromConditionObjectCall(ConditionObjectCall conditionObjectCall)
        {
        ...
        private sealed class ConditionTypeCase : AccountSharePricePlanTriggerCondition, ICaseValue<ConditionTypeCase, ConditionType>
        {
        ...
        private sealed class ConditionObjectCallCase : AccountSharePricePlanTriggerCondition, ICaseValue<ConditionObjectCallCase, ConditionObjectCall>
        {
