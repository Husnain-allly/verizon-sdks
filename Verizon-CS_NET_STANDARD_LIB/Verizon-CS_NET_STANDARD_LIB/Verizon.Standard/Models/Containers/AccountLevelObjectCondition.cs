// <copyright file="AccountLevelObjectCondition.cs" company="APIMatic">
...
namespace Verizon.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<AccountLevelObjectCondition>),
        new Type[] {
    ...
    public abstract class AccountLevelObjectCondition
    {
        /// <summary>
        /// This is conditionType case.
        /// </summary>
        /// <returns>
        /// The AccountLevelObjectCondition instance, wrapping the provided ConditionType value.
        /// </returns>
        public static AccountLevelObjectCondition FromConditionType(ConditionType conditionType)
        {
        ...
        /// </summary>
        /// <returns>
        /// The AccountLevelObjectCondition instance, wrapping the provided ConditionObjectCall value.
        /// </returns>
        public static AccountLevelObjectCondition FromConditionObjectCall(ConditionObjectCall conditionObjectCall)
        {
        ...
        private sealed class ConditionTypeCase : AccountLevelObjectCondition, ICaseValue<ConditionTypeCase, ConditionType>
        {
        ...
        private sealed class ConditionObjectCallCase : AccountLevelObjectCondition, ICaseValue<ConditionObjectCallCase, ConditionObjectCall>
        {
