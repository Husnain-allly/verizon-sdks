...
namespace Verizon.Standard.Authentication
{
    public interface IThingspaceOauthCredentials
    {
        ...
        /// </summary>
        List<Models.OauthScopeThingspaceOauth> OauthScopes { get; }
        ...
        bool Equals(string oauthClientId, string oauthClientSecret, Models.OauthToken oauthToken, List<Models.OauthScopeThingspaceOauth> oauthScopes);
