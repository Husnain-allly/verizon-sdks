...
```csharp
CloudConnectorDevicesApi cloudConnectorDevicesApi = client.CloudConnectorDevicesApi;
```
...
try
{
    ApiResponse<ChangeConfigurationResponse> result = await cloudConnectorDevicesApi.UpdateDevicesConfigurationValueAsync(body);
}
...
try
{
    ApiResponse<FindDeviceByPropertyResponseList> result = await cloudConnectorDevicesApi.FindDeviceByPropertyValuesAsync(body);
}
catch (ApiException e)
{
    // TODO: Handle exception here
...
QuerySubscriptionRequest body = new QuerySubscriptionRequest
{
    ...
    MSelection = new Dictionary<string, string>
    {
...
try
{
    ApiResponse<SearchDeviceByPropertyResponseList> result = await cloudConnectorDevicesApi.SearchDevicesResourcesByPropertyValuesAsync(body);
}
catch (ApiException e)
{
    // TODO: Handle exception here
...
try
{
    ApiResponse<SearchDeviceEventHistoryResponseList> result = await cloudConnectorDevicesApi.SearchDeviceEventHistoryAsync(body);
}
catch (ApiException e)
{
    // TODO: Handle exception here
...
try
{
    ApiResponse<SearchSensorHistoryResponseList> result = await cloudConnectorDevicesApi.SearchSensorReadingsAsync(
        fieldname,
        body
    );
}
...
try
{
    await cloudConnectorDevicesApi.DeleteDeviceFromAccountAsync(body);
}
catch (ApiException e)
{
    // TODO: Handle exception here
