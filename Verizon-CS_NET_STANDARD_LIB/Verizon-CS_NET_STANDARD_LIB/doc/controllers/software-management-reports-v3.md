...
```csharp
SoftwareManagementReportsV3Api softwareManagementReportsV3Api = client.SoftwareManagementReportsV3Api;
```
...
try
{
    ApiResponse<V3CampaignHistory> result = await softwareManagementReportsV3Api.GetCampaignHistoryByStatusAsync(
        acc,
        campaignStatus,
        lastSeenCampaignId
    );
...
try
{
    ApiResponse<List<DeviceFirmwareUpgrade>> result = await softwareManagementReportsV3Api.GetDeviceFirmwareUpgradeHistoryAsync(
        acc,
        deviceId
    );
}
...
try
{
    ApiResponse<V3CampaignDevice> result = await softwareManagementReportsV3Api.GetCampaignDeviceStatusAsync(
        acc,
        campaignId,
        lastSeenDeviceId
    );
