...
```csharp
SoftwareManagementCallbacksV2Api softwareManagementCallbacksV2Api = client.SoftwareManagementCallbacksV2Api;
```
...
try
{
    ApiResponse<CallbackSummary> result = await softwareManagementCallbacksV2Api.ListRegisteredCallbacksAsync(account);
}
...
try
{
    ApiResponse<FotaV2CallbackRegistrationResult> result = await softwareManagementCallbacksV2Api.UpdateCallbackAsync(
        account,
        body
    );
}
...
try
{
    ApiResponse<FotaV2CallbackRegistrationResult> result = await softwareManagementCallbacksV2Api.RegisterCallbackAsync(
        account,
        body
    );
}
...
try
{
    ApiResponse<FotaV2SuccessResult> result = await softwareManagementCallbacksV2Api.DeregisterCallbackAsync(account);
}
catch (ApiException e)
{
    // TODO: Handle exception here
