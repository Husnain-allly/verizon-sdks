...
```csharp
SoftwareManagementReportsV2Api softwareManagementReportsV2Api = client.SoftwareManagementReportsV2Api;
```
...
try
{
    ApiResponse<List<SoftwarePackage>> result = await softwareManagementReportsV2Api.ListAvailableSoftwareAsync(
        account,
        distributionType
    );
}
...
try
{
    ApiResponse<V2AccountDeviceList> result = await softwareManagementReportsV2Api.ListAccountDevicesAsync(
        account,
        lastSeenDeviceId,
        distributionType
    );
...
try
{
    ApiResponse<List<DeviceSoftwareUpgrade>> result = await softwareManagementReportsV2Api.GetDeviceFirmwareUpgradeHistoryAsync(
        account,
        deviceId
    );
}
...
try
{
    ApiResponse<V2CampaignHistory> result = await softwareManagementReportsV2Api.GetCampaignHistoryByStatusAsync(
        account,
        campaignStatus,
        lastSeenCampaignId
    );
...
try
{
    ApiResponse<V2CampaignDevice> result = await softwareManagementReportsV2Api.GetCampaignDeviceStatusAsync(
        account,
        campaignId,
        lastSeenDeviceId
    );
