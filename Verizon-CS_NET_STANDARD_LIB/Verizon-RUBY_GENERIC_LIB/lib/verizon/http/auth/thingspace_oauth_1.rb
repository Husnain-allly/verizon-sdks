...
module Verizon
  ...
  class ThingspaceOauth1 < CoreLibrary::HeaderAuth
    include CoreLibrary
    # Display error message on occurrence of authentication failure.
    # @returns [String] The oAuth error message.
    def error_message
      'ThingspaceOauth1: OAuthToken is undefined or expired.'
    end

    # Initialization constructor.
    def initialize(thingspace_oauth_1_credentials, config)
      @_oauth_client_id = thingspace_oauth_1_credentials.oauth_client_id unless
        thingspace_oauth_1_credentials.nil? || thingspace_oauth_1_credentials.oauth_client_id.nil?
      @_oauth_client_secret = thingspace_oauth_1_credentials.oauth_client_secret unless
        thingspace_oauth_1_credentials.nil? || thingspace_oauth_1_credentials.oauth_client_secret.nil?
      @_oauth_token = thingspace_oauth_1_credentials.oauth_token unless
        thingspace_oauth_1_credentials.nil? || thingspace_oauth_1_credentials.oauth_token.nil?
      @_oauth_clock_skew = thingspace_oauth_1_credentials.oauth_clock_skew unless
        thingspace_oauth_1_credentials.nil? || thingspace_oauth_1_credentials.oauth_clock_skew.nil?
      @_oauth_token_provider = thingspace_oauth_1_credentials.oauth_token_provider unless
        thingspace_oauth_1_credentials.nil? || thingspace_oauth_1_credentials.oauth_token_provider.nil?
      @_oauth_on_token_update = thingspace_oauth_1_credentials.oauth_on_token_update unless
        thingspace_oauth_1_credentials.nil? || thingspace_oauth_1_credentials.oauth_on_token_update.nil?
    ...
    def fetch_token(additional_params: nil)
      token = @_o_auth_api.request_token_thingspace_oauth_1(
