...
module Verizon
  ...
  class SoftwareManagementLicensesV2Api < BaseApi
    ...
    def list_licenses_to_remove(account,
                                start_index: nil)
      warn 'Endpoint list_licenses_to_remove in SoftwareManagementLicensesV2Ap'\
           'i is deprecated'
      @api_call
        .request(new_request_builder(HttpMethodEnum::GET,
