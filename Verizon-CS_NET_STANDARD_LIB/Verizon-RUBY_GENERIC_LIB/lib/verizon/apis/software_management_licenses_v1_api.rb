...
module Verizon
  ...
  class SoftwareManagementLicensesV1Api < BaseApi
    ...
    def list_licenses_to_remove(account,
                                start_index)
      warn 'Endpoint list_licenses_to_remove in SoftwareManagementLicensesV1Ap'\
           'i is deprecated'
      @api_call
