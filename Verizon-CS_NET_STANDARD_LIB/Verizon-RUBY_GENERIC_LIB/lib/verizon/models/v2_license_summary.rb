...
module Verizon
  ...
  class V2LicenseSummary < BaseModel
    ...
    def initialize(account_name:, assigned_licenses:, has_more_data:,
                   max_page_size:, total_license: SKIP,
    ...
    def self.from_hash(hash)
      ...
      V2LicenseSummary.new(account_name: account_name,
                           assigned_licenses: assigned_licenses,
                           has_more_data: has_more_data,
                           max_page_size: max_page_size,
    ...
    def to_s
      ...
      "<#{class_name} account_name: #{@account_name}, total_license: #{@total_license},"\
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} account_name: #{@account_name.inspect}, total_license:"\
      " #{@total_license.inspect}, assigned_licenses: #{@assigned_licenses.inspect},"\
