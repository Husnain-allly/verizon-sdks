...
module Verizon
  ...
  class DataPercentage75TriggerAttribute < BaseModel
    SKIP = Object.new
    ...
    # DataPercentage75<br />True - Trigger on Data percentage is over 75%
    # used<br />False - Do not trigger when over 75% used.
    ...
    def self.from_hash(hash)
      ...
      DataPercentage75TriggerAttribute.new(key: key,
                                           value: value,
                                           additional_properties: additional_properties)
    end

    # Validates an instance of the object from a given value.
    # @param [DataPercentage75TriggerAttribute | Hash] The value against the validation is performed.
