...
module Verizon
  ...
  class DailyUsageHistory < BaseModel
    ...
    def self.from_hash(hash)
      ...
      DailyUsageHistory.new(bytes_used: bytes_used,
    ...
    def to_s
      ...
      "<#{class_name} bytes_used: #{@bytes_used}, extended_attributes: #{@extended_attributes},"\
      " service_plan: #{@service_plan}, sms_used: #{@sms_used}, source: #{@source}, timestamp:"\
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} bytes_used: #{@bytes_used.inspect}, extended_attributes:"\
      " #{@extended_attributes.inspect}, service_plan: #{@service_plan.inspect}, sms_used:"\
      " #{@sms_used.inspect}, source: #{@source.inspect}, timestamp: #{@timestamp.inspect},"\
      " additional_properties: #{@additional_properties}>"
    end
  end
end
