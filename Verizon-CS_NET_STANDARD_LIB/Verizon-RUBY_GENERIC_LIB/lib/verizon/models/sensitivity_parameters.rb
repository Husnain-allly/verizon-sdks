...
module Verizon
  ...
  class SensitivityParameters < BaseModel
    ...
    def self.from_hash(hash)
      ...
      SensitivityParameters.new(abnormal_max_value: abnormal_max_value,
                                enable_abnormal: enable_abnormal,
                                enable_very_abnormal: enable_very_abnormal,
                                very_abnormal_max_value: very_abnormal_max_value)
    end

    # Provides a human-readable string representation of the object.
    def to_s
      class_name = self.class.name.split('::').last
      "<#{class_name} abnormal_max_value: #{@abnormal_max_value}, enable_abnormal:"\
      " #{@enable_abnormal}, enable_very_abnormal: #{@enable_very_abnormal},"\
      " very_abnormal_max_value: #{@very_abnormal_max_value}>"
    end
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} abnormal_max_value: #{@abnormal_max_value.inspect}, enable_abnormal:"\
      " #{@enable_abnormal.inspect}, enable_very_abnormal: #{@enable_very_abnormal.inspect},"\
      " very_abnormal_max_value: #{@very_abnormal_max_value.inspect}>"
    end
  end
end
