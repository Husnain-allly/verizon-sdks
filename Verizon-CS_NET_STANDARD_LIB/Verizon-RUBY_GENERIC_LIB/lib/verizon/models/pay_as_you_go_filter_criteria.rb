...
module Verizon
  # PayAsYouGoFilterCriteria Model.
  class PayAsYouGoFilterCriteria < BaseModel
    SKIP = Object.new
    private_constant :SKIP

    # TODO: Write general description for this method
    # @return [PayAsYouGoFilterCriteria1]
    ...
    def self.from_hash(hash)
      ...
      filter_criteria = PayAsYouGoFilterCriteria1.from_hash(hash['filterCriteria']) if
        hash['filterCriteria']
      ...
      PayAsYouGoFilterCriteria.new(filter_criteria: filter_criteria,
                                   additional_properties: additional_properties)
    end

    # Validates an instance of the object from a given value.
    # @param [PayAsYouGoFilterCriteria | Hash] The value against the validation is performed.
