...
module Verizon
  ...
  class CreateTargetRequest < BaseModel
    ...
    def initialize(accountidentifier: SKIP, billingaccountid: SKIP, kind: SKIP,
                   address: SKIP, addressscheme: SKIP, fields: SKIP,
                   description: SKIP, externalid: SKIP, name: SKIP,
                   region: SKIP, key1: SKIP, oauth: SKIP,
    ...
    def self.from_hash(hash)
      ...
      CreateTargetRequest.new(accountidentifier: accountidentifier,
    ...
    def to_s
      ...
      "<#{class_name} accountidentifier: #{@accountidentifier}, billingaccountid:"\
      " #{@billingaccountid}, kind: #{@kind}, address: #{@address}, addressscheme:"\
      " #{@addressscheme}, fields: #{@fields}, description: #{@description}, externalid:"\
      " #{@externalid}, name: #{@name}, region: #{@region}, key1: #{@key1}, oauth: #{@oauth},"\
      " additional_properties: #{@additional_properties}>"
    end
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} accountidentifier: #{@accountidentifier.inspect}, billingaccountid:"\
      " #{@billingaccountid.inspect}, kind: #{@kind.inspect}, address: #{@address.inspect},"\
      " addressscheme: #{@addressscheme.inspect}, fields: #{@fields.inspect}, description:"\
      " #{@description.inspect}, externalid: #{@externalid.inspect}, name: #{@name.inspect},"\
      " region: #{@region.inspect}, key1: #{@key1.inspect}, oauth: #{@oauth.inspect},"\
      " additional_properties: #{@additional_properties}>"
    end
  end
end
