...
module Verizon
  ...
  class SmsTriggerRequest < BaseModel
    ...
    def self.from_hash(hash)
      ...
      SmsTriggerRequest.new(comparator: comparator,
                            sms_type: sms_type,
                            threshold: threshold)
    end
    ...
    def to_s
      ...
      "<#{class_name} comparator: #{@comparator}, sms_type: #{@sms_type}, threshold:"\
      " #{@threshold}>"
    end
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} comparator: #{@comparator.inspect}, sms_type: #{@sms_type.inspect},"\
