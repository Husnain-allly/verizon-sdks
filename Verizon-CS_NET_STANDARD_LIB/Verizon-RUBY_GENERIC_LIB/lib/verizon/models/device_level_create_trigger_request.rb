...
module Verizon
  # DeviceLevelCreateTriggerRequest Model.
  class DeviceLevelCreateTriggerRequest < BaseModel
    SKIP = Object.new
    ...
    def initialize(trigger_name: SKIP, ecpd_id: SKIP, trigger_category: SKIP,
                   data_trigger: SKIP, notification: SKIP, active: SKIP)
    ...
    def self.from_hash(hash)
      ...
      DeviceLevelCreateTriggerRequest.new(trigger_name: trigger_name,
                                          ecpd_id: ecpd_id,
    ...
    # @param [DeviceLevelCreateTriggerRequest | Hash] The value against the validation is performed.
    ...
    def inspect
      ...
      " notification: #{@notification.inspect}, active: #{@active.inspect}>"
    end
  end
end
