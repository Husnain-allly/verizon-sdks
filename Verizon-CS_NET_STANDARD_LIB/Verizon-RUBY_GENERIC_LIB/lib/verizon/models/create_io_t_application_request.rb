...
module Verizon
  ...
  class CreateIoTApplicationRequest < BaseModel
    ...
    def initialize(app_name: SKIP, billing_account_id: SKIP, client_id: SKIP,
                   client_secret: SKIP, email_i_ds: SKIP, resourcegroup: SKIP,
                   sample_io_tc_app: SKIP, subscription_id: SKIP,
                   tenant_id: SKIP, additional_properties: nil)
    ...
    def self.from_hash(hash)
      ...
      CreateIoTApplicationRequest.new(app_name: app_name,
                                      billing_account_id: billing_account_id,
                                      client_id: client_id,
                                      client_secret: client_secret,
                                      email_i_ds: email_i_ds,
                                      resourcegroup: resourcegroup,
                                      sample_io_tc_app: sample_io_tc_app,
    ...
    def to_s
      ...
      "<#{class_name} app_name: #{@app_name}, billing_account_id: #{@billing_account_id},"\
      " client_id: #{@client_id}, client_secret: #{@client_secret}, email_i_ds: #{@email_i_ds},"\
      " resourcegroup: #{@resourcegroup}, sample_io_tc_app: #{@sample_io_tc_app}, subscription_id:"\
      " #{@subscription_id}, tenant_id: #{@tenant_id}, additional_properties:"\
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} app_name: #{@app_name.inspect}, billing_account_id:"\
      " #{@billing_account_id.inspect}, client_id: #{@client_id.inspect}, client_secret:"\
      " #{@client_secret.inspect}, email_i_ds: #{@email_i_ds.inspect}, resourcegroup:"\
      " #{@resourcegroup.inspect}, sample_io_tc_app: #{@sample_io_tc_app.inspect},"\
      " subscription_id: #{@subscription_id.inspect}, tenant_id: #{@tenant_id.inspect},"\
      " additional_properties: #{@additional_properties}>"
    end
  end
end
