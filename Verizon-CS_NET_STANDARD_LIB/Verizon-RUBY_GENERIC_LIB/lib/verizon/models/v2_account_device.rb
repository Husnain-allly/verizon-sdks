...
module Verizon
  ...
  class V2AccountDevice < BaseModel
    ...
    def initialize(device_id:, mdn:, model:, make:, fota_eligible:,
                   app_fota_eligible:, license_assigned:, distribution_type:,
                   software_list:, create_time: SKIP, upgrade_time: SKIP,
    ...
    def self.from_hash(hash)
      ...
      V2AccountDevice.new(device_id: device_id,
                          mdn: mdn,
                          model: model,
                          make: make,
                          fota_eligible: fota_eligible,
    ...
    def to_s
      ...
      "<#{class_name} device_id: #{@device_id}, mdn: #{@mdn}, model: #{@model}, make: #{@make},"\
      " fota_eligible: #{@fota_eligible}, app_fota_eligible: #{@app_fota_eligible},"\
      " license_assigned: #{@license_assigned}, distribution_type: #{@distribution_type},"\
      " software_list: #{@software_list}, create_time: #{@create_time}, upgrade_time:"\
      " #{@upgrade_time}, update_time: #{@update_time}, refresh_time: #{@refresh_time},"\
      " additional_properties: #{@additional_properties}>"
    end
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} device_id: #{@device_id.inspect}, mdn: #{@mdn.inspect}, model:"\
      " #{@model.inspect}, make: #{@make.inspect}, fota_eligible: #{@fota_eligible.inspect},"\
      " app_fota_eligible: #{@app_fota_eligible.inspect}, license_assigned:"\
      " #{@license_assigned.inspect}, distribution_type: #{@distribution_type.inspect},"\
      " software_list: #{@software_list.inspect}, create_time: #{@create_time.inspect},"\
      " upgrade_time: #{@upgrade_time.inspect}, update_time: #{@update_time.inspect},"\
      " refresh_time: #{@refresh_time.inspect}, additional_properties: #{@additional_properties}>"
    end
  end
end
