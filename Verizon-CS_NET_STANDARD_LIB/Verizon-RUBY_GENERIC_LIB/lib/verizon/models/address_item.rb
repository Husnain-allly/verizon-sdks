...
module Verizon
  ...
  class AddressItem < BaseModel
    ...
    def self.from_hash(hash)
      ...
      AddressItem.new(address_line1: address_line1,
    ...
    # @param [AddressItem | Hash] The value against the validation is performed.
    ...
    def to_s
      ...
      " #{@city}, state: #{@state}, country: #{@country}, zip: #{@zip}, zip4: #{@zip4}>"
    end
    ...
    def inspect
      ...
      " #{@address_line2.inspect}, city: #{@city.inspect}, state: #{@state.inspect}, country:"\
      " #{@country.inspect}, zip: #{@zip.inspect}, zip4: #{@zip4.inspect}>"
    end
  end
end
