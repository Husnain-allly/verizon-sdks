...
module Verizon
  ...
  class CarrierActivateRequest < BaseModel
    ...
    def initialize(devices:, service_plan:, mdn_zip_code:, account_name: SKIP,
                   carrier_ip_pool_name: SKIP, carrier_name: SKIP,
                   cost_center_code: SKIP, custom_fields: SKIP,
                   group_name: SKIP, lead_id: SKIP, primary_place_of_use: SKIP,
    ...
    def self.from_hash(hash)
      ...
      CarrierActivateRequest.new(devices: devices,
                                 service_plan: service_plan,
                                 mdn_zip_code: mdn_zip_code,
    ...
    def to_s
      ...
      "<#{class_name} devices: #{@devices}, service_plan: #{@service_plan}, mdn_zip_code:"\
      " #{@mdn_zip_code}, account_name: #{@account_name}, carrier_ip_pool_name:"\
      " #{@carrier_ip_pool_name}, carrier_name: #{@carrier_name}, cost_center_code:"\
      " #{@cost_center_code}, custom_fields: #{@custom_fields}, group_name: #{@group_name},"\
      " lead_id: #{@lead_id}, primary_place_of_use: #{@primary_place_of_use},"\
      " public_ip_restriction: #{@public_ip_restriction}, sku_number: #{@sku_number},"\
      " additional_properties: #{@additional_properties}>"
    end
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} devices: #{@devices.inspect}, service_plan: #{@service_plan.inspect},"\
      " mdn_zip_code: #{@mdn_zip_code.inspect}, account_name: #{@account_name.inspect},"\
      " carrier_ip_pool_name: #{@carrier_ip_pool_name.inspect}, carrier_name:"\
      " #{@carrier_name.inspect}, cost_center_code: #{@cost_center_code.inspect}, custom_fields:"\
      " #{@custom_fields.inspect}, group_name: #{@group_name.inspect}, lead_id:"\
      " #{@lead_id.inspect}, primary_place_of_use: #{@primary_place_of_use.inspect},"\
      " public_ip_restriction: #{@public_ip_restriction.inspect}, sku_number:"\
      " #{@sku_number.inspect}, additional_properties: #{@additional_properties}>"
    end
  end
end
