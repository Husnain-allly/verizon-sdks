...
module Verizon
  # KeysmsPercentage50 Model.
  class KeysmsPercentage50 < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      KeysmsPercentage50.new(key: key,
                             value: value,
                             additional_properties: additional_properties)
    end

    # Validates an instance of the object from a given value.
    # @param [KeysmsPercentage50 | Hash] The value against the validation is performed.
