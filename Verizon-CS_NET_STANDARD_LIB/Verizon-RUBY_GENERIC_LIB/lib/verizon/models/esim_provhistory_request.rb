...
module Verizon
  ...
  class EsimProvhistoryRequest < BaseModel
    ...
    def self.from_hash(hash)
      ...
      EsimProvhistoryRequest.new(account_name: account_name,
    ...
    def to_s
      ...
      "<#{class_name} account_name: #{@account_name}, device_filter: #{@device_filter}, earliest:"\
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} account_name: #{@account_name.inspect}, device_filter:"\
      " #{@device_filter.inspect}, earliest: #{@earliest.inspect}, latest: #{@latest.inspect}>"
    end
  end
end
