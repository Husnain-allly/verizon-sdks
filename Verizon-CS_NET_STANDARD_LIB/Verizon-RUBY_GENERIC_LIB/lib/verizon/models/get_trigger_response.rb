...
module Verizon
  ...
  class GetTriggerResponse < BaseModel
    ...
    def self.from_hash(hash)
      ...
      GetTriggerResponse.new(account_name: account_name,
    ...
    def to_s
      ...
      "<#{class_name} account_name: #{@account_name}, comparator: #{@comparator}, created_at:"\
      " #{@created_at}, group_name: #{@group_name}, modified_at: #{@modified_at},"\
      " notification_group_name: #{@notification_group_name}, organization_name:"\
      " #{@organization_name}, sms_type: #{@sms_type}, threshold: #{@threshold}, threshold_unit:"\
      " #{@threshold_unit}, trigger_category: #{@trigger_category}, trigger_cycle:"\
      " #{@trigger_cycle}, trigger_id: #{@trigger_id}, trigger_name: #{@trigger_name}>"
    end

    # Provides a debugging-friendly string with detailed object information.
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} account_name: #{@account_name.inspect}, comparator: #{@comparator.inspect},"\
      " created_at: #{@created_at.inspect}, group_name: #{@group_name.inspect}, modified_at:"\
      " #{@modified_at.inspect}, notification_group_name: #{@notification_group_name.inspect},"\
      " organization_name: #{@organization_name.inspect}, sms_type: #{@sms_type.inspect},"\
      " threshold: #{@threshold.inspect}, threshold_unit: #{@threshold_unit.inspect},"\
      " trigger_category: #{@trigger_category.inspect}, trigger_cycle: #{@trigger_cycle.inspect},"\
      " trigger_id: #{@trigger_id.inspect}, trigger_name: #{@trigger_name.inspect}>"
    end
  end
end
