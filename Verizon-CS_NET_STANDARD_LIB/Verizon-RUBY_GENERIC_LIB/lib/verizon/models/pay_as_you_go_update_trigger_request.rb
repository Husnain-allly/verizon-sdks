...
module Verizon
  ...
  class PayAsYouGoUpdateTriggerRequest < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      PayAsYouGoUpdateTriggerRequest.new(trigger_id: trigger_id,
    ...
    # @param [PayAsYouGoUpdateTriggerRequest | Hash] The value against the validation is performed.
