...
module Verizon
  ...
  class DeviceGroupFilterCriteria < BaseModel
    SKIP = Object.new
    private_constant :SKIP

    # TODO: Write general description for this method
    # @return [DeviceGroupFilter]
    ...
    def self.from_hash(hash)
      ...
      filter_criteria = DeviceGroupFilter.from_hash(hash['filterCriteria']) if
        hash['filterCriteria']
      ...
      DeviceGroupFilterCriteria.new(filter_criteria: filter_criteria,
                                    additional_properties: additional_properties)
    end

    # Validates an instance of the object from a given value.
    # @param [DeviceGroupFilterCriteria | Hash] The value against the validation is performed.
