...
module Verizon
  ...
  class UpgradeListQueryResult < BaseModel
    ...
    def initialize(has_more_flag: SKIP, last_seen_upgrade_id: SKIP,
                   report_list: SKIP, additional_properties: nil)
    ...
    def self.from_hash(hash)
      ...
      UpgradeListQueryResult.new(has_more_flag: has_more_flag,
                                 last_seen_upgrade_id: last_seen_upgrade_id,
    ...
    def to_s
      ...
      "<#{class_name} has_more_flag: #{@has_more_flag}, last_seen_upgrade_id:"\
      " #{@last_seen_upgrade_id}, report_list: #{@report_list}, additional_properties:"\
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} has_more_flag: #{@has_more_flag.inspect}, last_seen_upgrade_id:"\
      " #{@last_seen_upgrade_id.inspect}, report_list: #{@report_list.inspect},"\
      " additional_properties: #{@additional_properties}>"
    end
  end
end
