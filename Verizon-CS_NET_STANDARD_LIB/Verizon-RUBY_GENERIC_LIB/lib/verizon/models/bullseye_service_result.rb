...
module Verizon
  ...
  class BullseyeServiceResult < BaseModel
    ...
    def initialize(account_number: SKIP, device_list: SKIP, response_type: SKIP,
    ...
    def self.from_hash(hash)
      ...
      BullseyeServiceResult.new(account_number: account_number,
    ...
    def to_s
      ...
      "<#{class_name} account_number: #{@account_number}, device_list: #{@device_list},"\
      " response_type: #{@response_type}, additional_properties: #{@additional_properties}>"
    end

    # Provides a debugging-friendly string with detailed object information.
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} account_number: #{@account_number.inspect}, device_list:"\
      " #{@device_list.inspect}, response_type: #{@response_type.inspect}, additional_properties:"\
