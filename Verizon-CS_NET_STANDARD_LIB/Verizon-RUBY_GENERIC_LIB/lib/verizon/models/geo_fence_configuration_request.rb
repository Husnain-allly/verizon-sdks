...
module Verizon
  ...
  # populated.
  class GeoFenceConfigurationRequest < BaseModel
    SKIP = Object.new
    ...
    def initialize(geo_fence:, messages:, is_active:, name: SKIP,
                   description: SKIP)
    ...
    def self.from_hash(hash)
      ...
      GeoFenceConfigurationRequest.new(geo_fence: geo_fence,
                                       messages: messages,
                                       is_active: is_active,
                                       name: name,
    ...
    # @param [GeoFenceConfigurationRequest | Hash] The value against the validation is performed.
