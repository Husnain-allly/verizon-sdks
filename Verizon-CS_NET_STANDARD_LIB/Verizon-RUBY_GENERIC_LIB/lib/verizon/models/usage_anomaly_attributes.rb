...
module Verizon
  ...
  class UsageAnomalyAttributes < BaseModel
    ...
    def initialize(account_names: SKIP, device_group: SKIP,
    ...
    def self.from_hash(hash)
      ...
      UsageAnomalyAttributes.new(account_names: account_names,
    ...
    # @param [UsageAnomalyAttributes | Hash] The value against the validation is performed.
    ...
    def to_s
      ...
      "<#{class_name} account_names: #{@account_names}, device_group: #{@device_group},"\
      " include_abnormal: #{@include_abnormal}, include_very_abnormal: #{@include_very_abnormal},"\
      " include_under_expected_usage: #{@include_under_expected_usage},"\
      " include_over_expected_usage: #{@include_over_expected_usage}>"
    end
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} account_names: #{@account_names.inspect}, device_group:"\
      " #{@device_group.inspect}, include_abnormal: #{@include_abnormal.inspect},"\
      " include_very_abnormal: #{@include_very_abnormal.inspect}, include_under_expected_usage:"\
      " #{@include_under_expected_usage.inspect}, include_over_expected_usage:"\
      " #{@include_over_expected_usage.inspect}>"
    end
  end
end
