...
module Verizon
  ...
  class FiltercriteriaObjectCall < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      filter_criteria = FilterCriteria1.from_hash(hash['filterCriteria']) if
        hash['filterCriteria']
      ...
      FiltercriteriaObjectCall.new(filter_criteria: filter_criteria,
                                   additional_properties: additional_properties)
    end

    # Validates an instance of the object from a given value.
    # @param [FiltercriteriaObjectCall | Hash] The value against the validation is performed.
