...
module Verizon
  ...
  class Keyschunk2 < BaseModel
    ...
    def initialize(data_percentage50: SKIP, data_percentage75: SKIP,
                   ...
                   no_of_days_b4_promo_exp: SKIP, additional_properties: nil)
    ...
    def self.from_hash(hash)
      ...
      Keyschunk2.new(data_percentage50: data_percentage50,
                     data_percentage75: data_percentage75,
                     data_percentage90: data_percentage90,
                     data_percentage100: data_percentage100,
                     sms_percentage50: sms_percentage50,
                     sms_percentage75: sms_percentage75,
                     sms_percentage90: sms_percentage90,
                     sms_percentage100: sms_percentage100,
                     no_of_days_b4_promo_exp: no_of_days_b4_promo_exp,
                     additional_properties: additional_properties)
    end
    ...
    def to_s
      ...
      "<#{class_name} data_percentage50: #{@data_percentage50}, data_percentage75:"\
      " #{@data_percentage75}, data_percentage90: #{@data_percentage90}, data_percentage100:"\
      " #{@data_percentage100}, sms_percentage50: #{@sms_percentage50}, sms_percentage75:"\
      " #{@sms_percentage75}, sms_percentage90: #{@sms_percentage90}, sms_percentage100:"\
      " #{@sms_percentage100}, no_of_days_b4_promo_exp: #{@no_of_days_b4_promo_exp},"\
      " additional_properties: #{@additional_properties}>"
    end
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} data_percentage50: #{@data_percentage50.inspect}, data_percentage75:"\
      " #{@data_percentage75.inspect}, data_percentage90: #{@data_percentage90.inspect},"\
      " data_percentage100: #{@data_percentage100.inspect}, sms_percentage50:"\
      " #{@sms_percentage50.inspect}, sms_percentage75: #{@sms_percentage75.inspect},"\
      " sms_percentage90: #{@sms_percentage90.inspect}, sms_percentage100:"\
      " #{@sms_percentage100.inspect}, no_of_days_b4_promo_exp:"\
      " #{@no_of_days_b4_promo_exp.inspect}, additional_properties: #{@additional_properties}>"
    end
  end
end
