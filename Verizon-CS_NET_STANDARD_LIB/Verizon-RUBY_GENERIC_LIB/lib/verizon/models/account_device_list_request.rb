...
module Verizon
  ...
  class AccountDeviceListRequest < BaseModel
    ...
    def self.from_hash(hash)
      ...
      AccountDeviceListRequest.new(account_name: account_name,
                                   device_id: device_id,
                                   filter: filter,
                                   ...
                                   largest_device_id_seen: largest_device_id_seen,
                                   additional_properties: additional_properties)
    end
    ...
    def to_s
      ...
      "<#{class_name} account_name: #{@account_name}, device_id: #{@device_id}, filter:"\
      " #{@filter}, current_state: #{@current_state}, custom_fields: #{@custom_fields}, earliest:"\
      " #{@earliest}, group_name: #{@group_name}, latest: #{@latest}, service_plan:"\
      " #{@service_plan}, max_number_of_devices: #{@max_number_of_devices},"\
      " largest_device_id_seen: #{@largest_device_id_seen}, additional_properties:"\
    ...
    def inspect
      ...
      " filter: #{@filter.inspect}, current_state: #{@current_state.inspect}, custom_fields:"\
      " #{@custom_fields.inspect}, earliest: #{@earliest.inspect}, group_name:"\
      " #{@group_name.inspect}, latest: #{@latest.inspect}, service_plan:"\
      " #{@service_plan.inspect}, max_number_of_devices: #{@max_number_of_devices.inspect},"\
      " largest_device_id_seen: #{@largest_device_id_seen.inspect}, additional_properties:"\
      " #{@additional_properties}>"
    end
  end
end
