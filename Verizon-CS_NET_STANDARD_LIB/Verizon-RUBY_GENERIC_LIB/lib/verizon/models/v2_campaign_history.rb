...
module Verizon
  ...
  class V2CampaignHistory < BaseModel
    SKIP = Object.new
    ...
    # @return [Array[V2CampaignMetaInfo]]
    ...
    def self.from_hash(hash)
      ...
      unless hash['campaignList'].nil?
        ...
        hash['campaignList'].each do |structure|
          campaign_list << (V2CampaignMetaInfo.from_hash(structure) if structure)
        end
      end
      ...
      V2CampaignHistory.new(has_more_data: has_more_data,
                            campaign_list: campaign_list,
