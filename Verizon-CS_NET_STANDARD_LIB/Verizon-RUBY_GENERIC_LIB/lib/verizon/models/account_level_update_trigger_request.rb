  ...
  class AccountLevelUpdateTriggerRequest < BaseModel
    ...
    def self.from_hash(hash)
      ...
      sms_numbers = hash.key?('smsNumbers') ? APIHelper.deserialize_union_type(
        UnionTypeLookUp.get(:AccountLevelUpdateTriggerRequestSmsNumbers), hash['smsNumbers']
      ) : SKIP
    ...
    # @param [AccountLevelUpdateTriggerRequest | Hash] The value against the validation is performed.
