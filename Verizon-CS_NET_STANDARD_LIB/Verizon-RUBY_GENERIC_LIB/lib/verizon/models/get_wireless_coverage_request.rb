...
module Verizon
  ...
  class GetWirelessCoverageRequest < BaseModel
    ...
    def self.from_hash(hash)
      ...
      GetWirelessCoverageRequest.new(account_name: account_name,
                                     request_type: request_type,
                                     location_type: location_type,
                                     locations: locations,
                                     network_types_list: network_types_list)
    ...
    # @param [GetWirelessCoverageRequest | Hash] The value against the validation is performed.
        ...
        return (
          APIHelper.valid_type?(value.account_name,
            ...
            APIHelper.valid_type?(value.locations,
                                  ->(val) { Locationscoord.validate(val) },
