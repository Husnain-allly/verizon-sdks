...
module Verizon
  ...
  class Region < BaseModel
    ...
    def initialize(region_id: SKIP, name: SKIP, country_code: SKIP, metro: SKIP,
                   area: SKIP)
    ...
    def self.from_hash(hash)
      ...
      Region.new(region_id: region_id,
                 name: name,
    ...
    def to_s
      ...
      "<#{class_name} region_id: #{@region_id}, name: #{@name}, country_code: #{@country_code},"\
      " metro: #{@metro}, area: #{@area}>"
    end

    # Provides a debugging-friendly string with detailed object information.
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} region_id: #{@region_id.inspect}, name: #{@name.inspect}, country_code:"\
      " #{@country_code.inspect}, metro: #{@metro.inspect}, area: #{@area.inspect}>"
    end
  end
end
