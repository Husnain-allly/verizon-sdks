...
module Verizon
  ...
  class AttributeSetting < BaseModel
    ...
    def initialize(name: SKIP, value: SKIP, created_on: SKIP,
                   is_observable: SKIP, is_observing: SKIP, frequency: SKIP,
    ...
    def self.from_hash(hash)
      ...
      AttributeSetting.new(name: name,
                           value: value,
    ...
    def to_s
      ...
      " is_observable: #{@is_observable}, is_observing: #{@is_observing}, frequency:"\
      " #{@frequency}, additional_properties: #{@additional_properties}>"
    end
    ...
    def inspect
      ...
      " #{@created_on.inspect}, is_observable: #{@is_observable.inspect}, is_observing:"\
      " #{@is_observing.inspect}, frequency: #{@frequency.inspect}, additional_properties:"\
