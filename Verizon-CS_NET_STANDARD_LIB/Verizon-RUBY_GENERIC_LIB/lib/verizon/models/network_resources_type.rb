...
module Verizon
  ...
  class NetworkResourcesType < BaseModel
    ...
    def initialize(max_latency_ms:, min_bandwidth_kbits: SKIP,
    ...
    def self.from_hash(hash)
      ...
      NetworkResourcesType.new(max_latency_ms: max_latency_ms,
                               min_bandwidth_kbits: min_bandwidth_kbits,
                               service_continuity_support: service_continuity_support,
    ...
    def to_s
      ...
      "<#{class_name} min_bandwidth_kbits: #{@min_bandwidth_kbits}, service_continuity_support:"\
      " #{@service_continuity_support}, max_request_rate: #{@max_request_rate}, max_latency_ms:"\
      " #{@max_latency_ms}, min_availability: #{@min_availability}>"
    end

    # Provides a debugging-friendly string with detailed object information.
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} min_bandwidth_kbits: #{@min_bandwidth_kbits.inspect},"\
      " service_continuity_support: #{@service_continuity_support.inspect}, max_request_rate:"\
      " #{@max_request_rate.inspect}, max_latency_ms: #{@max_latency_ms.inspect},"\
      " min_availability: #{@min_availability.inspect}>"
    end
  end
end
