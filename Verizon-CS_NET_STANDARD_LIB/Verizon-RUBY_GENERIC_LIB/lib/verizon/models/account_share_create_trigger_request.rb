...
module Verizon
  ...
  class AccountShareCreateTriggerRequest < BaseModel
    SKIP = Object.new
    ...
    # The type of trigger being created or modified
    # @return [AccountSharePricePlanTrigger]
    ...
    def self.from_hash(hash)
      ...
      AccountShareCreateTriggerRequest.new(trigger_name: trigger_name,
                                           ecpd_id: ecpd_id,
    ...
    # @param [AccountShareCreateTriggerRequest | Hash] The value against the validation is performed.
