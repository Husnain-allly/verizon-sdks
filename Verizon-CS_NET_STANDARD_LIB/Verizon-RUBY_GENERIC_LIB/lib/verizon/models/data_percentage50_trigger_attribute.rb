...
module Verizon
  ...
  class DataPercentage50TriggerAttribute < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      DataPercentage50TriggerAttribute.new(key: key,
                                           value: value,
                                           additional_properties: additional_properties)
    end

    # Validates an instance of the object from a given value.
    # @param [DataPercentage50TriggerAttribute | Hash] The value against the validation is performed.
