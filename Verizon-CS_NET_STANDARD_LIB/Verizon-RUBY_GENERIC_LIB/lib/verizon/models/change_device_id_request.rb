...
module Verizon
  ...
  class ChangeDeviceIdRequest < BaseModel
    ...
    def initialize(device_ids:, assign_non_geo_mdn: SKIP, change4g_option: SKIP,
                   device_ids_to: SKIP, npa_nxx: SKIP, service_plan: SKIP,
                   zip_code: SKIP, smsr_oid: SKIP, additional_properties: nil)
    ...
    def self.from_hash(hash)
      ...
      ChangeDeviceIdRequest.new(device_ids: device_ids,
                                assign_non_geo_mdn: assign_non_geo_mdn,
                                change4g_option: change4g_option,
    ...
    def to_s
      ...
      "<#{class_name} assign_non_geo_mdn: #{@assign_non_geo_mdn}, change4g_option:"\
      " #{@change4g_option}, device_ids: #{@device_ids}, device_ids_to: #{@device_ids_to},"\
      " npa_nxx: #{@npa_nxx}, service_plan: #{@service_plan}, zip_code: #{@zip_code}, smsr_oid:"\
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} assign_non_geo_mdn: #{@assign_non_geo_mdn.inspect}, change4g_option:"\
      " #{@change4g_option.inspect}, device_ids: #{@device_ids.inspect}, device_ids_to:"\
      " #{@device_ids_to.inspect}, npa_nxx: #{@npa_nxx.inspect}, service_plan:"\
      " #{@service_plan.inspect}, zip_code: #{@zip_code.inspect}, smsr_oid: #{@smsr_oid.inspect},"\
      " additional_properties: #{@additional_properties}>"
    end
  end
end
