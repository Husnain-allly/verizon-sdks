...
module Verizon
  ...
  class DtoConfigurationProfileDelete < BaseModel
    SKIP = Object.new
    ...
    def initialize(account_name: SKIP, resourceidentifier: SKIP,
    ...
    def self.from_hash(hash)
      ...
      DtoConfigurationProfileDelete.new(account_name: account_name,
