...
module Verizon
  ...
  class NotificationGroupNameTriggerAttribute < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      NotificationGroupNameTriggerAttribute.new(key: key,
                                                additional_properties: additional_properties)
    end

    # Validates an instance of the object from a given value.
    # @param [NotificationGroupNameTriggerAttribute | Hash] The value against the validation is performed.
