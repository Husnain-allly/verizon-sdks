...
module Verizon
  ...
  class AnomalyTriggerRequest < BaseModel
    ...
    # The Verizon billing accounts associated with the anomaly triggers for this
    ...
    def self.from_hash(hash)
      ...
      AnomalyTriggerRequest.new(account_names: account_names,
                                include_abnormal: include_abnormal,
                                include_very_abnormal: include_very_abnormal,
                                include_under_expected_usage: include_under_expected_usage,
                                include_over_expected_usage: include_over_expected_usage)
    end

    # Validates an instance of the object from a given value.
    # @param [AnomalyTriggerRequest | Hash] The value against the validation is performed.
    ...
    def to_s
      ...
      "<#{class_name} account_names: #{@account_names}, include_abnormal: #{@include_abnormal},"\
      " include_very_abnormal: #{@include_very_abnormal}, include_under_expected_usage:"\
      " #{@include_under_expected_usage}, include_over_expected_usage:"\
      " #{@include_over_expected_usage}>"
    end
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} account_names: #{@account_names.inspect}, include_abnormal:"\
      " #{@include_abnormal.inspect}, include_very_abnormal: #{@include_very_abnormal.inspect},"\
      " include_under_expected_usage: #{@include_under_expected_usage.inspect},"\
      " include_over_expected_usage: #{@include_over_expected_usage.inspect}>"
    end
  end
end
