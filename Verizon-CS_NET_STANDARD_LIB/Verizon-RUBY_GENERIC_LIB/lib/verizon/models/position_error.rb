...
module Verizon
  ...
  class PositionError < BaseModel
    ...
    def to_s
      ...
      "<#{class_name} time: #{@time}, utcoffset: #{@utcoffset}, type: #{@type}, info: #{@info},"\
      " additional_properties: #{@additional_properties}>"
    end
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} time: #{@time.inspect}, utcoffset: #{@utcoffset.inspect}, type:"\
      " #{@type.inspect}, info: #{@info.inspect}, additional_properties:"\
