...
module Verizon
  ...
  class SecuritySubscription < BaseModel
    ...
    def self.from_hash(hash)
      ...
      SecuritySubscription.new(extended_attributes: extended_attributes,
    ...
    def to_s
      ...
      "<#{class_name} extended_attributes: #{@extended_attributes}, license_assigned:"\
      " #{@license_assigned}, license_available: #{@license_available}, license_purchased:"\
      " #{@license_purchased}, license_type: #{@license_type}, sku_number: #{@sku_number}>"
    end

    # Provides a debugging-friendly string with detailed object information.
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} extended_attributes: #{@extended_attributes.inspect}, license_assigned:"\
      " #{@license_assigned.inspect}, license_available: #{@license_available.inspect},"\
      " license_purchased: #{@license_purchased.inspect}, license_type: #{@license_type.inspect},"\
