...
module Verizon
  ...
  class SearchDeviceByPropertyResponse < BaseModel
    ...
    def initialize(billingaccountid: SKIP, createdon: SKIP,
                   eventretention: SKIP, fields: SKIP, iccid: SKIP, id: SKIP,
                   imei: SKIP, kind: SKIP, lastupdated: SKIP, providerid: SKIP,
                   refid: SKIP, refidtype: SKIP, state: SKIP, version: SKIP,
                   versionid: SKIP, additional_properties: nil)
    ...
    def self.from_hash(hash)
      ...
      SearchDeviceByPropertyResponse.new(billingaccountid: billingaccountid,
                                         createdon: createdon,
    ...
    def to_s
      ...
      "<#{class_name} billingaccountid: #{@billingaccountid}, createdon: #{@createdon},"\
      " eventretention: #{@eventretention}, fields: #{@fields}, iccid: #{@iccid}, id: #{@id},"\
      " imei: #{@imei}, kind: #{@kind}, lastupdated: #{@lastupdated}, providerid: #{@providerid},"\
      " refid: #{@refid}, refidtype: #{@refidtype}, state: #{@state}, version: #{@version},"\
      " versionid: #{@versionid}, additional_properties: #{@additional_properties}>"
    end
    ...
    def inspect
      ...
      " #{@createdon.inspect}, eventretention: #{@eventretention.inspect}, fields:"\
      " #{@fields.inspect}, iccid: #{@iccid.inspect}, id: #{@id.inspect}, imei: #{@imei.inspect},"\
      " kind: #{@kind.inspect}, lastupdated: #{@lastupdated.inspect}, providerid:"\
      " #{@providerid.inspect}, refid: #{@refid.inspect}, refidtype: #{@refidtype.inspect}, state:"\
      " #{@state.inspect}, version: #{@version.inspect}, versionid: #{@versionid.inspect},"\
      " additional_properties: #{@additional_properties}>"
    end
  end
end
