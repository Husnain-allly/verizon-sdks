...
module Verizon
  ...
  class DeactivateDeviceProfileRequest < BaseModel
    ...
    def initialize(account_name:, reason_code:, devices: SKIP,
                   carrier_name: SKIP, etf_waiver: true,
    ...
    def self.from_hash(hash)
      ...
      DeactivateDeviceProfileRequest.new(account_name: account_name,
                                         reason_code: reason_code,
                                         devices: devices,
                                         carrier_name: carrier_name,
                                         etf_waiver: etf_waiver,
                                         check_fallback_profile: check_fallback_profile)
    end

    # Provides a human-readable string representation of the object.
    def to_s
      class_name = self.class.name.split('::').last
      "<#{class_name} account_name: #{@account_name}, reason_code: #{@reason_code}, devices:"\
      " #{@devices}, carrier_name: #{@carrier_name}, etf_waiver: #{@etf_waiver},"\
      " check_fallback_profile: #{@check_fallback_profile}>"
    end
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} account_name: #{@account_name.inspect}, reason_code:"\
      " #{@reason_code.inspect}, devices: #{@devices.inspect}, carrier_name:"\
      " #{@carrier_name.inspect}, etf_waiver: #{@etf_waiver.inspect}, check_fallback_profile:"\
      " #{@check_fallback_profile.inspect}>"
    end
  end
end
