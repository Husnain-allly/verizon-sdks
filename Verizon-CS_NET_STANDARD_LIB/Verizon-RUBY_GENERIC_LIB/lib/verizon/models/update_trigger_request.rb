...
module Verizon
  ...
  class UpdateTriggerRequest < BaseModel
    ...
    def initialize(account_name: SKIP, active: SKIP,
                   ...
                   trigger_category: SKIP, trigger_id: SKIP, trigger_name: SKIP)
    ...
    def self.from_hash(hash)
      ...
      UpdateTriggerRequest.new(account_name: account_name,
                               active: active,
                               anomaly_trigger_request: anomaly_trigger_request,
                               cycle_type: cycle_type,
                               data_trigger_request: data_trigger_request,
                               group_name: group_name,
                               promo_alert_trigger_request: promo_alert_trigger_request,
    ...
    def to_s
      ...
      "<#{class_name} account_name: #{@account_name}, active: #{@active},"\
      " anomaly_trigger_request: #{@anomaly_trigger_request}, cycle_type: #{@cycle_type},"\
      " data_trigger_request: #{@data_trigger_request}, group_name: #{@group_name},"\
      " promo_alert_trigger_request: #{@promo_alert_trigger_request}, session_trigger_request:"\
      " #{@session_trigger_request}, sms_trigger_request: #{@sms_trigger_request},"\
      " trigger_category: #{@trigger_category}, trigger_id: #{@trigger_id}, trigger_name:"\
      " #{@trigger_name}>"
    end
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} account_name: #{@account_name.inspect}, active: #{@active.inspect},"\
      " anomaly_trigger_request: #{@anomaly_trigger_request.inspect}, cycle_type:"\
      " #{@cycle_type.inspect}, data_trigger_request: #{@data_trigger_request.inspect},"\
      " group_name: #{@group_name.inspect}, promo_alert_trigger_request:"\
      " #{@promo_alert_trigger_request.inspect}, session_trigger_request:"\
      " #{@session_trigger_request.inspect}, sms_trigger_request: #{@sms_trigger_request.inspect},"\
      " trigger_category: #{@trigger_category.inspect}, trigger_id: #{@trigger_id.inspect},"\
