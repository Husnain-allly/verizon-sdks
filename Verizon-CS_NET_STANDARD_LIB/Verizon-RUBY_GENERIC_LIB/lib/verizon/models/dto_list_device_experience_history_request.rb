...
module Verizon
  # DtoListDeviceExperienceHistoryRequest Model.
  class DtoListDeviceExperienceHistoryRequest < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      DtoListDeviceExperienceHistoryRequest.new(accountname: accountname,
                                                filter: filter)
    end
