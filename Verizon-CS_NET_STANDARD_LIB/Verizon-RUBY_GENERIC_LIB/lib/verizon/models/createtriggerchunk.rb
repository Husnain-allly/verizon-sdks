...
module Verizon
  # Createtriggerchunk Model.
  class Createtriggerchunk < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      Createtriggerchunk.new(trigger_name: trigger_name,
                             ecpd_id: ecpd_id,
    ...
    # @param [Createtriggerchunk | Hash] The value against the validation is performed.
