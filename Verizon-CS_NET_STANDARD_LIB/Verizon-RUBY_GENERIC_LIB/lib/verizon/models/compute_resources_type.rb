...
module Verizon
  ...
  class ComputeResourcesType < BaseModel
    ...
    def self.from_hash(hash)
      ...
      ComputeResourcesType.new(gpu: gpu,
                               min_ramgb: min_ramgb,
    ...
    def to_s
      ...
      "<#{class_name} gpu: #{@gpu}, min_ramgb: #{@min_ramgb}, min_storage_gb:"\
      " #{@min_storage_gb}>"
    end
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} gpu: #{@gpu.inspect}, min_ramgb: #{@min_ramgb.inspect}, min_storage_gb:"\
      " #{@min_storage_gb.inspect}>"
    end
  end
end
