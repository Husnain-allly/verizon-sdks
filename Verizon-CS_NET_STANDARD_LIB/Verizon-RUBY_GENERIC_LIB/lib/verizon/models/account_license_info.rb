...
module Verizon
  ...
  class AccountLicenseInfo < BaseModel
    ...
    def initialize(account_name: SKIP, total_licenses: SKIP,
    ...
    def self.from_hash(hash)
      ...
      AccountLicenseInfo.new(account_name: account_name,
    ...
    def inspect
      ...
      " #{@last_seen_device_id.inspect}, device_list: #{@device_list.inspect},"\
      " additional_properties: #{@additional_properties}>"
    end
  end
end
