...
module Verizon
  ...
  class CarrierDeactivateRequest < BaseModel
    ...
    def initialize(account_name:, devices:, reason_code:, custom_fields: SKIP,
                   etf_waiver: SKIP, group_name: SKIP, service_plan: SKIP,
                   delete_after_deactivation: SKIP, additional_properties: nil)
    ...
    def self.from_hash(hash)
      ...
      CarrierDeactivateRequest.new(account_name: account_name,
                                   devices: devices,
                                   reason_code: reason_code,
                                   ...
                                   delete_after_deactivation: delete_after_deactivation,
                                   additional_properties: additional_properties)
    end
    ...
    def to_s
      ...
      "<#{class_name} account_name: #{@account_name}, devices: #{@devices}, reason_code:"\
      " #{@reason_code}, custom_fields: #{@custom_fields}, etf_waiver: #{@etf_waiver}, group_name:"\
      " #{@group_name}, service_plan: #{@service_plan}, delete_after_deactivation:"\
      " #{@delete_after_deactivation}, additional_properties: #{@additional_properties}>"
    end
    ...
    def inspect
      ...
      " reason_code: #{@reason_code.inspect}, custom_fields: #{@custom_fields.inspect},"\
      " etf_waiver: #{@etf_waiver.inspect}, group_name: #{@group_name.inspect}, service_plan:"\
      " #{@service_plan.inspect}, delete_after_deactivation:"\
      " #{@delete_after_deactivation.inspect}, additional_properties: #{@additional_properties}>"
    end
  end
end
