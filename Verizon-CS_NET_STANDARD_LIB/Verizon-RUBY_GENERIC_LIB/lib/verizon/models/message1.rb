...
module Verizon
  ...
  class Message1 < BaseModel
    ...
    def initialize(is_private:, road_user_type:, trigger_conditions:,
                   sae_alert:, limits: SKIP, distribution_type: SKIP,
    ...
    def self.from_hash(hash)
      ...
      sae_alert = SaeAlert.from_hash(hash['saeAlert']) if hash['saeAlert']
      ...
      Message1.new(is_private: is_private,
                   road_user_type: road_user_type,
                   trigger_conditions: trigger_conditions,
                   sae_alert: sae_alert,
                   limits: limits,
    ...
    # @param [Message1 | Hash] The value against the validation is performed.
      ...
      if value.instance_of? self
        return (
          APIHelper.valid_type?(value.is_private,
            ...
            APIHelper.valid_type?(value.sae_alert,
                                  ->(val) { SaeAlert.validate(val) },
                                  is_model_hash: true)
        )
      end
      ...
      (
        APIHelper.valid_type?(value['isPrivate'],
          ...
          APIHelper.valid_type?(value['triggerConditions'],
                                ->(val) { TriggerCondition.validate(val) }) and
          APIHelper.valid_type?(value['saeAlert'],
                                ->(val) { SaeAlert.validate(val) },
                                is_model_hash: true)
      )
    end
    ...
    def to_s
      ...
      " #{@distribution_type}, distribution_schedule: #{@distribution_schedule}, sae_alert:"\
      " #{@sae_alert}, additional_properties: #{@additional_properties}>"
    end
    ...
    def inspect
      ...
      " distribution_schedule: #{@distribution_schedule.inspect}, sae_alert:"\
      " #{@sae_alert.inspect}, additional_properties: #{@additional_properties}>"
    end
  end
end
