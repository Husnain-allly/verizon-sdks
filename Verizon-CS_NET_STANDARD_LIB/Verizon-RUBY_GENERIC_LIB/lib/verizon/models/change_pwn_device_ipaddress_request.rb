...
module Verizon
  ...
  class ChangePwnDeviceIpaddressRequest < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      unless hash['deviceList'].nil?
        ...
        hash['deviceList'].each do |structure|
          device_list << (DeviceListIp.from_hash(structure) if structure)
        end
      end
      ...
      ChangePwnDeviceIpaddressRequest.new(account_name: account_name,
                                          device_list: device_list,
                                          additional_properties: additional_properties)
    end
