...
module Verizon
  ...
  class Updatetriggerchunk < BaseModel
    SKIP = Object.new
    ...
    def self.from_hash(hash)
      ...
      Updatetriggerchunk.new(trigger_id: trigger_id,
    ...
    # @param [Updatetriggerchunk | Hash] The value against the validation is performed.
