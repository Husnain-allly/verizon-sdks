...
module Verizon
  ...
  class GioDeactivateDeviceProfileRequest < BaseModel
    ...
    def initialize(devices: SKIP, account_name: SKIP, service_plan: SKIP,
                   etf_waiver: false, reason_code: SKIP)
    ...
    def self.from_hash(hash)
      ...
      GioDeactivateDeviceProfileRequest.new(devices: devices,
    ...
    def to_s
      ...
      " #{@service_plan}, etf_waiver: #{@etf_waiver}, reason_code: #{@reason_code}>"
    end
    ...
    def inspect
      ...
      " service_plan: #{@service_plan.inspect}, etf_waiver: #{@etf_waiver.inspect}, reason_code:"\
      " #{@reason_code.inspect}>"
    end
  end
end
