...
module Verizon
  ...
  class CampaignSoftwareUpgrade < BaseModel
    ...
    def initialize(software_name:, software_from:, software_to:,
                   distribution_type:, start_date:, end_date:, device_list:,
                   campaign_name: SKIP, download_after_date: SKIP,
    ...
    def self.from_hash(hash)
      ...
      CampaignSoftwareUpgrade.new(software_name: software_name,
                                  software_from: software_from,
                                  software_to: software_to,
                                  distribution_type: distribution_type,
                                  start_date: start_date,
    ...
    def to_s
      ...
      "<#{class_name} campaign_name: #{@campaign_name}, software_name: #{@software_name},"\
      " software_from: #{@software_from}, software_to: #{@software_to}, distribution_type:"\
      " #{@distribution_type}, start_date: #{@start_date}, end_date: #{@end_date},"\
      ...
      " install_time_window_list: #{@install_time_window_list}, device_list: #{@device_list},"\
      " additional_properties: #{@additional_properties}>"
    end
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} campaign_name: #{@campaign_name.inspect}, software_name:"\
      " #{@software_name.inspect}, software_from: #{@software_from.inspect}, software_to:"\
      " #{@software_to.inspect}, distribution_type: #{@distribution_type.inspect}, start_date:"\
