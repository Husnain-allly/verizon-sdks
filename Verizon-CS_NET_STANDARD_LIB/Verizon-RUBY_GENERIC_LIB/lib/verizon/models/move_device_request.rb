...
module Verizon
  ...
  class MoveDeviceRequest < BaseModel
    ...
    def initialize(account_name:, filter: SKIP, custom_fields: SKIP,
                   devices: SKIP, group_name: SKIP, carrier_ip_pool_name: SKIP,
                   service_plan: SKIP, additional_properties: nil)
    ...
    def self.from_hash(hash)
      ...
      MoveDeviceRequest.new(account_name: account_name,
                            filter: filter,
    ...
    def to_s
      ...
      "<#{class_name} account_name: #{@account_name}, filter: #{@filter}, custom_fields:"\
      " #{@custom_fields}, devices: #{@devices}, group_name: #{@group_name}, carrier_ip_pool_name:"\
      " #{@carrier_ip_pool_name}, service_plan: #{@service_plan}, additional_properties:"\
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} account_name: #{@account_name.inspect}, filter: #{@filter.inspect},"\
