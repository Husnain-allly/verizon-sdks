...
module Verizon
  ...
  class UploadsActivatesDeviceRequest < BaseModel
    ...
    def initialize(account_name:, email_address:, device_sku:, upload_type:,
                   service_plan:, mdn_zip_code:, devices:,
                   carrier_ip_pool_name: SKIP, additional_properties: nil)
    ...
    def self.from_hash(hash)
      ...
      UploadsActivatesDeviceRequest.new(account_name: account_name,
                                        email_address: email_address,
                                        device_sku: device_sku,
                                        upload_type: upload_type,
                                        service_plan: service_plan,
    ...
    def to_s
      ...
      "<#{class_name} account_name: #{@account_name}, email_address: #{@email_address},"\
      " device_sku: #{@device_sku}, upload_type: #{@upload_type}, service_plan: #{@service_plan},"\
      " carrier_ip_pool_name: #{@carrier_ip_pool_name}, mdn_zip_code: #{@mdn_zip_code}, devices:"\
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} account_name: #{@account_name.inspect}, email_address:"\
      " #{@email_address.inspect}, device_sku: #{@device_sku.inspect}, upload_type:"\
      " #{@upload_type.inspect}, service_plan: #{@service_plan.inspect}, carrier_ip_pool_name:"\
      " #{@carrier_ip_pool_name.inspect}, mdn_zip_code: #{@mdn_zip_code.inspect}, devices:"\
      " #{@devices.inspect}, additional_properties: #{@additional_properties}>"
    end
  end
end
