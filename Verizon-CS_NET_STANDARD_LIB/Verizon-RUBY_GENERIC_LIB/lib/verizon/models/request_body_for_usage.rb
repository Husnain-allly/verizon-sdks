...
module Verizon
  ...
  class RequestBodyForUsage < BaseModel
    ...
    def initialize(account_id: SKIP, device_id: SKIP, start_time: SKIP,
    ...
    def self.from_hash(hash)
      ...
      RequestBodyForUsage.new(account_id: account_id,
                              device_id: device_id,
    ...
    def to_s
      ...
      "<#{class_name} account_id: #{@account_id}, device_id: #{@device_id}, start_time:"\
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} account_id: #{@account_id.inspect}, device_id: #{@device_id.inspect},"\
