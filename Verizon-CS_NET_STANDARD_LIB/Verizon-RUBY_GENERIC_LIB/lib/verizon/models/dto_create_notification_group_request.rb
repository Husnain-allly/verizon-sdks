...
module Verizon
  # DtoCreateNotificationGroupRequest Model.
  class DtoCreateNotificationGroupRequest < BaseModel
    SKIP = Object.new
    ...
    def initialize(group:, accountname: SKIP, userids: SKIP)
    ...
    def self.from_hash(hash)
      ...
      DtoCreateNotificationGroupRequest.new(group: group,
    ...
    def to_s
      ...
      "<#{class_name} accountname: #{@accountname}, group: #{@group}, userids: #{@userids}>"
    end

    # Provides a debugging-friendly string with detailed object information.
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} accountname: #{@accountname.inspect}, group: #{@group.inspect}, userids:"\
      " #{@userids.inspect}>"
    end
  end
end
