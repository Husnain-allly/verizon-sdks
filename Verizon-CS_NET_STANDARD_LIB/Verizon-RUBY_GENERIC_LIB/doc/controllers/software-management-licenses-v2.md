...
```ruby
software_management_licenses_v2_api = client.software_management_licenses_v2
```
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `data` property of this instance returns the response data which is of type [`V2LicenseSummary`](../../doc/models/v2-license-summary.md).
...
result = software_management_licenses_v2_api.get_account_license_status(
  account,
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `data` property of this instance returns the response data which is of type [`V2LicensesAssignedRemovedResult`](../../doc/models/v2-licenses-assigned-removed-result.md).
...
result = software_management_licenses_v2_api.assign_licenses_to_devices(
  account,
  body
)
...
result = software_management_licenses_v2_api.remove_licenses_from_devices(
  account,
  body
)
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `data` property of this instance returns the response data which is of type [`V2ListOfLicensesToRemove`](../../doc/models/v2-list-of-licenses-to-remove.md).
...
result = software_management_licenses_v2_api.list_licenses_to_remove(account)
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `data` property of this instance returns the response data which is of type [`V2ListOfLicensesToRemoveResult`](../../doc/models/v2-list-of-licenses-to-remove-result.md).
...
result = software_management_licenses_v2_api.create_list_of_licenses_to_remove(
  account,
  body
)
...
result = software_management_licenses_v2_api.delete_list_of_licenses_to_remove(account)
