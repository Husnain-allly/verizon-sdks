...
class SoftwareManagementSubscriptionsV3Api(BaseApi):

    """A Controller to access Endpoints in the verizon API."""
    def __init__(self, config):
        super(SoftwareManagementSubscriptionsV3Api, self).__init__(config)
    ...
    def get_account_subscription_status(self,
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(FotaV3Subscription.from_dictionary)
