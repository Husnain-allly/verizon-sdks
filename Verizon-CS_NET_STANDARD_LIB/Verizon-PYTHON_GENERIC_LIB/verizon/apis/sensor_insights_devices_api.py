...
class SensorInsightsDevicesApi(BaseApi):
    ...
    def sensor_insights_device_action_set_request(self,
        ...
        Args:
            body (DtoDeviceActionSetRequest | DtoDeviceCommand): Set device
                configuration
        ...
        return super().new_api_call_builder.request(
            ...
            .body_param(Parameter()
                        .value(body)
                        .is_required(True)
                        .validator(lambda value: UnionTypeLookUp.get('SensorInsightsDeviceActionSetRequestBody').validate(value)))
            .header_param(Parameter()
                          .key('accept')
                          .value('application/json'))
            .body_serializer(APIHelper.json_serialize)
