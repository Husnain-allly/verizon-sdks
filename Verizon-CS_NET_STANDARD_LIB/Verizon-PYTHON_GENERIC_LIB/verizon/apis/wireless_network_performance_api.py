...
class WirelessNetworkPerformanceApi(BaseApi):
    ...
    def __init__(self, config):
        super(WirelessNetworkPerformanceApi, self).__init__(config)
    ...
    def domestic_4_g_and_5g_nationwide_network_coverage(self,
        ...
        Args:
            body (GetWirelessCoverageRequest | GetWirelessCoverageRequestFwa):
        ...
        return super().new_api_call_builder.request(
            ...
            .body_param(Parameter()
                        .value(body)
                        .is_required(True)
                        .validator(lambda value: UnionTypeLookUp.get('Domestic4GAnd5GNationwideNetworkCoverageBody').validate(value)))
            .header_param(Parameter()
                          .key('accept')
                          .value('application/json'))
            .body_serializer(APIHelper.json_serialize)
