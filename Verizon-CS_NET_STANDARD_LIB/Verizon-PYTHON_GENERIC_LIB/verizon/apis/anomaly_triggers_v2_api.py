...
class AnomalyTriggersV2Api(BaseApi):
    ...
    def __init__(self, config):
        super(AnomalyTriggersV2Api, self).__init__(config)
    ...
    def create_anomaly_detection_trigger_v2(self,
        ...
        Args:
            body (List[TriggerType1 | ActiveAnomalyIndicator |
                ActiveTriggerIndicator]): Request to create an anomaly trigger.
        ...
        return super().new_api_call_builder.request(
            ...
            .body_param(Parameter()
                        .value(body)
                        .is_required(True)
                        .validator(lambda value: UnionTypeLookUp.get('CreateTriggerRequestOptions').validate(value)))
            .header_param(Parameter()
                          .key('accept')
                          .value('application/json'))
    ...
    def update_anomaly_detection_trigger_v2(self,
        ...
        Args:
            body (List[TriggerType3 | ActiveAnomalyIndicator]): Request to
        ...
        return super().new_api_call_builder.request(
            ...
            .body_param(Parameter()
                        .value(body)
                        .is_required(True)
                        .validator(lambda value: UnionTypeLookUp.get('UpdateTriggerRequestOptions').validate(value)))
            .header_param(Parameter()
                          .key('accept')
                          .value('application/json'))
            .body_serializer(APIHelper.json_serialize)
