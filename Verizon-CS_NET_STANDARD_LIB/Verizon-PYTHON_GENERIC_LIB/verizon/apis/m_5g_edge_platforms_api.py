...
class M5GEdgePlatformsApi(BaseApi):

    """A Controller to access Endpoints in the verizon API."""
    def __init__(self, config):
        super(M5GEdgePlatformsApi, self).__init__(config)
    ...
    def list_mec_platforms(self,
        ...
        Args:
            ...
            ue_identity_type (UserEquipmentIdentityType, optional): Type of
                User Equipment identifier used in `UEIdentity`.
