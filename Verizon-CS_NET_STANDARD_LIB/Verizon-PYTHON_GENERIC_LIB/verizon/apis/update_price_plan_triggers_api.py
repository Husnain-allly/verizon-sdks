...
class UpdatePricePlanTriggersApi(BaseApi):
    ...
    def __init__(self, config):
        super(UpdatePricePlanTriggersApi, self).__init__(config)
    ...
    def update_trigger_rules(self,
        ...
        Args:
            body (AccountLevelUpdateTriggerRequest |
                ...
                PayAsYouGoUpdateTriggerRequest | Updatetriggerchunk): Update a
                trigger
        ...
        return super().new_api_call_builder.request(
            ...
            .body_param(Parameter()
                        .value(body)
                        .is_required(True)
                        .validator(lambda value: UnionTypeLookUp.get('UpdateTriggerRulesBody').validate(value)))
            .header_param(Parameter()
                          .key('accept')
                          .value('application/json'))
