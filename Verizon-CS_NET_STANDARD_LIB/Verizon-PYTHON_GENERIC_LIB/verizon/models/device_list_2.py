...
class DeviceList2(object):
    ...
    Attributes:
        ids (List[EsimDeviceId | DeviceId2] | None): The model property of
    ...
    def from_dictionary(cls,
        ...
        ids = APIHelper.deserialize_union_type(UnionTypeLookUp.get('DeviceList2Ids'), dictionary.get('ids'), False) if dictionary.get('ids') is not None else APIHelper.SKIP
