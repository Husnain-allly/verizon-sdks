...
class M5GBiactivateRequest(object):
    ...
    def from_dictionary(cls,
        ...
        device_list_with_service_address = APIHelper.deserialize_union_type(UnionTypeLookUp.get('5gbiactivateRequestDeviceListWithServiceAddress'), dictionary.get('deviceListWithServiceAddress'), False) if dictionary.get('deviceListWithServiceAddress') is not None else APIHelper.SKIP
