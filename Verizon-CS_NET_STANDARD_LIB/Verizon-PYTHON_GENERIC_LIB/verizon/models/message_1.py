...
from verizon.models.sae_alert import SaeAlert
...
class Message1(object):
    ...
    Attributes:
        ...
        sae_alert (SaeAlert): The model property of type SaeAlert.
    ...
    def from_dictionary(cls,
        ...
        sae_alert = SaeAlert.from_dictionary(dictionary.get('saeAlert')) if dictionary.get('saeAlert') else None
    ...
    def validate(cls, dictionary):
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(value=dictionary.is_private,
                ...
                and APIHelper.is_valid_type(value=dictionary.sae_alert,
                                            type_callable=lambda value: SaeAlert.validate(value),
                                            is_model_dict=True)
        ...
        return APIHelper.is_valid_type(value=dictionary.get('isPrivate'),
            ...
            and APIHelper.is_valid_type(value=dictionary.get('triggerConditions'),
                                        type_callable=lambda value: TriggerCondition.validate(value)) \
            and APIHelper.is_valid_type(value=dictionary.get('saeAlert'),
                                        type_callable=lambda value: SaeAlert.validate(value),
                                        is_model_dict=True)
