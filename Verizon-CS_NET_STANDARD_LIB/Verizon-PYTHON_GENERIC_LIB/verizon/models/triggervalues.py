...
class Triggervalues(object):
    ...
    Attributes:
        ...
        trigger_attributes (List[KeyServicePlan | KeyDataPercentage50 |
            ...
            The model property of type List[KeyServicePlan |
            KeyDataPercentage50 | KeysmsPercentage50 | NoOfDaysB4PromoExp |
            EnablePromoExp] | None.
    ...
    def from_dictionary(cls,
        ...
        trigger_attributes = APIHelper.deserialize_union_type(UnionTypeLookUp.get('keysChunk'), dictionary.get('triggerAttributes'), False) if dictionary.get('triggerAttributes') is not None else APIHelper.SKIP
