...
class EsimGlobalDeviceList(object):
    ...
    Attributes:
        ...
        provisioning_status_filter (ProvisioningStatusFilter): The last status
            of the device as a list filter.
        profile_status_filter (ProfileStatusFilter): The last status of the
            device's profile as a filter.
        carrier_name_filter (str): The cellular service provider.
        device_filter (List[EsimDeviceId | DeviceId2] | None): An array of
            device identifiers to filter the list.
    ...
    def from_dictionary(cls,
        ...
        device_filter = APIHelper.deserialize_union_type(UnionTypeLookUp.get('ESIMGlobalDeviceListDeviceFilter'), dictionary.get('deviceFilter'), False) if dictionary.get('deviceFilter') is not None else APIHelper.SKIP
