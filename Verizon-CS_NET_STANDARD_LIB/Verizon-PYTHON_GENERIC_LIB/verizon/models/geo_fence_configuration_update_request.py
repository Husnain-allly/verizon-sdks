...
class GeoFenceConfigurationUpdateRequest(object):
    ...
    Attributes:
        ...
        messages (List[Message | Message1 | Message2] | None): List of
            predefined messages that belongs to the geofence. These are the
            messages that are sent out by the system when the Trigger
            Condition for the message is met.
    ...
    def from_dictionary(cls,
        ...
        messages = APIHelper.deserialize_union_type(UnionTypeLookUp.get('Message32'), dictionary.get('messages'), False) if dictionary.get('messages') is not None else APIHelper.SKIP
