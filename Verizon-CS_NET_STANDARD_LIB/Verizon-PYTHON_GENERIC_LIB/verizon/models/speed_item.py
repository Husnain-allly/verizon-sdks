...
class SpeedItem(object):
    ...
    def validate(cls, dictionary):
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(value=dictionary.speed,
                                           type_callable=lambda value: Speed.validate(value),
        ...
        return APIHelper.is_valid_type(value=dictionary.get('speed'),
                                       type_callable=lambda value: Speed.validate(value),
                                       is_value_nullable=True,
                                       is_model_dict=True)
