...
from verizon.models.line_string_type import LineStringType
...
class LineString(object):
    ...
    Attributes:
        mtype (LineStringType): The model property of type LineStringType.
    ...
    def validate(cls, dictionary):
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(value=dictionary.mtype,
                                           type_callable=lambda value: LineStringType.validate(value)) \
