...
class DataTrigger1(object):
    ...
    def from_dictionary(cls,
        ...
        condition = APIHelper.deserialize_union_type(UnionTypeLookUp.get('DataTrigger1Condition'), dictionary.get('condition'), False) if dictionary.get('condition') is not None else APIHelper.SKIP
