...
from verizon.models.multi_line_string_type import MultiLineStringType
...
class MultiLineString(object):
    ...
    Attributes:
        mtype (MultiLineStringType): The model property of type
            MultiLineStringType.
    ...
    def validate(cls, dictionary):
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(value=dictionary.mtype,
                                           type_callable=lambda value: MultiLineStringType.validate(value)) \
