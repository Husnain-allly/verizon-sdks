...
class Notificationarray(object):
    ...
    def from_dictionary(cls,
        ...
        sms_numbers = APIHelper.deserialize_union_type(UnionTypeLookUp.get('NotificationarraySmsNumbers'), dictionary.get('smsNumbers'), False) if dictionary.get('smsNumbers') is not None else APIHelper.SKIP
