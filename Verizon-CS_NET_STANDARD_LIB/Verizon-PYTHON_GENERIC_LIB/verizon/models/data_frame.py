...
from verizon.models.frame_type import FrameType
...
class DataFrame(object):
    ...
    Attributes:
        ...
        msg_id (MsgId | MsgId1): The model property of type MsgId | MsgId1.
        ...
        not_used_3 (int): Always set to 0 and carries no meaning. Legacy field
            maintained for backward compatibility.
        content (Content | Content1 | Content2 | Content3 | Content4): The
            model property of type Content | Content1 | Content2 | Content3 |
            Content4.
    ...
    def from_dictionary(cls,
        ...
        msg_id = APIHelper.deserialize_union_type(UnionTypeLookUp.get('DataFrameMsgId'), dictionary.get('msgId'), False) if dictionary.get('msgId') is not None else None
        ...
        content = APIHelper.deserialize_union_type(UnionTypeLookUp.get('DataFrameContent'), dictionary.get('content'), False) if dictionary.get('content') is not None else None
    ...
    def validate(cls, dictionary):
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(value=dictionary.not_used,
                                           type_callable=lambda value: isinstance(value, int)) \
                and APIHelper.is_valid_type(value=dictionary.frame_type,
                                            type_callable=lambda value: FrameType.validate(value)) \
                and UnionTypeLookUp.get('DataFrameMsgId').validate(dictionary.msg_id).is_valid \
                and APIHelper.is_valid_type(value=dictionary.start_time,
                                            type_callable=lambda value: isinstance(value, int)) \
                and APIHelper.is_valid_type(value=dictionary.duration_time,
                                            type_callable=lambda value: isinstance(value, int)) \
                and APIHelper.is_valid_type(value=dictionary.priority,
                                            type_callable=lambda value: isinstance(value, int)) \
                and APIHelper.is_valid_type(value=dictionary.not_used_1,
                                            type_callable=lambda value: isinstance(value, int)) \
                and APIHelper.is_valid_type(value=dictionary.regions,
                                            type_callable=lambda value: GeographicalPath.validate(value),
                                            is_model_dict=True,
                                            is_inner_model_dict=True) \
                and APIHelper.is_valid_type(value=dictionary.not_used_2,
                                            type_callable=lambda value: isinstance(value, int)) \
                and APIHelper.is_valid_type(value=dictionary.not_used_3,
                                            type_callable=lambda value: isinstance(value, int)) \
                and UnionTypeLookUp.get('DataFrameContent').validate(dictionary.content).is_valid

        if not isinstance(dictionary, dict):
            return False

        return APIHelper.is_valid_type(value=dictionary.get('notUsed'),
                                       type_callable=lambda value: isinstance(value, int)) \
            and APIHelper.is_valid_type(value=dictionary.get('frameType'),
                                        type_callable=lambda value: FrameType.validate(value)) \
            and UnionTypeLookUp.get('DataFrameMsgId').validate(dictionary.get('msgId')).is_valid \
            and APIHelper.is_valid_type(value=dictionary.get('startTime'),
                                        type_callable=lambda value: isinstance(value, int)) \
            and APIHelper.is_valid_type(value=dictionary.get('durationTime'),
                                        type_callable=lambda value: isinstance(value, int)) \
            and APIHelper.is_valid_type(value=dictionary.get('priority'),
                                        type_callable=lambda value: isinstance(value, int)) \
            and APIHelper.is_valid_type(value=dictionary.get('notUsed1'),
                                        type_callable=lambda value: isinstance(value, int)) \
            and APIHelper.is_valid_type(value=dictionary.get('regions'),
                                        type_callable=lambda value: GeographicalPath.validate(value),
                                        is_model_dict=True,
                                        is_inner_model_dict=True) \
            and APIHelper.is_valid_type(value=dictionary.get('notUsed2'),
                                        type_callable=lambda value: isinstance(value, int)) \
            and APIHelper.is_valid_type(value=dictionary.get('notUsed3'),
                                        type_callable=lambda value: isinstance(value, int)) \
            and UnionTypeLookUp.get('DataFrameContent').validate(dictionary.get('content')).is_valid
