...
class M5GBiaccountNameobject(object):
    ...
    Attributes:
        ...
        custom_fields (List[M5GBikeyValue1] | None): The model property of
            type List[M5GBikeyValue1] | None.
        device_ids (List[M5GBideviceId1] | None): The model property of type
            List[M5GBideviceId1] | None.
        extended_attributes (List[M5GBiattribute1 | M5GBiattribute2] | None):
            The model property of type List[M5GBiattribute1 | M5GBiattribute2]
            | None.
    ...
    def from_dictionary(cls,
        ...
        custom_fields = APIHelper.deserialize_union_type(UnionTypeLookUp.get('5gbiaccountNameobjectCustomFields'), dictionary.get('customFields'), False) if dictionary.get('customFields') is not None else APIHelper.SKIP
        device_ids = APIHelper.deserialize_union_type(UnionTypeLookUp.get('5gbiaccountNameobjectDeviceIds'), dictionary.get('deviceIds'), False) if dictionary.get('deviceIds') is not None else APIHelper.SKIP
        extended_attributes = APIHelper.deserialize_union_type(UnionTypeLookUp.get('5gbiaccountNameobjectExtendedAttributes'), dictionary.get('extendedAttributes'), False) if dictionary.get('extendedAttributes') is not None else APIHelper.SKIP
        group_names = None
