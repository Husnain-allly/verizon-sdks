...
from verizon.models.multi_polygon_type import MultiPolygonType
...
class MultiPolygon(object):
    ...
    Attributes:
        mtype (MultiPolygonType): The model property of type MultiPolygonType.
    ...
    def validate(cls, dictionary):
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(value=dictionary.mtype,
                                           type_callable=lambda value: MultiPolygonType.validate(value)) \
