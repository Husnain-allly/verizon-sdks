...
class MecPlatformResource(object):
    ...
    Attributes:
        ...
        region (str): MEC region name. Current valid values are US_WEST_2 and
            US_EAST_1.
        status (MecPlatformStatus): Status of the MEC Platform (default is
            'unknown')
        properties (List[MecPlatformsAdditionalSupportInfo] |
            MecPlatformsAdditionalSupportInfo | None): The model property of
            type List[MecPlatformsAdditionalSupportInfo] |
            MecPlatformsAdditionalSupportInfo | None.
    ...
    def from_dictionary(cls,
        ...
        properties = APIHelper.deserialize_union_type(UnionTypeLookUp.get('MECPlatformResourceProperties'), dictionary.get('properties'), False) if dictionary.get('properties') is not None else APIHelper.SKIP
