...
class NodeListLl(object):
    ...
    def validate(cls, dictionary):
        ...
        if isinstance(dictionary, cls):
            return APIHelper.is_valid_type(value=dictionary.nodes,
                                           type_callable=lambda value: NodeLl.validate(value),
                                           is_model_dict=True,
        ...
        return APIHelper.is_valid_type(value=dictionary.get('nodes'),
                                       type_callable=lambda value: NodeLl.validate(value),
                                       is_model_dict=True,
                                       is_inner_model_dict=True)
