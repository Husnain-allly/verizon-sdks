...
class ProfileRequest(object):
    ...
    Attributes:
        ...
        primary_place_of_use (List[Customernamequery | Addressquery] | None):
            The model property of type List[Customernamequery | Addressquery]
            | None.
    ...
    def from_dictionary(cls,
        ...
        primary_place_of_use = APIHelper.deserialize_union_type(UnionTypeLookUp.get('ProfileRequestPrimaryPlaceOfUse'), dictionary.get('primaryPlaceOfUse'), False) if dictionary.get('primaryPlaceOfUse') is not None else APIHelper.SKIP
