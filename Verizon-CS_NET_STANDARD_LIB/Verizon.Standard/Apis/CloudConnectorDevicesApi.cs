// <copyright file="CloudConnectorDevicesApi.cs" company="APIMatic">
...
namespace Verizon.Standard.Apis
{
    ...
    /// </summary>
    public class CloudConnectorDevicesApi : BaseApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CloudConnectorDevicesApi"/> class.
        /// </summary>
        internal CloudConnectorDevicesApi(GlobalConfiguration globalConfiguration) : base(globalConfiguration) { }
        ...
        public async Task<ApiResponse<Models.SearchSensorHistoryResponseList>> SearchSensorReadingsAsync(
            ...
            => await CreateApiCall<Models.SearchSensorHistoryResponseList>()
              ...
              .RequestBuilder(_requestBuilder => _requestBuilder
                  ...
                  .Parameters(_parameters => _parameters
                      .Body(_bodyParameter => _bodyParameter.Setup(body).Required())
                      .Template(_template => _template.Setup("fieldname", fieldname).Required())
                      .Header(_header => _header.Setup("Content-Type", "application/json"))))
              .ExecuteAsync(cancellationToken).ConfigureAwait(false);
