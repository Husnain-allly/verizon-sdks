// <copyright file="DeviceReportsApi.cs" company="APIMatic">
...
namespace Verizon.Standard.Apis
{
    ...
    /// DeviceReportsApi.
    /// </summary>
    public class DeviceReportsApi : BaseApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceReportsApi"/> class.
        /// </summary>
        internal DeviceReportsApi(GlobalConfiguration globalConfiguration) : base(globalConfiguration) { }
