// <copyright file="DeviceProfileManagementApi.cs" company="APIMatic">
...
namespace Verizon.Standard.Apis
{
    ...
    /// </summary>
    public class DeviceProfileManagementApi : BaseApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceProfileManagementApi"/> class.
        /// </summary>
        internal DeviceProfileManagementApi(GlobalConfiguration globalConfiguration) : base(globalConfiguration) { }
