// <copyright file="DeviceLocationCallbacksApi.cs" company="APIMatic">
...
namespace Verizon.Standard.Apis
{
    ...
    /// </summary>
    public class DeviceLocationCallbacksApi : BaseApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceLocationCallbacksApi"/> class.
        /// </summary>
        internal DeviceLocationCallbacksApi(GlobalConfiguration globalConfiguration) : base(globalConfiguration) { }
