...
```csharp
HyperPreciseLocationCallbacksApi hyperPreciseLocationCallbacksApi = client.HyperPreciseLocationCallbacksApi;
```
...
try
{
    ApiResponse<List<CallbackCreated>> result = await hyperPreciseLocationCallbacksApi.ListRegisteredCallbacksAsync(accountNumber);
}
...
try
{
    ApiResponse<CallbackRegistered> result = await hyperPreciseLocationCallbacksApi.RegisterCallbackAsync(
        accountNumber,
        body
    );
}
...
try
{
    await hyperPreciseLocationCallbacksApi.DeregisterCallbackAsync(
        accountNumber,
        service
    );
}
