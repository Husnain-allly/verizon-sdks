...
```csharp
ServiceEndpointsApi serviceEndpointsApi = client.ServiceEndpointsApi;
```
...
try
{
    ApiResponse<ListOptimalServiceEndpointsResult> result = await serviceEndpointsApi.ListOptimalServiceEndpointsAsync(
        region,
        null,
        ueIdentityType,
        ueIdentity,
...
```csharp
List<ResourcesEdgeHostedServiceWithProfileId> body = new List<ResourcesEdgeHostedServiceWithProfileId>
{
...
try
{
    ApiResponse<RegisterServiceEndpointResult> result = await serviceEndpointsApi.RegisterServiceEndpointsAsync(body);
}
catch (ApiException e)
{
    // TODO: Handle exception here
...
try
{
    ApiResponse<ListAllServiceEndpointsResult> result = await serviceEndpointsApi.ListAllServiceEndpointsAsync();
}
catch (ApiException e)
{
    // TODO: Handle exception here
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `Data` property of this instance returns the response data which is of type [List<Models.ResourcesEdgeHostedServiceWithProfileId>](../../doc/models/resources-edge-hosted-service-with-profile-id.md).
...
try
{
    ApiResponse<List<ResourcesEdgeHostedServiceWithProfileId>> result = await serviceEndpointsApi.GetServiceEndpointAsync(serviceEndpointsId);
}
catch (ApiException e)
{
    // TODO: Handle exception here
...
try
{
    ApiResponse<UpdateServiceEndpointResult> result = await serviceEndpointsApi.UpdateServiceEndpointAsync(
        serviceEndpointsId,
        body
    );
}
...
try
{
    ApiResponse<DeregisterServiceEndpointResult> result = await serviceEndpointsApi.DeregisterServiceEndpointAsync(serviceEndpointsId);
}
catch (ApiException e)
{
    // TODO: Handle exception here
