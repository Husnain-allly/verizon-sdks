...
```php
$anomalyTriggersApi = $client->getAnomalyTriggersApi();
```
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `getResult()` method on this instance returns the response data which is of type [`GetTriggerResponseList[]`](../../doc/models/get-trigger-response-list.md).

## Example Usage

```php
$apiResponse = $anomalyTriggersApi->listAnomalyDetectionTriggers();
```
...
$apiResponse = $anomalyTriggersApi->updateAnomalyDetectionTrigger($body);
```
...
$apiResponse = $anomalyTriggersApi->createAnomalyDetectionTrigger($body);
```
...
$apiResponse = $anomalyTriggersApi->listAnomalyDetectionTriggerSettings($triggerId);
```
...
$apiResponse = $anomalyTriggersApi->deleteAnomalyDetectionTrigger($triggerId);
```
