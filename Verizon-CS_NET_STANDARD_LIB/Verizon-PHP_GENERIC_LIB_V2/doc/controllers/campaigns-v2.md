...
```php
$campaignsV2Api = $client->getCampaignsV2Api();
```
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `getResult()` method on this instance returns the response data which is of type [`CampaignSoftware`](../../doc/models/campaign-software.md).
...
$apiResponse = $campaignsV2Api->scheduleCampaignFirmwareUpgrade(
    $account,
    $body
);
```
...
$apiResponse = $campaignsV2Api->getCampaignInformation(
    $account,
    $campaignId
);
```
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `getResult()` method on this instance returns the response data which is of type [`V2AddOrRemoveDeviceResult`](../../doc/models/v2-add-or-remove-device-result.md).
...
$apiResponse = $campaignsV2Api->updateCampaignFirmwareDevices(
    $account,
    $campaignId,
    $body
);
...
$apiResponse = $campaignsV2Api->cancelCampaign(
    $account,
    $campaignId
);
```
...
$apiResponse = $campaignsV2Api->updateCampaignDates(
    $account,
    $campaignId,
    $body
);
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `getResult()` method on this instance returns the response data which is of type [`UploadAndScheduleFileResponse`](../../doc/models/upload-and-schedule-file-response.md).
...
$apiResponse = $campaignsV2Api->scheduleFileUpgrade(
    $acc,
    $body
);
```
...
$apiResponse = $campaignsV2Api->scheduleSwUpgradeHttpDevices(
    $acc,
    $body
);
```
