...
```php
$softwareManagementCallbacksV2Api = $client->getSoftwareManagementCallbacksV2Api();
```
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `getResult()` method on this instance returns the response data which is of type [`CallbackSummary`](../../doc/models/callback-summary.md).
...
$apiResponse = $softwareManagementCallbacksV2Api->listRegisteredCallbacks($account);
```
...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `getResult()` method on this instance returns the response data which is of type [`FotaV2CallbackRegistrationResult`](../../doc/models/fota-v2-callback-registration-result.md).
...
$apiResponse = $softwareManagementCallbacksV2Api->updateCallback(
    $account,
    $body
);
```
...
$apiResponse = $softwareManagementCallbacksV2Api->registerCallback(
    $account,
    $body
);
```
...
$apiResponse = $softwareManagementCallbacksV2Api->deregisterCallback($account);
```
