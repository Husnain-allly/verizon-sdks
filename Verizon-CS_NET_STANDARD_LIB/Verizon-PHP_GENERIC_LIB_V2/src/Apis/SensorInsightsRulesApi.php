...
class SensorInsightsRulesApi extends BaseApi
{
    /**
     * @param DtoOverwriteRuleRequest $body Overwrite a rule
     *
     * @return ApiResponse Response from the API call
     */
    public function sensorInsightsOverwriteRuleRequest(DtoOverwriteRuleRequest $body): ApiResponse
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/dm/v1/rules')
    ...
    /**
     * @param DtoListRulesRequest $body Retrieve a rule
     *
     * @return ApiResponse Response from the API call
     */
    public function sensorInsightsListRulesRequest(DtoListRulesRequest $body): ApiResponse
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/dm/v1/rules/actions/query')
            ->server(Server::THINGSPACE)
            ->auth(Auth::and('thingspace_oauth', 'VZ-M2M-Token'))
            ->parameters(HeaderParam::init('Content-Type', 'application/json'), BodyParam::init($body)->required());
