...
class DeviceManagementApi extends BaseApi
{
    /**
    ...
    public function updateDeviceId(string $serviceType, ChangeDeviceIdRequest $body): ApiResponse
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::PUT, '/m2m/v1/devices/{serviceType}/actions/deviceId')
            ...
            ->auth(Auth::and('thingspace_oauth', 'VZ-M2M-Token'))
            ->parameters(
                TemplateParam::init('serviceType', $serviceType)->required(),
    ...
    public function usageSegmentationLabelDeletion(string $accountName, LabelsList $labelList): ApiResponse
    {
        $_reqBuilder = $this->requestBuilder(
            ...
            ->parameters(
                ...
                QueryParam::init('LabelList', $labelList)->required()
            );
     ...
     *
     * @param UploadsActivatesDeviceRequest $body Request to Upload and Activate device.
     *
     * @return ApiResponse Response from the API call
     */
    public function uploadActivateDevice(UploadsActivatesDeviceRequest $body): ApiResponse
    {
     ...
     * @return ApiResponse Response from the API call
     */
    public function deviceUploadStatus(CheckOrderStatusRequest $body): ApiResponse
    {
