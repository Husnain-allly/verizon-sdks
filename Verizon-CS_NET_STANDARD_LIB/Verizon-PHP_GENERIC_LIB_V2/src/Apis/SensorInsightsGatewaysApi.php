...
class SensorInsightsGatewaysApi extends BaseApi
{
    /**
     * @param DtoListDevicesRequest $body Get gateway information
     *
     * @return ApiResponse Response from the API call
     */
    public function sensorInsightsListGatewayDevicesRequest(DtoListDevicesRequest $body): ApiResponse
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/dm/v1/devices/gateways/actions/query')
