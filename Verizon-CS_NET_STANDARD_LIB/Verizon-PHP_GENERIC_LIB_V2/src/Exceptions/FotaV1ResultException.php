...
class FotaV1ResultException extends ApiException
{
    ...
    /**
     * Converts the FotaV1ResultException object to a human-readable string representation.
     *
     * @return string The string representation of the FotaV1ResultException object.
     */
