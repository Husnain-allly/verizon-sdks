...
class FotaV2ResultException extends ApiException
{
    ...
    /**
     * Converts the FotaV2ResultException object to a human-readable string representation.
     *
     * @return string The string representation of the FotaV2ResultException object.
     */
