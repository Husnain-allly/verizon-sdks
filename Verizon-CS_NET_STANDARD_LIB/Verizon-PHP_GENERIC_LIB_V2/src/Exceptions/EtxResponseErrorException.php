 ...
 */
class EtxResponseErrorException extends ApiException
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the EtxResponseErrorException object to a human-readable string representation.
     *
     * @return string The string representation of the EtxResponseErrorException object.
     */
