 ...
 * Error response.
 */
class FotaV3ResultException extends ApiException
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the FotaV3ResultException object to a human-readable string representation.
     *
     * @return string The string representation of the FotaV3ResultException object.
     */
