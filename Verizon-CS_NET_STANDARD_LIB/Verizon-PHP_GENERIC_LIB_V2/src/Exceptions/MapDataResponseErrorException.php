 ...
 */
class MapDataResponseErrorException extends ApiException
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the MapDataResponseErrorException object to a human-readable string representation.
     *
     * @return string The string representation of the MapDataResponseErrorException object.
     */
