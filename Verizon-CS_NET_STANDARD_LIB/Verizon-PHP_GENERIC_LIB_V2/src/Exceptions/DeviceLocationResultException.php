...
class DeviceLocationResultException extends ApiException
{
    ...
    /**
     * Converts the DeviceLocationResultException object to a human-readable string representation.
     *
     * @return string The string representation of the DeviceLocationResultException object.
     */
