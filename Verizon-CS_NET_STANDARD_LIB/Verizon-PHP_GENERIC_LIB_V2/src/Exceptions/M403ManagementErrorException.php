...
class M403ManagementErrorException extends ApiException
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the M403ManagementErrorException object to a human-readable string representation.
     *
     * @return string The string representation of the M403ManagementErrorException object.
     */
