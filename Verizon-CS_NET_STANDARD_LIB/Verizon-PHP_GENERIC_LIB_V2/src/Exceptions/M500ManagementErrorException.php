...
class M500ManagementErrorException extends ApiException
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the M500ManagementErrorException object to a human-readable string representation.
     *
     * @return string The string representation of the M500ManagementErrorException object.
     */
