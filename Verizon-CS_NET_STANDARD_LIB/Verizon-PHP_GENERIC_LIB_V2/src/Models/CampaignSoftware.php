 ...
 */
class CampaignSoftware implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the CampaignSoftware object to a human-readable string representation.
     *
     * @return string The string representation of the CampaignSoftware object.
     */
