...
class V1AccountSubscription implements \JsonSerializable
{
    ...
    /**
     * Converts the V1AccountSubscription object to a human-readable string representation.
     *
     * @return string The string representation of the V1AccountSubscription object.
     */
