...
class DeviceListQueryResult implements \JsonSerializable
{
    ...
    /**
     * Converts the DeviceListQueryResult object to a human-readable string representation.
     *
     * @return string The string representation of the DeviceListQueryResult object.
     */
    ...
    protected $propertyNames = ['accountName', 'hasMoreData', 'lastSeenDeviceId', 'deviceList'];
