...
class AccountLeadsResult implements \JsonSerializable
{
    ...
    /**
     * Converts the AccountLeadsResult object to a human-readable string representation.
     *
     * @return string The string representation of the AccountLeadsResult object.
     */
    ...
    protected $propertyNames = ['hasMoreData', 'leads'];
