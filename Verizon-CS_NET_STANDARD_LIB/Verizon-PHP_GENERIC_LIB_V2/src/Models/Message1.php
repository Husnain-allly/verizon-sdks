...
class Message1 implements \JsonSerializable
{
    /**
     * @var bool
     */
     ...
     */
    public function __construct(bool $isPrivate, array $roadUserType, array $triggerConditions, SaeAlert $saeAlert)
    {
     ...
     * Returns Sae Alert.
     */
    public function getSaeAlert(): SaeAlert
    {
        return $this->saeAlert;
    }
     ...
     * @maps saeAlert
     */
    public function setSaeAlert(SaeAlert $saeAlert): void
    {
        $this->saeAlert = $saeAlert;
    }

    /**
     * Converts the Message1 object to a human-readable string representation.
     *
     * @return string The string representation of the Message1 object.
     */
