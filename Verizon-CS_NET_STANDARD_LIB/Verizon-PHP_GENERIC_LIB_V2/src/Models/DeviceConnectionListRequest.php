 ...
 */
class DeviceConnectionListRequest implements \JsonSerializable
{
    /**
     * @var DeviceId
     */
    ...
    /**
     * Converts the DeviceConnectionListRequest object to a human-readable string representation.
     *
     * @return string The string representation of the DeviceConnectionListRequest object.
     */
