...
class SearchDeviceResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the SearchDeviceResponse object to a human-readable string representation.
     *
     * @return string The string representation of the SearchDeviceResponse object.
     */
