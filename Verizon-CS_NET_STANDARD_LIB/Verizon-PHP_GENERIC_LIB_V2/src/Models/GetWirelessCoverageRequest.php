...
class GetWirelessCoverageRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the GetWirelessCoverageRequest object to a human-readable string representation.
     *
     * @return string The string representation of the GetWirelessCoverageRequest object.
     */
