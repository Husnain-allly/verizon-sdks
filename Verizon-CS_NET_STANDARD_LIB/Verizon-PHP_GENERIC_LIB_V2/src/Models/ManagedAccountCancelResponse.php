...
class ManagedAccountCancelResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the ManagedAccountCancelResponse object to a human-readable string representation.
     *
     * @return string The string representation of the ManagedAccountCancelResponse object.
     */
