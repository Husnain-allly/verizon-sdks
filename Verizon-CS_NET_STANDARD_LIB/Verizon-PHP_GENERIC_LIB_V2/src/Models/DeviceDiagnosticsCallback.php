...
class DeviceDiagnosticsCallback implements \JsonSerializable
{
    ...
    /**
     * Converts the DeviceDiagnosticsCallback object to a human-readable string representation.
     *
     * @return string The string representation of the DeviceDiagnosticsCallback object.
     */
    ...
    protected $propertyNames = ['accountName', 'serviceName', 'endpoint', 'createdOn', 'httpHeaders'];
