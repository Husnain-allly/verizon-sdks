...
class ResourcesServiceProfile implements \JsonSerializable
{
    ...
    /**
     * Converts the ResourcesServiceProfile object to a human-readable string representation.
     *
     * @return string The string representation of the ResourcesServiceProfile object.
     */
