...
class M5GBiaddressAndcustomerinfo implements \JsonSerializable
{
    /**
    ...
    /**
     * Converts the M5GBiaddressAndcustomerinfo object to a human-readable string representation.
     *
     * @return string The string representation of the M5GBiaddressAndcustomerinfo object.
     */
