...
class DeviceListQueryItem implements \JsonSerializable
{
    ...
    /**
     * Converts the DeviceListQueryItem object to a human-readable string representation.
     *
     * @return string The string representation of the DeviceListQueryItem object.
     */
