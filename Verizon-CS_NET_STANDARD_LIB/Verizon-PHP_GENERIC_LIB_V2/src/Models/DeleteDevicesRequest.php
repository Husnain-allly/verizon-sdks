...
class DeleteDevicesRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the DeleteDevicesRequest object to a human-readable string representation.
     *
     * @return string The string representation of the DeleteDevicesRequest object.
     */
    ...
    protected $propertyNames = ['devicesToDelete', 'accountName'];
