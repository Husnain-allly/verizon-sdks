...
class DeviceLevelCreateTriggerRequest implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the DeviceLevelCreateTriggerRequest object to a human-readable string representation.
     *
     * @return string The string representation of the DeviceLevelCreateTriggerRequest object.
     */
