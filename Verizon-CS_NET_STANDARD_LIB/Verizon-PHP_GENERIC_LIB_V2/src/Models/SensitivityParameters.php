...
class SensitivityParameters implements \JsonSerializable
{
    ...
    /**
     * Converts the SensitivityParameters object to a human-readable string representation.
     *
     * @return string The string representation of the SensitivityParameters object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            ...
            [
                'abnormalMaxValue' => $this->abnormalMaxValue,
                'enableAbnormal' => $this->enableAbnormal,
                'enableVeryAbnormal' => $this->enableVeryAbnormal,
                'veryAbnormalMaxValue' => $this->veryAbnormalMaxValue
            ]
        );
    }
