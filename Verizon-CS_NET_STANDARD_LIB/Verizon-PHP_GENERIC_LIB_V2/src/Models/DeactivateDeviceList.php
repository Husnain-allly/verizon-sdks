...
{
    /**
     * @var array<DeviceId|PropertyDeviceId>|null
     */
    private $ids;
     ...
     * Returns Ids.
     *
     * @return array<DeviceId|PropertyDeviceId>|null
     */
     ...
     *
     * @maps ids
     * @mapsBy anyOf(anyOf(DeviceId,PropertyDeviceId)[],null)
     *
     * @param array<DeviceId|PropertyDeviceId>|null $ids
     */
        ...
        if (isset($this->ids)) {
            $json['ids'] =
                ApiHelper::getJsonHelper()->verifyTypes(
                    $this->ids,
                    'anyOf(anyOf(DeviceId,PropertyDeviceId)[],null)'
                );
        }
