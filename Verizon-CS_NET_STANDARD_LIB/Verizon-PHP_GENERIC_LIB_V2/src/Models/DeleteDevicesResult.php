...
class DeleteDevicesResult implements \JsonSerializable
{
     ...
     *
     * @maps deviceIds
     * @mapsBy anyOf(oneOf(DeviceId[],DeviceId),null)
     *
     * @param DeviceId[]|DeviceId|null $deviceIds
     */
    public function setDeviceIds($deviceIds): void
    {
        ...
        if (isset($this->deviceIds)) {
            $json['deviceIds'] =
                ApiHelper::getJsonHelper()->verifyTypes(
                    $this->deviceIds,
                    'anyOf(oneOf(DeviceId[],DeviceId),null)'
                );
        }
