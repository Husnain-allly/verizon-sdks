...
class SecuritySubscription implements \JsonSerializable
{
    ...
    /**
     * Converts the SecuritySubscription object to a human-readable string representation.
     *
     * @return string The string representation of the SecuritySubscription object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            ...
            [
                ...
                'licensePurchased' => $this->licensePurchased,
