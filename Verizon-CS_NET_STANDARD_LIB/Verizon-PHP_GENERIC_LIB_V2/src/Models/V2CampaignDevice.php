 ...
 */
class V2CampaignDevice implements \JsonSerializable
{
    /**
     * @var int|null
     */
    ...
    /**
     * Converts the V2CampaignDevice object to a human-readable string representation.
     *
     * @return string The string representation of the V2CampaignDevice object.
     */
