...
class PayAsYouGoUpdateTriggerRequest implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * @var PayAsYouGoPricePlanTrigger|null
     */
     ...
     */
    public function getPricePlanTrigger(): ?PayAsYouGoPricePlanTrigger
    {
     ...
     */
    public function setPricePlanTrigger(?PayAsYouGoPricePlanTrigger $pricePlanTrigger): void
    {
    ...
    /**
     * Converts the PayAsYouGoUpdateTriggerRequest object to a human-readable string representation.
     *
     * @return string The string representation of the PayAsYouGoUpdateTriggerRequest object.
     */
