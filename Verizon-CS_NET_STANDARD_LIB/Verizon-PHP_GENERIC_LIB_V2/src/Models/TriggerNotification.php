...
class TriggerNotification implements \JsonSerializable
{
    ...
    /**
     * Converts the TriggerNotification object to a human-readable string representation.
     *
     * @return string The string representation of the TriggerNotification object.
     */
