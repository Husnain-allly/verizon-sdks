...
class AggregateSessionReportRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the AggregateSessionReportRequest object to a human-readable string representation.
     *
     * @return string The string representation of the AggregateSessionReportRequest object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            ...
            [
                ...
                'imei' => $this->imei,
                'deviceGroup' => $this->getDeviceGroup(),
                'deviceLabel' => $this->getDeviceLabel(),
                'dataPlan' => $this->getDataPlan(),
                'noSessionFlag' => $this->noSessionFlag,
