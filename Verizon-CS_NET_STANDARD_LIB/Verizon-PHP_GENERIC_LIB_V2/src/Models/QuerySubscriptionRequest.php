 ...
 */
class QuerySubscriptionRequest implements \JsonSerializable
{
    /**
    ...
    /**
     * Converts the QuerySubscriptionRequest object to a human-readable string representation.
     *
     * @return string The string representation of the QuerySubscriptionRequest object.
     */
