...
class FallBack implements \JsonSerializable
{
    ...
    /**
     * Converts the FallBack object to a human-readable string representation.
     *
     * @return string The string representation of the FallBack object.
     */
    ...
    protected $propertyNames = ['devices', 'accountName'];
