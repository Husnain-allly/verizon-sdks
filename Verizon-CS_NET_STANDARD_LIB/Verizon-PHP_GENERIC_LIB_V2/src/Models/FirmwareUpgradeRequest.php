...
class FirmwareUpgradeRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the FirmwareUpgradeRequest object to a human-readable string representation.
     *
     * @return string The string representation of the FirmwareUpgradeRequest object.
     */
    ...
    protected $propertyNames = ['accountName', 'firmwareName', 'firmwareTo', 'startDate', 'endDate', 'deviceList'];
