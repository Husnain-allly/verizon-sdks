...
class GenerateExternalIdRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the GenerateExternalIdRequest object to a human-readable string representation.
     *
     * @return string The string representation of the GenerateExternalIdRequest object.
     */
    ...
    protected $propertyNames = ['accountidentifier'];
