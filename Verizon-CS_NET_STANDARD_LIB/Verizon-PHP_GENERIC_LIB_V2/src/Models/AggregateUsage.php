...
class AggregateUsage implements \JsonSerializable
{
    ...
    /**
     * Converts the AggregateUsage object to a human-readable string representation.
     *
     * @return string The string representation of the AggregateUsage object.
     */
    ...
    protected $propertyNames = ['deviceId', 'accountName', 'startTime', 'endTime'];
