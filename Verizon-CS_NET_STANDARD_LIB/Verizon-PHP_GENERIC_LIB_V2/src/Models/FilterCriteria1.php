...
class FilterCriteria1 implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the FilterCriteria1 object to a human-readable string representation.
     *
     * @return string The string representation of the FilterCriteria1 object.
     */
