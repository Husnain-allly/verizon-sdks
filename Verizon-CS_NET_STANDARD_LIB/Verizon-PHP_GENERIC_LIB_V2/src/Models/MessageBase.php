...
class MessageBase implements \JsonSerializable
{
     ...
     */
    public function __construct(bool $isPrivate, array $roadUserType)
    {
     ...
     *
     * @param string[]|null $triggerConditions
     */
    ...
    /**
     * Converts the MessageBase object to a human-readable string representation.
     *
     * @return string The string representation of the MessageBase object.
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->triggerConditions)) {
