...
class CarrierActivateRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the CarrierActivateRequest object to a human-readable string representation.
     *
     * @return string The string representation of the CarrierActivateRequest object.
     */
