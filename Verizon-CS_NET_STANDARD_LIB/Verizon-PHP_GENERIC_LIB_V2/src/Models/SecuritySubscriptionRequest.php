...
class SecuritySubscriptionRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the SecuritySubscriptionRequest object to a human-readable string representation.
     *
     * @return string The string representation of the SecuritySubscriptionRequest object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            'SecuritySubscriptionRequest',
            ['accountName' => $this->accountName, 'skuNumber' => $this->skuNumber]
        );
    }
