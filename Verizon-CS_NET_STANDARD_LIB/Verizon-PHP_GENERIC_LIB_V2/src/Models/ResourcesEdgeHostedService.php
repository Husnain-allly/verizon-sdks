...
class ResourcesEdgeHostedService implements \JsonSerializable
{
    ...
    /**
     * Converts the ResourcesEdgeHostedService object to a human-readable string representation.
     *
     * @return string The string representation of the ResourcesEdgeHostedService object.
     */
