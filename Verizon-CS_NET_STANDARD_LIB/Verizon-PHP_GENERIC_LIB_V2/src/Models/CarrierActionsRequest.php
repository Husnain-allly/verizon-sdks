...
class CarrierActionsRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the CarrierActionsRequest object to a human-readable string representation.
     *
     * @return string The string representation of the CarrierActionsRequest object.
     */
    ...
    protected $propertyNames = ['accountName', 'customFields', 'devices', 'withBilling', 'groupName', 'servicePlan'];
