...
class CallbackCreated implements \JsonSerializable
{
    ...
    /**
     * Converts the CallbackCreated object to a human-readable string representation.
     *
     * @return string The string representation of the CallbackCreated object.
     */
    ...
    protected $propertyNames = ['aname', 'name', 'url'];
