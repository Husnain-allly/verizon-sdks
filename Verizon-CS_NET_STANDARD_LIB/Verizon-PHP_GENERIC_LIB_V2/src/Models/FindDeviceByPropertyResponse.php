 ...
 */
class FindDeviceByPropertyResponse implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the FindDeviceByPropertyResponse object to a human-readable string representation.
     *
     * @return string The string representation of the FindDeviceByPropertyResponse object.
     */
