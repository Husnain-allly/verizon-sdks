...
class AccountLevelUpdateTrigger implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the AccountLevelUpdateTrigger object to a human-readable string representation.
     *
     * @return string The string representation of the AccountLevelUpdateTrigger object.
     */
