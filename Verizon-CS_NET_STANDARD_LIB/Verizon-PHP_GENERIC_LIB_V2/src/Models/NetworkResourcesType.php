...
class NetworkResourcesType implements \JsonSerializable
{
    ...
    /**
     * Converts the NetworkResourcesType object to a human-readable string representation.
     *
     * @return string The string representation of the NetworkResourcesType object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            ...
            [
                'minBandwidthKbits' => $this->minBandwidthKbits,
                'serviceContinuitySupport' => $this->serviceContinuitySupport,
                'maxRequestRate' => $this->maxRequestRate,
                'maxLatencyMs' => $this->maxLatencyMs,
                'minAvailability' => $this->minAvailability
            ]
        );
    }
