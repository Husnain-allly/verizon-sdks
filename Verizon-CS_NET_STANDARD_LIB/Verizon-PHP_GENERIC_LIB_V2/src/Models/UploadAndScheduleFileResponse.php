...
class UploadAndScheduleFileResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the UploadAndScheduleFileResponse object to a human-readable string representation.
     *
     * @return string The string representation of the UploadAndScheduleFileResponse object.
     */
