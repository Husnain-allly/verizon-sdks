...
class GetTriggerResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the GetTriggerResponse object to a human-readable string representation.
     *
     * @return string The string representation of the GetTriggerResponse object.
     */
