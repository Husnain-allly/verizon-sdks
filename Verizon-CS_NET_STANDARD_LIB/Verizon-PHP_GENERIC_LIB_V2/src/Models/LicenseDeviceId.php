...
class LicenseDeviceId implements \JsonSerializable
{
    ...
    /**
     * Converts the LicenseDeviceId object to a human-readable string representation.
     *
     * @return string The string representation of the LicenseDeviceId object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify('LicenseDeviceId', ['id' => $this->id, 'kind' => $this->kind]);
    }
