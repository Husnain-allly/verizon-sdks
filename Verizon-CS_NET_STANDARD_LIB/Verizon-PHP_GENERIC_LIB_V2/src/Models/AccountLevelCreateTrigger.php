...
class AccountLevelCreateTrigger implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the AccountLevelCreateTrigger object to a human-readable string representation.
     *
     * @return string The string representation of the AccountLevelCreateTrigger object.
     */
