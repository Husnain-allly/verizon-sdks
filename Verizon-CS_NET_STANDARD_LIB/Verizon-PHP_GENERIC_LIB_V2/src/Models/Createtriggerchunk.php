...
class Createtriggerchunk implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the Createtriggerchunk object to a human-readable string representation.
     *
     * @return string The string representation of the Createtriggerchunk object.
     */
