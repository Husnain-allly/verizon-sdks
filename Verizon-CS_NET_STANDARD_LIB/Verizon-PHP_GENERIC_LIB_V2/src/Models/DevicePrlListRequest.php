...
class DevicePrlListRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the DevicePrlListRequest object to a human-readable string representation.
     *
     * @return string The string representation of the DevicePrlListRequest object.
     */
    ...
    protected $propertyNames = ['deviceIds', 'accountName', 'customFields', 'groupName', 'servicePlan'];
