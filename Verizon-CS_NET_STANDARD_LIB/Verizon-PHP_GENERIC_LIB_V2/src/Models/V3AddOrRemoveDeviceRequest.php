...
class V3AddOrRemoveDeviceRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the V3AddOrRemoveDeviceRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V3AddOrRemoveDeviceRequest object.
     */
