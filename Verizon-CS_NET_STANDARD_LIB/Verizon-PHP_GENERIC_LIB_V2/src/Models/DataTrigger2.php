...
class DataTrigger2 implements \JsonSerializable
{
    /**
    ...
    /**
     * Converts the DataTrigger2 object to a human-readable string representation.
     *
     * @return string The string representation of the DataTrigger2 object.
     */
