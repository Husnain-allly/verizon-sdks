...
class RegisteredCallbacks implements \JsonSerializable
{
    ...
    /**
     * Converts the RegisteredCallbacks object to a human-readable string representation.
     *
     * @return string The string representation of the RegisteredCallbacks object.
     */
    ...
    protected $propertyNames = ['aname', 'name', 'url', 'username', 'password'];
