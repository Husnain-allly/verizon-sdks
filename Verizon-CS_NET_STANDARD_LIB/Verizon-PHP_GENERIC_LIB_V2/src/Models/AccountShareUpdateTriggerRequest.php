...
class AccountShareUpdateTriggerRequest implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the AccountShareUpdateTriggerRequest object to a human-readable string representation.
     *
     * @return string The string representation of the AccountShareUpdateTriggerRequest object.
     */
