...
class DiagnosticObservationSetting implements \JsonSerializable
{
    ...
    /**
     * Converts the DiagnosticObservationSetting object to a human-readable string representation.
     *
     * @return string The string representation of the DiagnosticObservationSetting object.
     */
