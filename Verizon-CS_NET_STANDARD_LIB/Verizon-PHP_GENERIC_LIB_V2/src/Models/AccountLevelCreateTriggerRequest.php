...
class AccountLevelCreateTriggerRequest implements \JsonSerializable
{
    /**
     * @var string|null
     */
     ...
     */
    public function getDataTrigger(): ?DataTrigger
    {
     ...
     * @maps dataTrigger
     */
    public function setDataTrigger(?DataTrigger $dataTrigger): void
    {
    ...
    /**
     * Converts the AccountLevelCreateTriggerRequest object to a human-readable string representation.
     *
     * @return string The string representation of the AccountLevelCreateTriggerRequest object.
     */
