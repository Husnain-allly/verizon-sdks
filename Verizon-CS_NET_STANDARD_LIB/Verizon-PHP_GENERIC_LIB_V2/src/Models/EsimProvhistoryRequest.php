...
class EsimProvhistoryRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the EsimProvhistoryRequest object to a human-readable string representation.
     *
     * @return string The string representation of the EsimProvhistoryRequest object.
     */
