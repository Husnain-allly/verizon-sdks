...
class ActivateDeviceProfileRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the ActivateDeviceProfileRequest object to a human-readable string representation.
     *
     * @return string The string representation of the ActivateDeviceProfileRequest object.
     */
