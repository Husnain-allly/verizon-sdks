...
class ListServiceProfilesResult implements \JsonSerializable
{
    ...
    /**
     * Converts the ListServiceProfilesResult object to a human-readable string representation.
     *
     * @return string The string representation of the ListServiceProfilesResult object.
     */
