 ...
 */
class V2CampaignHistory implements \JsonSerializable
{
    /**
     * @var bool
     */
     ...
     *
     * @return V2CampaignMetaInfo[]|null
     */
     ...
     * @maps campaignList
     *
     * @param V2CampaignMetaInfo[]|null $campaignList
     */
    ...
    /**
     * Converts the V2CampaignHistory object to a human-readable string representation.
     *
     * @return string The string representation of the V2CampaignHistory object.
     */
