...
class DtoExpandedDeviceResponse implements \JsonSerializable
{
    /**
     * @var string|null
     */
     ...
     * @maps modelmetadata
     */
    public function setModelmetadata(?array $modelmetadata): void
    {
    ...
    /**
     * Converts the DtoExpandedDeviceResponse object to a human-readable string representation.
     *
     * @return string The string representation of the DtoExpandedDeviceResponse object.
     */
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->modelmetadata)) {
            $json['modelmetadata']    = $this->modelmetadata;
        }
