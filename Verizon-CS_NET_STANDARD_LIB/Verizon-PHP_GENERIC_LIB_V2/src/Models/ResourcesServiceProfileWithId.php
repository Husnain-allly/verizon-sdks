...
/**
 * Information about the resource requirements and service characteristics of an edge application.
 * Includes serviceProfileId. Used when retrieving a service profile.
 */
class ResourcesServiceProfileWithId implements \JsonSerializable
{
    /**
     * @var string|null
     */
     ...
     * @required
     * @maps clientType
     * @factory \VerizonLib\Models\ClientType::checkValue
     */
    ...
    /**
     * Converts the ResourcesServiceProfileWithId object to a human-readable string representation.
     *
     * @return string The string representation of the ResourcesServiceProfileWithId object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            ...
            [
                ...
                'ecspFilter' => $this->ecspFilter,
                'clientSchedule' => $this->clientSchedule,
                'clientServiceArea' => $this->clientServiceArea,
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        $json['clientType']            = ClientType::checkValue($this->clientType);
