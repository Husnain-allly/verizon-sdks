...
class DeviceIdentifier implements \JsonSerializable
{
    ...
    /**
     * Converts the DeviceIdentifier object to a human-readable string representation.
     *
     * @return string The string representation of the DeviceIdentifier object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            'DeviceIdentifier',
            ['kind' => $this->kind, 'id' => $this->id, 'mdn' => $this->mdn]
        );
    }
