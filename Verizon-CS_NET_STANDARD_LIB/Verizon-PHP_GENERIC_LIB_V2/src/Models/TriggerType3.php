 ...
 * Trigger details.
 */
class TriggerType3 implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the TriggerType3 object to a human-readable string representation.
     *
     * @return string The string representation of the TriggerType3 object.
     */
