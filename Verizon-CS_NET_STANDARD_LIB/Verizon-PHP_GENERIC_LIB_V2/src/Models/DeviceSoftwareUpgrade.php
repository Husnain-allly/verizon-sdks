...
class DeviceSoftwareUpgrade implements \JsonSerializable
{
    ...
    /**
     * Converts the DeviceSoftwareUpgrade object to a human-readable string representation.
     *
     * @return string The string representation of the DeviceSoftwareUpgrade object.
     */
    ...
    protected $propertyNames = ['deviceId', 'id', 'accountName', 'softwareName', 'startDate', 'status', 'reason'];
