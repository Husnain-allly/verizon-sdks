 ...
 */
class DeleteSubscriptionRequest implements \JsonSerializable
{
    /**
    ...
    /**
     * Converts the DeleteSubscriptionRequest object to a human-readable string representation.
     *
     * @return string The string representation of the DeleteSubscriptionRequest object.
     */
