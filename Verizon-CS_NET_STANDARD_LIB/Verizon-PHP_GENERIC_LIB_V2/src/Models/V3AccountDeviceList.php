 ...
 * Array of devices.
 */
class V3AccountDeviceList implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the V3AccountDeviceList object to a human-readable string representation.
     *
     * @return string The string representation of the V3AccountDeviceList object.
     */
