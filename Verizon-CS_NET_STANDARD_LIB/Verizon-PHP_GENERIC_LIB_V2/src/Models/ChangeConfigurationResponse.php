...
class ChangeConfigurationResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the ChangeConfigurationResponse object to a human-readable string representation.
     *
     * @return string The string representation of the ChangeConfigurationResponse object.
     */
