...
/**
 * Builder for model Createtriggerchunk
 *
 * @see Createtriggerchunk
 */
class CreatetriggerchunkBuilder
{
    /**
     * @var Createtriggerchunk
     */
    private $instance;

    private function __construct(Createtriggerchunk $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new Createtriggerchunk Builder object.
     */
    public static function init(): self
    {
        return new self(new Createtriggerchunk());
    }
    ...
    /**
     * Initializes a new Createtriggerchunk object.
     */
    public function build(): Createtriggerchunk
    {
