...
class DataTriggerRequest implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the DataTriggerRequest object to a human-readable string representation.
     *
     * @return string The string representation of the DataTriggerRequest object.
     */
