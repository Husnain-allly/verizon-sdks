...
class SecuritySuccessResult implements \JsonSerializable
{
    ...
    /**
     * Converts the SecuritySuccessResult object to a human-readable string representation.
     *
     * @return string The string representation of the SecuritySuccessResult object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify('SecuritySuccessResult', ['requestId' => $this->requestId]);
    }
