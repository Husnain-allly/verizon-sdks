...
class ARequestBodyForUsage implements \JsonSerializable
{
    /**
    ...
    /**
     * Converts the ARequestBodyForUsage object to a human-readable string representation.
     *
     * @return string The string representation of the ARequestBodyForUsage object.
     */
    ...
    protected $propertyNames = ['deviceId', 'startTime', 'endTime'];
