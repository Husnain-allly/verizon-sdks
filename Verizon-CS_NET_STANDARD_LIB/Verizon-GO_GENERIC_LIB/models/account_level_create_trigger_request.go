...
// AccountLevelCreateTriggerRequest represents a AccountLevelCreateTriggerRequest struct.
type AccountLevelCreateTriggerRequest struct {
    ...
    SmsNumbers                    []AccountLevelCreateTriggerRequestSmsNumbers `json:"smsNumbers,omitempty"`
...
// String implements the fmt.Stringer interface for AccountLevelCreateTriggerRequest,
// providing a human-readable string representation useful for logging, debugging or displaying information.
func (a AccountLevelCreateTriggerRequest) String() string {
    return fmt.Sprintf(
    	"AccountLevelCreateTriggerRequest[TriggerName=%v, EcpdId=%v, TriggerCategory=%v, DataTrigger=%v, Notification=%v, NotificationType=%v, Callback=%v, EmailNotification=%v, NotificationGroupName=%v, NotificationFrequencyFactor=%v, NotificationFrequencyInterval=%v, ExternalEmailRecipients=%v, SmsNotification=%v, SmsNumbers=%v, Reminder=%v, Severity=%v, Active=%v]",
    	a.TriggerName, a.EcpdId, a.TriggerCategory, a.DataTrigger, a.Notification, a.NotificationType, a.Callback, a.EmailNotification, a.NotificationGroupName, a.NotificationFrequencyFactor, a.NotificationFrequencyInterval, a.ExternalEmailRecipients, a.SmsNotification, a.SmsNumbers, a.Reminder, a.Severity, a.Active)
}

// MarshalJSON implements the json.Marshaler interface for AccountLevelCreateTriggerRequest.
// It customizes the JSON marshaling process for AccountLevelCreateTriggerRequest objects.
func (a AccountLevelCreateTriggerRequest) MarshalJSON() (
    []byte,
    error) {
    return json.Marshal(a.toMap())
}

// toMap converts the AccountLevelCreateTriggerRequest object to a map representation for JSON marshaling.
func (a AccountLevelCreateTriggerRequest) toMap() map[string]any {
...
// UnmarshalJSON implements the json.Unmarshaler interface for AccountLevelCreateTriggerRequest.
// It customizes the JSON unmarshaling process for AccountLevelCreateTriggerRequest objects.
func (a *AccountLevelCreateTriggerRequest) UnmarshalJSON(input []byte) error {
    var temp tempAccountLevelCreateTriggerRequest
...
// tempAccountLevelCreateTriggerRequest is a temporary struct used for validating the fields of AccountLevelCreateTriggerRequest.
type tempAccountLevelCreateTriggerRequest  struct {
    TriggerName                   *string                                      `json:"triggerName,omitempty"`
    EcpdId                        *string                                      `json:"ecpdId,omitempty"`
    TriggerCategory               *TriggerCategory                             `json:"triggerCategory,omitempty"`
    DataTrigger                   *DataTrigger                                 `json:"dataTrigger,omitempty"`
