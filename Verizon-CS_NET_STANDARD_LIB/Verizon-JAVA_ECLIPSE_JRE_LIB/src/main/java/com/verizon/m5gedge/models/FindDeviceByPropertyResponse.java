...
public class FindDeviceByPropertyResponse {
    ...
    public String toString() {
        return "FindDeviceByPropertyResponse [" + "billingaccountid=" + billingaccountid
                ...
                + versionid + ", additionalProperties=" + additionalProperties + "]";
    }
    ...
    public static class Builder {
        ...
        public FindDeviceByPropertyResponse build() {
            FindDeviceByPropertyResponse model =
                    new FindDeviceByPropertyResponse(billingaccountid, createdon, eventretention,
