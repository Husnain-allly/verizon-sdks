 ...
 */
@JsonDeserialize(using = EsimDeviceListDeviceIds.EsimDeviceListDeviceIdsDeserializer.class)
public abstract class EsimDeviceListDeviceIds {
    ...
    private static class EsimDeviceIdCase extends EsimDeviceListDeviceIds {
    ...
    private static class DeviceId2Case extends EsimDeviceListDeviceIds {
    ...
    /**
     * This is a custom deserializer class for EsimDeviceListDeviceIds.
     */
    protected static class EsimDeviceListDeviceIdsDeserializer
            extends JsonDeserializer<EsimDeviceListDeviceIds> {

        @Override
        public EsimDeviceListDeviceIds deserialize(JsonParser jp, DeserializationContext ctxt)
