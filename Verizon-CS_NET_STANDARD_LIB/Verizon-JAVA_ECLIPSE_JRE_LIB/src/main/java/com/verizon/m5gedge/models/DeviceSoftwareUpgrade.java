...
public class DeviceSoftwareUpgrade {
    ...
    public String toString() {
        return "DeviceSoftwareUpgrade [" + "deviceId=" + deviceId + ", id=" + id + ", accountName="
                ...
                + reason + ", softwareName=" + softwareName + ", additionalProperties="
    ...
    public static class Builder {
        ...
        public DeviceSoftwareUpgrade build() {
            DeviceSoftwareUpgrade model =
                    new DeviceSoftwareUpgrade(deviceId, id, accountName, startDate, status, reason,
                            softwareName);
