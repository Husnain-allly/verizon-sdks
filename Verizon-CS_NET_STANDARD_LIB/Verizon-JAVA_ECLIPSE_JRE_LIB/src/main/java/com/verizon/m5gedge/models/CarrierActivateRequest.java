...
public class CarrierActivateRequest {
    ...
    public String toString() {
        return "CarrierActivateRequest [" + "devices=" + devices + ", servicePlan=" + servicePlan
                ...
                + ", skuNumber=" + skuNumber + ", additionalProperties=" + additionalProperties
                + "]";
    }
    ...
    public static class Builder {
        ...
        public CarrierActivateRequest build() {
            CarrierActivateRequest model =
                    new CarrierActivateRequest(devices, servicePlan, mdnZipCode, accountName,
                            carrierIpPoolName, carrierName, costCenterCode, customFields, groupName,
                            leadId, primaryPlaceOfUse, publicIpRestriction, skuNumber);
