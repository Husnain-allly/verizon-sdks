...
/**
 * This is a model class for DataTrigger2 type.
 */
public class DataTrigger2 {
    ...
    /**
     * Converts this DataTrigger2 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "DataTrigger2 [" + "deviceGroup=" + deviceGroup + ", conditionType=" + conditionType
                + ", comparitor=" + comparitor + ", threshold=" + threshold + ", thresholdUnit="
                + thresholdUnit + ", cycleType=" + cycleType + ", allowanceThreshold="
                + allowanceThreshold + ", action=" + action + ", additionalProperties="
                + additionalProperties + "]";
    }

    /**
     * Builds a new {@link DataTrigger2.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link DataTrigger2.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link DataTrigger2}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link DataTrigger2} object using the set fields.
         * @return {@link DataTrigger2}
         */
        public DataTrigger2 build() {
            DataTrigger2 model =
                    new DataTrigger2(deviceGroup, conditionType, comparitor, threshold,
