 ...
 */
public final class ServiceEndpointsApi extends BaseApi {

    /**
     * Initializes the controller.
     * @param globalConfig    Configurations added in client.
     */
    public ServiceEndpointsApi(GlobalConfiguration globalConfig) {
        super(globalConfig);
    }
     ...
     */
    private ApiCall<ApiResponse<ListAllServiceEndpointsResult>, ApiException> prepareListAllServiceEndpointsRequest() {
