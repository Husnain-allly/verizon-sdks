...
import com.verizon.m5gedge.models.containers.DataFrameContent;
import com.verizon.m5gedge.models.containers.DataFrameMsgId;
...
public class DataFrame {
    ...
    public static class Builder {
         ...
         * @param  content  DataFrameContent value for content.
         */
        public Builder(int notUsed, FrameType frameType, DataFrameMsgId msgId, int startTime,
                int durationTime, int priority, int notUsed1, List<GeographicalPath> regions,
                int notUsed2, int notUsed3, DataFrameContent content) {
            this.notUsed = notUsed;
            this.frameType = frameType;
            this.msgId = msgId;
            this.startTime = startTime;
