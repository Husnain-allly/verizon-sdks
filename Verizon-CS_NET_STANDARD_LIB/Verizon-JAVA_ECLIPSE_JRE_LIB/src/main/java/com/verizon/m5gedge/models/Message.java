...
public class Message {
     ...
     * @param  generic  Generic value for generic.
    ...
    protected Message(
        ...
        this(isPrivate, roadUserType, triggerConditions, generic, null, null, null);
    }
     ...
     * **Note:** ETX prefers the j2735 or the j2735_gr encoding and only vendor specific message
     * types are allowed to be published in different message formats.
     * @param generic Value for Generic
     */
    @JsonSetter("generic")
    ...
    public String toString() {
        return "Message [" + "isPrivate=" + isPrivate + ", roadUserType=" + roadUserType
                + ", triggerConditions=" + triggerConditions + ", generic=" + generic + ", limits="
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(isPrivate, roadUserType, triggerConditions, generic)
                .limits(getLimits())
    ...
    public static class Builder {
        ...
        public Builder(boolean isPrivate, List<RoadUserTypes> roadUserType,
                List<TriggerCondition> triggerConditions, Generic generic) {
            this.isPrivate = isPrivate;
            this.roadUserType = roadUserType;
            this.triggerConditions = triggerConditions;
            this.generic = generic;
         ...
         * @return Builder
         */
        public Builder generic(Generic generic) {
            this.generic = generic;
            return this;
        }
        ...
        public Message build() {
            Message model =
                    new Message(isPrivate, roadUserType, triggerConditions, generic, limits,
