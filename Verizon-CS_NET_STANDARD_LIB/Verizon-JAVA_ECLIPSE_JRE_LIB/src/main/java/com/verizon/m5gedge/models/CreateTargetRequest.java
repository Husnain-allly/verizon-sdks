...
public class CreateTargetRequest {
    ...
    public static class Builder {
        ...
        public CreateTargetRequest build() {
            CreateTargetRequest model =
                    new CreateTargetRequest(accountidentifier, billingaccountid, kind, address,
                            addressscheme, fields, description, externalid, name, region, key1,
                            oauth);
