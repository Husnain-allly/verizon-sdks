...
/**
 * ProvisioningStatusFilter to be used.
 */
public enum ProvisioningStatusFilter {
    ...
    private static TreeMap<String, ProvisioningStatusFilter> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static ProvisioningStatusFilter constructFromString(String toConvert) throws IOException {
        ProvisioningStatusFilter enumValue = fromString(toConvert);
        if (enumValue == null) {
     ...
     * @return The enum member against the given string value.
     */
    public static ProvisioningStatusFilter fromString(String toConvert) {
    ...
    /**
     * Convert list of ProvisioningStatusFilter values to list of string values.
     * @param toConvert The list of ProvisioningStatusFilter values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<ProvisioningStatusFilter> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (ProvisioningStatusFilter enumValue : toConvert) {
