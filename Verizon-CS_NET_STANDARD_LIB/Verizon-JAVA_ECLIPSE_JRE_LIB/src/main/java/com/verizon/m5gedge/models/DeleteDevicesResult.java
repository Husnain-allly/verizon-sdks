...
import com.verizon.m5gedge.models.containers.DeleteDevicesResultDeviceIds;
...
public class DeleteDevicesResult {
    private DeleteDevicesResultDeviceIds deviceIds;
     ...
     * @param  deviceIds  DeleteDevicesResultDeviceIds value for deviceIds.
     * @param  status  String value for status.
     * @param  message  String value for message.
     */
    public DeleteDevicesResult(
            DeleteDevicesResultDeviceIds deviceIds,
            String status,
            String message) {
     ...
     * @return Returns the DeleteDevicesResultDeviceIds
     */
    @JsonGetter("deviceIds")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public DeleteDevicesResultDeviceIds getDeviceIds() {
        return deviceIds;
    }
     ...
     * One object per device to be deleted. Each object must contain a kind and id element
     * identifying the device.
     * @param deviceIds Value for DeleteDevicesResultDeviceIds
     */
    @JsonSetter("deviceIds")
    public void setDeviceIds(DeleteDevicesResultDeviceIds deviceIds) {
        this.deviceIds = deviceIds;
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder deviceIds(DeleteDevicesResultDeviceIds deviceIds) {
            this.deviceIds = deviceIds;
            return this;
        }
