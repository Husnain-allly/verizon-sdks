...
/**
 * This is a model class for V2CampaignDevice type.
 */
public class V2CampaignDevice {
    ...
    /**
     * Converts this V2CampaignDevice into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "V2CampaignDevice [" + "hasMoreData=" + hasMoreData + ", maxPageSize=" + maxPageSize
    ...
    /**
     * Builds a new {@link V2CampaignDevice.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link V2CampaignDevice.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link V2CampaignDevice}.
     */
    public static class Builder {
         ...
         * @param  deviceList  List of V2DeviceStatus value for deviceList.
         */
        public Builder(boolean hasMoreData, int maxPageSize, List<V2DeviceStatus> deviceList) {
            this.hasMoreData = hasMoreData;
            this.maxPageSize = maxPageSize;
            this.deviceList = deviceList;
        }
        ...
        /**
         * Builds a new {@link V2CampaignDevice} object using the set fields.
         * @return {@link V2CampaignDevice}
         */
        public V2CampaignDevice build() {
            V2CampaignDevice model =
                    new V2CampaignDevice(hasMoreData, maxPageSize, deviceList, totalDevice,
                            lastSeenDeviceId);
