 ...
 */
@JsonDeserialize(using = AccountLevelCreateTriggerRequestSmsNumbers.AccountLevelCreateTriggerRequestSmsNumbersDeserializer.class)
public abstract class AccountLevelCreateTriggerRequestSmsNumbers {
     ...
     */
    public static AccountLevelCreateTriggerRequestSmsNumbers fromCellphonenumber(
    ...
    private static class CellphonenumberCase extends AccountLevelCreateTriggerRequestSmsNumbers {
    ...
    /**
     * This is a custom deserializer class for AccountLevelCreateTriggerRequestSmsNumbers.
     */
    protected static class AccountLevelCreateTriggerRequestSmsNumbersDeserializer
            extends JsonDeserializer<AccountLevelCreateTriggerRequestSmsNumbers> {

        @Override
        public AccountLevelCreateTriggerRequestSmsNumbers deserialize(JsonParser jp, DeserializationContext ctxt)
