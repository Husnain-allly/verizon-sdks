 ...
 */
public final class RetrievetheTriggersApi extends BaseApi {

    /**
     * Initializes the controller.
     * @param globalConfig    Configurations added in client.
     */
    public RetrievetheTriggersApi(GlobalConfiguration globalConfig) {
        super(globalConfig);
    }
     ...
     */
    private ApiCall<ApiResponse<TriggerValueResponse>, ApiException> prepareGetAllAvailableTriggersRequest() {
     ...
     */
    private ApiCall<ApiResponse<TriggerValueResponse2>, ApiException> prepareGetAllTriggersByTriggerCategoryRequest() {
