...
public class ConnectivityManagementCallback {
    ...
    public String toString() {
        return "ConnectivityManagementCallback [" + "accountName=" + accountName + ", password="
                ...
                + username + ", additionalProperties=" + additionalProperties + "]";
    }
    ...
    public static class Builder {
        ...
        public ConnectivityManagementCallback build() {
            ConnectivityManagementCallback model =
                    new ConnectivityManagementCallback(accountName, password, serviceName, url,
                            username);
