...
public class V3AccountDevice {
    ...
    public String toString() {
        return "V3AccountDevice [" + "deviceId=" + deviceId + ", mdn=" + mdn + ", model=" + model
                ...
                + updateTime + ", refreshTime=" + refreshTime + ", additionalProperties="
    ...
    public static class Builder {
        ...
        public V3AccountDevice build() {
            V3AccountDevice model2 =
                    new V3AccountDevice(deviceId, mdn, model, make, firmware, fotaEligible, status,
                            licenseAssigned, protocol, softwareList, fileList, createTime,
                            upgradeTime, updateTime, refreshTime);
