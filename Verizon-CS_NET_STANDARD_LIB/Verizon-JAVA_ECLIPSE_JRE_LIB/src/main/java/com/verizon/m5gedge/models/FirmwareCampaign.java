...
public class FirmwareCampaign {
    ...
    public String toString() {
        return "FirmwareCampaign [" + "id=" + id + ", accountName=" + accountName
                ...
                + campaignTimeWindowList + ", additionalProperties=" + additionalProperties + "]";
    }
    ...
    public static class Builder {
        ...
        public FirmwareCampaign build() {
            FirmwareCampaign model2 =
                    new FirmwareCampaign(id, accountName, firmwareFrom, firmwareTo, protocol, make,
