 ...
 */
@JsonDeserialize(using = AccountLevelObjectCondition.AccountLevelObjectConditionDeserializer.class)
public abstract class AccountLevelObjectCondition {
     ...
     */
    public static AccountLevelObjectCondition fromConditionObjectCall(
    ...
    private static class ConditionTypeCase extends AccountLevelObjectCondition {
    ...
    private static class ConditionObjectCallCase extends AccountLevelObjectCondition {
    ...
    /**
     * This is a custom deserializer class for AccountLevelObjectCondition.
     */
    protected static class AccountLevelObjectConditionDeserializer
            extends JsonDeserializer<AccountLevelObjectCondition> {

        @Override
        public AccountLevelObjectCondition deserialize(JsonParser jp, DeserializationContext ctxt)
