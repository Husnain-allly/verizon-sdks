...
/**
 * OauthScopeThingspaceOauth to be used.
 */
public enum OauthScopeThingspaceOauth {
    ...
    private static TreeMap<String, OauthScopeThingspaceOauth> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static OauthScopeThingspaceOauth constructFromString(String toConvert) throws IOException {
        OauthScopeThingspaceOauth enumValue = fromString(toConvert);
        if (enumValue == null) {
     ...
     * @return The enum member against the given string value.
     */
    public static OauthScopeThingspaceOauth fromString(String toConvert) {
    ...
    /**
     * Convert list of OauthScopeThingspaceOauth values to list of string values.
     * @param toConvert The list of OauthScopeThingspaceOauth values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<OauthScopeThingspaceOauth> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (OauthScopeThingspaceOauth enumValue : toConvert) {
