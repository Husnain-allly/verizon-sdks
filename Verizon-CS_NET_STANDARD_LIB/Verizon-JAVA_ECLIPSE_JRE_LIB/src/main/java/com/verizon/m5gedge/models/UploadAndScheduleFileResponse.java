...
public class UploadAndScheduleFileResponse {
    ...
    public String toString() {
        return "UploadAndScheduleFileResponse [" + "id=" + id + ", accountName=" + accountName
                ...
                + ", deviceList=" + deviceList + ", status=" + status + ", additionalProperties="
    ...
    public static class Builder {
        ...
        public UploadAndScheduleFileResponse build() {
            UploadAndScheduleFileResponse model2 =
                    new UploadAndScheduleFileResponse(id, accountName, campaignName, softwareName,
                            softwareFrom, softwareTo, fileName, fileVersion, distributionType, make,
                            model, startDate, endDate, downloadAfterDate, downloadTimeWindowList,
                            installAfterDate, installTimeWindowList, deviceList, status);
