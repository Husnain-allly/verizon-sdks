 ...
 */
@JsonDeserialize(using = AccountSharePricePlanTriggerCondition.AccountSharePricePlanTriggerConditionDeserializer.class)
public abstract class AccountSharePricePlanTriggerCondition {
     ...
     */
    public static AccountSharePricePlanTriggerCondition fromConditionType(
     ...
     */
    public static AccountSharePricePlanTriggerCondition fromConditionObjectCall(
    ...
    private static class ConditionTypeCase extends AccountSharePricePlanTriggerCondition {
    ...
    private static class ConditionObjectCallCase extends AccountSharePricePlanTriggerCondition {
    ...
    /**
     * This is a custom deserializer class for AccountSharePricePlanTriggerCondition.
     */
    protected static class AccountSharePricePlanTriggerConditionDeserializer
            extends JsonDeserializer<AccountSharePricePlanTriggerCondition> {

        @Override
        public AccountSharePricePlanTriggerCondition deserialize(JsonParser jp, DeserializationContext ctxt)
