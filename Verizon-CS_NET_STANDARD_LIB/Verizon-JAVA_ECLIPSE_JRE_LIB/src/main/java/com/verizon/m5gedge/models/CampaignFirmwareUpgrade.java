...
public class CampaignFirmwareUpgrade {
    ...
    public static class Builder {
        ...
        public CampaignFirmwareUpgrade build() {
            CampaignFirmwareUpgrade model =
                    new CampaignFirmwareUpgrade(firmwareName, firmwareFrom, firmwareTo, protocol,
                            startDate, endDate, deviceList, autoAssignLicenseFlag,
                            autoAddDevicesFlag, campaignName, campaignTimeWindowList);
