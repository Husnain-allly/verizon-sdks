...
public class Message2 {
     ...
     * @param  saeInfo  SaeInfo value for saeInfo.
    ...
    protected Message2(
            ...
            @JsonProperty("saeInfo") SaeInfo saeInfo) {
        this(isPrivate, roadUserType, triggerConditions, saeInfo, null, null, null);
    }
    ...
    /**
     * Getter for SaeInfo.
     * @return Returns the SaeInfo
     */
    @JsonGetter("saeInfo")
    public SaeInfo getSaeInfo() {
        return saeInfo;
    }

    /**
     * Setter for SaeInfo.
     * @param saeInfo Value for SaeInfo
     */
    @JsonSetter("saeInfo")
    public void setSaeInfo(SaeInfo saeInfo) {
        this.saeInfo = saeInfo;
    }
    ...
    public String toString() {
        return "Message2 [" + "isPrivate=" + isPrivate + ", roadUserType=" + roadUserType
                + ", triggerConditions=" + triggerConditions + ", saeInfo=" + saeInfo + ", limits="
                + limits + ", distributionType=" + distributionType + ", distributionSchedule="
                + distributionSchedule + ", additionalProperties=" + additionalProperties + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(isPrivate, roadUserType, triggerConditions, saeInfo)
                .limits(getLimits())
    ...
    public static class Builder {
        ...
        public Builder(boolean isPrivate, List<RoadUserTypes> roadUserType,
                List<TriggerCondition> triggerConditions, SaeInfo saeInfo) {
            this.isPrivate = isPrivate;
            this.roadUserType = roadUserType;
            this.triggerConditions = triggerConditions;
            this.saeInfo = saeInfo;
         ...
         * @return Builder
         */
        public Builder saeInfo(SaeInfo saeInfo) {
            this.saeInfo = saeInfo;
            return this;
        }
        ...
        public Message2 build() {
            Message2 model =
                    new Message2(isPrivate, roadUserType, triggerConditions, saeInfo, limits,
