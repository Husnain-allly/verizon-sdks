...
public class FirmwareUpgradeRequest {
    ...
    public String toString() {
        return "FirmwareUpgradeRequest [" + "accountName=" + accountName + ", firmwareName="
                ...
                + ", endDate=" + endDate + ", deviceList=" + deviceList + ", additionalProperties="
    ...
    public static class Builder {
        ...
        public FirmwareUpgradeRequest build() {
            FirmwareUpgradeRequest model =
                    new FirmwareUpgradeRequest(accountName, firmwareName, firmwareTo, startDate,
                            endDate, deviceList);
