...
public final class OauthAuthorizationApi extends BaseApi {
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public ApiResponse<OauthToken> requestTokenThingspaceOauth1(
            final String authorization,
            final String scope,
            final Map<String, Object> fieldParameters) throws ApiException, IOException {
        return prepareRequestTokenThingspaceOauth1Request(authorization, scope,
                fieldParameters).execute();
    }
     ...
     * @return    Returns the OauthToken wrapped in ApiResponse response from the API call
     */
    public CompletableFuture<ApiResponse<OauthToken>> requestTokenThingspaceOauth1Async(
            final String authorization,
            final String scope,
            final Map<String, Object> fieldParameters) {
        try {
    ...
    /**
     * Builds the ApiCall object for requestTokenThingspaceOauth1.
     */
    private ApiCall<ApiResponse<OauthToken>, ApiException> prepareRequestTokenThingspaceOauth1Request(
            final String authorization,
            final String scope,
            final Map<String, Object> fieldParameters) {
        return new ApiCall.Builder<ApiResponse<OauthToken>, ApiException>()
