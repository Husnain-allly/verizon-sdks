 ...
 */
@JsonDeserialize(using = DataTrigger1Condition.DataTrigger1ConditionDeserializer.class)
public abstract class DataTrigger1Condition {
     ...
     */
    public static DataTrigger1Condition fromConditionObjectCall(
    ...
    private static class ConditionTypeCase extends DataTrigger1Condition {
    ...
    private static class ConditionObjectCallCase extends DataTrigger1Condition {
    ...
    /**
     * This is a custom deserializer class for DataTrigger1Condition.
     */
    protected static class DataTrigger1ConditionDeserializer
            extends JsonDeserializer<DataTrigger1Condition> {

        @Override
        public DataTrigger1Condition deserialize(JsonParser jp, DeserializationContext ctxt)
