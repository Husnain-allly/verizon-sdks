...
public enum HttpStatusCode {
    ...
    private static TreeMap<String, HttpStatusCode> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static HttpStatusCode constructFromString(String toConvert) throws IOException {
        HttpStatusCode enumValue = fromString(toConvert);
        if (enumValue == null) {
     ...
     * @return The enum member against the given string value.
     */
    public static HttpStatusCode fromString(String toConvert) {
    ...
    /**
     * Convert list of HttpStatusCode values to list of string values.
     * @param toConvert The list of HttpStatusCode values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<HttpStatusCode> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (HttpStatusCode enumValue : toConvert) {
