...
import com.verizon.m5gedge.models.containers.TriggerAttributesOptions;
...
public class AnomalyTriggerValue {
    ...
    public String toString() {
        return "AnomalyTriggerValue [" + "triggerId=" + triggerId + ", triggerName=" + triggerName
                ...
                + ", modifiedAt=" + modifiedAt + ", additionalProperties=" + additionalProperties
                + "]";
    }
    ...
    public static class Builder {
        ...
        public AnomalyTriggerValue build() {
            AnomalyTriggerValue model =
                    new AnomalyTriggerValue(triggerId, triggerName, organizationName,
