...
public class EdgePerformanceResultException extends ApiException {
    ...
    /**
     * Converts this EdgePerformanceResultException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "EdgePerformanceResultException [" + "statusCode=" + getResponseCode() + ", message="
                + getMessage() + ", status=" + status + ", message=" + message + "]";
    }
}
