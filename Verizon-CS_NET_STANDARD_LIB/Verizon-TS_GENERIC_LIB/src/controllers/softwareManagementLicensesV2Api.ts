...
export class SoftwareManagementLicensesV2Api extends BaseApi {
  /**
  ...
  async assignLicensesToDevices(
    ...
    req.deprecated('SoftwareManagementLicensesV2Api.assignLicensesToDevices');
    req.throwOn(400, FotaV2ResultError, 'Unexpected error.');
    req.authenticate([{ thingspaceOauth: true, vzM2MToken: true }]);
  ...
  async removeLicensesFromDevices(
    ...
    req.deprecated('SoftwareManagementLicensesV2Api.removeLicensesFromDevices');
    req.throwOn(400, FotaV2ResultError, 'Unexpected error.');
    req.authenticate([{ thingspaceOauth: true, vzM2MToken: true }]);
    return req.callAsJson(
      v2LicensesAssignedRemovedResultSchema,
  ...
  async listLicensesToRemove(
    ...
    req.deprecated('SoftwareManagementLicensesV2Api.listLicensesToRemove');
    req.throwOn(400, FotaV2ResultError, 'Unexpected error.');
    req.authenticate([{ thingspaceOauth: true, vzM2MToken: true }]);
  ...
  async createListOfLicensesToRemove(
    ...
    req.appendTemplatePath`/licenses/${mapped.account}/cancel`;
    req.deprecated(
      'SoftwareManagementLicensesV2Api.createListOfLicensesToRemove'
    );
    req.throwOn(400, FotaV2ResultError, 'Unexpected error.');
    req.authenticate([{ thingspaceOauth: true, vzM2MToken: true }]);
  ...
  async deleteListOfLicensesToRemove(
    ...
    req.appendTemplatePath`/licenses/${mapped.account}/cancel`;
    req.deprecated(
      'SoftwareManagementLicensesV2Api.deleteListOfLicensesToRemove'
    );
    req.throwOn(400, FotaV2ResultError, 'Unexpected error.');
    req.authenticate([{ thingspaceOauth: true, vzM2MToken: true }]);
