...
import { CampaignStatus, campaignStatusSchema } from '../models/campaignStatus';
import {
...
export class SoftwareManagementReportsV3Api extends BaseApi {
  /**
  ...
  async getCampaignHistoryByStatus(
    ...
    const mapped = req.prepareArgs({
      acc: [acc, string()],
      campaignStatus: [campaignStatus, campaignStatusSchema],
