...
export class SoftwareManagementLicensesV1Api extends BaseApi {
  /**
  ...
  async assignLicensesToDevices(
    ...
    req.deprecated('SoftwareManagementLicensesV1Api.assignLicensesToDevices');
  ...
  async removeLicensesFromDevices(
    ...
    req.deprecated('SoftwareManagementLicensesV1Api.removeLicensesFromDevices');
    req.throwOn(400, FotaV1ResultError, 'Unexpected error.');
    req.authenticate([{ thingspaceOauth: true, vzM2MToken: true }]);
    return req.callAsJson(
      v1LicensesAssignedRemovedResultSchema,
  ...
  async createListOfLicensesToRemove(
    ...
    req.deprecated(
      'SoftwareManagementLicensesV1Api.createListOfLicensesToRemove'
    );
    req.throwOn(400, FotaV1ResultError, 'Unexpected error.');
    req.authenticate([{ thingspaceOauth: true, vzM2MToken: true }]);
  ...
  async deleteListOfLicensesToRemove(
    ...
    req.appendTemplatePath`/licenses/${mapped.account}/cancel`;
    req.deprecated(
      'SoftwareManagementLicensesV1Api.deleteListOfLicensesToRemove'
    );
    req.throwOn(400, FotaV1ResultError, 'Unexpected error.');
    req.authenticate([{ thingspaceOauth: true, vzM2MToken: true }]);
  ...
  async listLicensesToRemove(
    ...
    req.deprecated('SoftwareManagementLicensesV1Api.listLicensesToRemove');
    req.throwOn(400, FotaV1ResultError, 'Unexpected error.');
    req.authenticate([{ thingspaceOauth: true, vzM2MToken: true }]);
