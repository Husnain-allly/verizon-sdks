...
export const clientPersistenceResponseSchema: Schema<ClientPersistenceResponse> = object(
  {
    deviceId: ['DeviceID', optional(string())],
    certificate: ['Certificate', optional(lazy(() => certificateSchema))],
    clientType: ['ClientType', optional(etxClientTypeSchema)],
    clientSubtype: ['ClientSubtype', optional(clientSubtypeSchema)],
