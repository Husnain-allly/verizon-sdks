...
/** Device information. */
export interface V3AccountDevice {
  /** Device identifier. */
  deviceId: string;
  /** MDN. */
  mdn: string;
...
export const v3AccountDeviceSchema: Schema<V3AccountDevice> = typedExpandoObject(
  {
    ...
    softwareList: ['softwareList', array(lazy(() => v3SoftwareInfoSchema))],
