...
export interface AccountShareCreateTriggerRequest {
...
export const accountShareCreateTriggerRequestSchema: Schema<AccountShareCreateTriggerRequest> = typedExpandoObject(
  {
