...
export type AccountSharePricePlanTriggerCondition =
  | ConditionType
  | ConditionObjectCall;

export const accountSharePricePlanTriggerConditionSchema: Schema<AccountSharePricePlanTriggerCondition> = anyOf(
  [conditionTypeSchema, conditionObjectCallSchema]
);

export namespace AccountSharePricePlanTriggerCondition {
  /**
