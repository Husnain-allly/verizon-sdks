...
export type PayAsYouGoPricePlanTriggerCondition =
  | ConditionType
  | ConditionObjectCall;

export const payAsYouGoPricePlanTriggerConditionSchema: Schema<PayAsYouGoPricePlanTriggerCondition> = anyOf(
  [conditionTypeSchema, conditionObjectCallSchema]
);

export namespace PayAsYouGoPricePlanTriggerCondition {
  /**
