...
import {
  ...
  mecPlatformResourcePropertiesSchema,
} from './containers/mecPlatformResourceProperties';
import {
  MecPlatformStatus,
  mecPlatformStatusSchema,
} from './mecPlatformStatus';
...
export interface MecPlatformResource {
  ...
  properties?: MecPlatformResourceProperties;
}
...
export const mecPlatformResourceSchema: Schema<MecPlatformResource> = object({
  ...
  status: ['status', optional(mecPlatformStatusSchema)],
  properties: ['properties', optional(mecPlatformResourcePropertiesSchema)],
});
