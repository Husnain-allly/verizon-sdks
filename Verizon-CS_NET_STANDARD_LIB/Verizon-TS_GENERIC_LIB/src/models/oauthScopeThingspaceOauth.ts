...
/**
 * Enum for OauthScopeThingspaceOauth
 */
export enum OauthScopeThingspaceOauth {
...
/**
 * Schema for OauthScopeThingspaceOauth
 */
export const oauthScopeThingspaceOauthSchema: Schema<OauthScopeThingspaceOauth> = stringEnum(
