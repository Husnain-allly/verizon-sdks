...
export interface DtoExpandedDeviceResponse {
...
export const dtoExpandedDeviceResponseSchema: Schema<DtoExpandedDeviceResponse> = object(
  {
    ...
    commands: ['commands', optional(dict(unknown()))],
    ...
    modelmetadata: ['modelmetadata', optional(unknown())],
