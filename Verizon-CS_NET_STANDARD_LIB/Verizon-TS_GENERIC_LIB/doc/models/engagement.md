...
|  --- | --- | --- | --- |
| `engagementId` | `string \| undefined` | Optional | The engagement ID. |
| `chargingGroup` | `string \| undefined` | Optional | The charging group name. |
| `services` | [`AccountService[] \| undefined`](../../doc/models/account-service.md) | Optional | The services associated with the account. |
