...
```ts
const clientLoggingApi = new ClientLoggingApi(client);
```
...
try {
  const { result, ...httpResponse } = await clientLoggingApi.listDevicesWithLoggingEnabled(account);
...
try {
  const { result, ...httpResponse } = await clientLoggingApi.enableLoggingForDevices(
  account,
  body
);
  // Get more response info...
...
try {
  const { result, ...httpResponse } = await clientLoggingApi.disableLoggingForDevices(
  account,
  deviceIds
);
  // Get more response info...
...
try {
  const { result, ...httpResponse } = await clientLoggingApi.enableDeviceLogging(
  account,
  deviceId
);
  // Get more response info...
...
try {
  const { result, ...httpResponse } = await clientLoggingApi.disableDeviceLogging(
  account,
  deviceId
);
  // Get more response info...
...
try {
  const { result, ...httpResponse } = await clientLoggingApi.listDeviceLogs(
  account,
  deviceId
);
  // Get more response info...
