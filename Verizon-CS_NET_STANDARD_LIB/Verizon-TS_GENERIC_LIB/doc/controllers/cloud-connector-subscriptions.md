...
```ts
const cloudConnectorSubscriptionsApi = new CloudConnectorSubscriptionsApi(client);
```
...
try {
  const { result, ...httpResponse } = await cloudConnectorSubscriptionsApi.createSubscription(body);
...
try {
  const { result, ...httpResponse } = await cloudConnectorSubscriptionsApi.querySubscription(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
...
try {
  const { result, ...httpResponse } = await cloudConnectorSubscriptionsApi.deleteSubscription(body);
  // Get more response info...
  // const { statusCode, headers } = httpResponse;
} catch (error) {
  if (error instanceof ApiError) {
